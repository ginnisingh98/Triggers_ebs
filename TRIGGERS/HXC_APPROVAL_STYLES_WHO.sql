--------------------------------------------------------
--  DDL for Trigger HXC_APPROVAL_STYLES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_APPROVAL_STYLES_WHO" 
before insert or update on "HXC"."HXC_APPROVAL_STYLES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_APPROVAL_STYLES_WHO" ENABLE;
