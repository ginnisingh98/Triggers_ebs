--------------------------------------------------------
--  DDL for Trigger PQH_FR_VALIDATION_EVENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_FR_VALIDATION_EVENTS_WHO" 
before insert or update on "HR"."PQH_FR_VALIDATION_EVENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_FR_VALIDATION_EVENTS_WHO" ENABLE;
