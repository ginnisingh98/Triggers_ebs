--------------------------------------------------------
--  DDL for Trigger PAY_IE_PRSI_DETAILS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_IE_PRSI_DETAILS_F_WHO" 
before insert or update on "HR"."PAY_IE_PRSI_DETAILS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_IE_PRSI_DETAILS_F_WHO" ENABLE;
