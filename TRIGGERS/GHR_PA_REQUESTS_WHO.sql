--------------------------------------------------------
--  DDL for Trigger GHR_PA_REQUESTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PA_REQUESTS_WHO" 
before insert or update on "HR"."GHR_PA_REQUESTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PA_REQUESTS_WHO" ENABLE;
