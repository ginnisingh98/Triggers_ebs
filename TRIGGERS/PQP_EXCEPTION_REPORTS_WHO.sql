--------------------------------------------------------
--  DDL for Trigger PQP_EXCEPTION_REPORTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_EXCEPTION_REPORTS_WHO" 
before insert or update on "HR"."PQP_EXCEPTION_REPORTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_EXCEPTION_REPORTS_WHO" ENABLE;
