--------------------------------------------------------
--  DDL for Trigger FF_FORMULAS_F_TL052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_FORMULAS_F_TL052615_WHO" 
before insert or update on "HR"."FF_FORMULAS_F_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_FORMULAS_F_TL052615_WHO" ENABLE;
