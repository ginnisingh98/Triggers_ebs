--------------------------------------------------------
--  DDL for Trigger GHR_ROUTING_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_ROUTING_GROUPS_WHO" 
before insert or update on "HR"."GHR_ROUTING_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_ROUTING_GROUPS_WHO" ENABLE;
