--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_PSTL_CD_R_RNG_CVG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_PSTL_CD_R_RNG_CVG_WHO" 
before insert or update on "BEN"."BEN_ELIG_PSTL_CD_R_RNG_CVG_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_PSTL_CD_R_RNG_CVG_WHO" ENABLE;
