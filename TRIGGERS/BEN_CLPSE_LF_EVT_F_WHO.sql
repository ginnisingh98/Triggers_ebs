--------------------------------------------------------
--  DDL for Trigger BEN_CLPSE_LF_EVT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CLPSE_LF_EVT_F_WHO" 
before insert or update on "BEN"."BEN_CLPSE_LF_EVT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CLPSE_LF_EVT_F_WHO" ENABLE;
