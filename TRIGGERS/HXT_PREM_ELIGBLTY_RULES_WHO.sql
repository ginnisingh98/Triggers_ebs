--------------------------------------------------------
--  DDL for Trigger HXT_PREM_ELIGBLTY_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_PREM_ELIGBLTY_RULES_WHO" 
before insert or update on "HXT"."HXT_PREM_ELIGBLTY_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_PREM_ELIGBLTY_RULES_WHO" ENABLE;
