--------------------------------------------------------
--  DDL for Trigger PSP_ENC_ELEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ENC_ELEMENTS_WHO" 
before insert or update on "PSP"."PSP_ENC_ELEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ENC_ELEMENTS_WHO" ENABLE;
