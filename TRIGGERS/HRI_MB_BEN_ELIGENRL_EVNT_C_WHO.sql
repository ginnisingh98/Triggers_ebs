--------------------------------------------------------
--  DDL for Trigger HRI_MB_BEN_ELIGENRL_EVNT_C_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_MB_BEN_ELIGENRL_EVNT_C_WHO" 
before insert or update on "HRI"."HRI_MB_BEN_ELIGENRL_EVNT_CT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_MB_BEN_ELIGENRL_EVNT_C_WHO" ENABLE;
