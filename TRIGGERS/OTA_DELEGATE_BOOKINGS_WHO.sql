--------------------------------------------------------
--  DDL for Trigger OTA_DELEGATE_BOOKINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_DELEGATE_BOOKINGS_WHO" 
before insert or update on "OTA"."OTA_DELEGATE_BOOKINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_DELEGATE_BOOKINGS_WHO" ENABLE;
