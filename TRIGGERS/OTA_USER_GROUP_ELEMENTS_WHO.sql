--------------------------------------------------------
--  DDL for Trigger OTA_USER_GROUP_ELEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_USER_GROUP_ELEMENTS_WHO" 
before insert or update on "OTA"."OTA_USER_GROUP_ELEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_USER_GROUP_ELEMENTS_WHO" ENABLE;
