--------------------------------------------------------
--  DDL for Trigger HRI_CS_COMPOBJ_CT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_CS_COMPOBJ_CT_WHO" 
before insert or update on "HRI"."HRI_CS_COMPOBJ_CT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_CS_COMPOBJ_CT_WHO" ENABLE;
