--------------------------------------------------------
--  DDL for Trigger BEN_RPTG_GRP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_RPTG_GRP_WHO" 
before insert or update on "BEN"."BEN_RPTG_GRP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_RPTG_GRP_WHO" ENABLE;
