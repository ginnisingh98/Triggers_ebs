--------------------------------------------------------
--  DDL for Trigger OTA_BULK_ENR_REQUESTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_BULK_ENR_REQUESTS_WHO" 
before insert or update on "OTA"."OTA_BULK_ENR_REQUESTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_BULK_ENR_REQUESTS_WHO" ENABLE;
