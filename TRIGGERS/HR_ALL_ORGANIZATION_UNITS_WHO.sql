--------------------------------------------------------
--  DDL for Trigger HR_ALL_ORGANIZATION_UNITS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ALL_ORGANIZATION_UNITS_WHO" 
...
/
ALTER TRIGGER "APPS"."HR_ALL_ORGANIZATION_UNITS_WHO" ENABLE;
