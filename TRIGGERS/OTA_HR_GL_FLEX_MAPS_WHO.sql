--------------------------------------------------------
--  DDL for Trigger OTA_HR_GL_FLEX_MAPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_HR_GL_FLEX_MAPS_WHO" 
before insert or update on "OTA"."OTA_HR_GL_FLEX_MAPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_HR_GL_FLEX_MAPS_WHO" ENABLE;
