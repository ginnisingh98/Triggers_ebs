--------------------------------------------------------
--  DDL for Trigger OTA_CHAT_MESSAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CHAT_MESSAGES_WHO" 
before insert or update on "OTA"."OTA_CHAT_MESSAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CHAT_MESSAGES_WHO" ENABLE;
