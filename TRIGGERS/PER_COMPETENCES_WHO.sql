--------------------------------------------------------
--  DDL for Trigger PER_COMPETENCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COMPETENCES_WHO" 
before insert or update on "HR"."PER_COMPETENCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COMPETENCES_WHO" ENABLE;
