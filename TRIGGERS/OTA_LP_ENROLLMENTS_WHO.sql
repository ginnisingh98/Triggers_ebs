--------------------------------------------------------
--  DDL for Trigger OTA_LP_ENROLLMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_LP_ENROLLMENTS_WHO" 
before insert or update on "OTA"."OTA_LP_ENROLLMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_LP_ENROLLMENTS_WHO" ENABLE;
