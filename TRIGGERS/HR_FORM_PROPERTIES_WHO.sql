--------------------------------------------------------
--  DDL for Trigger HR_FORM_PROPERTIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_FORM_PROPERTIES_WHO" 
before insert or update on "HR"."HR_FORM_PROPERTIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_FORM_PROPERTIES_WHO" ENABLE;
