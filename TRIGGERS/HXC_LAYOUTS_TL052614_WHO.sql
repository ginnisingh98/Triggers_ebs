--------------------------------------------------------
--  DDL for Trigger HXC_LAYOUTS_TL052614_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_LAYOUTS_TL052614_WHO" 
before insert or update on "HXC"."HXC_LAYOUTS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_LAYOUTS_TL052614_WHO" ENABLE;
