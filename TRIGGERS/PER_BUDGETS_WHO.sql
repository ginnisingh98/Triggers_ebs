--------------------------------------------------------
--  DDL for Trigger PER_BUDGETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BUDGETS_WHO" 
before insert or update on "HR"."PER_BUDGETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BUDGETS_WHO" ENABLE;
