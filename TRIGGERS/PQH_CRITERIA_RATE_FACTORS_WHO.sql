--------------------------------------------------------
--  DDL for Trigger PQH_CRITERIA_RATE_FACTORS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_CRITERIA_RATE_FACTORS_WHO" 
before insert or update on "HR"."PQH_CRITERIA_RATE_FACTORS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_CRITERIA_RATE_FACTORS_WHO" ENABLE;
