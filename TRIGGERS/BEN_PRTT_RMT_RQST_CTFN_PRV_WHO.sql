--------------------------------------------------------
--  DDL for Trigger BEN_PRTT_RMT_RQST_CTFN_PRV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTT_RMT_RQST_CTFN_PRV_WHO" 
before insert or update on "BEN"."BEN_PRTT_RMT_RQST_CTFN_PRVDD_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTT_RMT_RQST_CTFN_PRV_WHO" ENABLE;
