--------------------------------------------------------
--  DDL for Trigger PER_CAREER_PATH_ELEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAREER_PATH_ELEMENTS_WHO" 
before insert or update on "HR"."PER_CAREER_PATH_ELEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAREER_PATH_ELEMENTS_WHO" ENABLE;
