--------------------------------------------------------
--  DDL for Trigger PQH_DE_LEVEL_CODES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_LEVEL_CODES_WHO" 
before insert or update on "HR"."PQH_DE_LEVEL_CODES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_LEVEL_CODES_WHO" ENABLE;
