--------------------------------------------------------
--  DDL for Trigger PER_COMPETENCES_TL052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COMPETENCES_TL052615_WHO" 
before insert or update on "HR"."PER_COMPETENCES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COMPETENCES_TL052615_WHO" ENABLE;
