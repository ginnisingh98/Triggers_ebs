--------------------------------------------------------
--  DDL for Trigger PAY_ITERATIVE_RULES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ITERATIVE_RULES_F_WHO" 
before insert or update on "HR"."PAY_ITERATIVE_RULES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ITERATIVE_RULES_F_WHO" ENABLE;
