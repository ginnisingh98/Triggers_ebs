--------------------------------------------------------
--  DDL for Trigger OTA_LEARNING_PATHS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_LEARNING_PATHS_WHO" 
before insert or update on "OTA"."OTA_LEARNING_PATHS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_LEARNING_PATHS_WHO" ENABLE;
