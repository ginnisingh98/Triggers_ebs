--------------------------------------------------------
--  DDL for Trigger PER_TIME_PERIOD_TYPE052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_TIME_PERIOD_TYPE052617_WHO" 
before insert or update on "HR"."PER_TIME_PERIOD_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_TIME_PERIOD_TYPE052617_WHO" ENABLE;
