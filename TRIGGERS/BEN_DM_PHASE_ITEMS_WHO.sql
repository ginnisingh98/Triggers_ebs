--------------------------------------------------------
--  DDL for Trigger BEN_DM_PHASE_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DM_PHASE_ITEMS_WHO" 
before insert or update on "BEN"."BEN_DM_PHASE_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DM_PHASE_ITEMS_WHO" ENABLE;
