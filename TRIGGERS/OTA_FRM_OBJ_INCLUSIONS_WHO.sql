--------------------------------------------------------
--  DDL for Trigger OTA_FRM_OBJ_INCLUSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_FRM_OBJ_INCLUSIONS_WHO" 
before insert or update on "OTA"."OTA_FRM_OBJ_INCLUSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_FRM_OBJ_INCLUSIONS_WHO" ENABLE;
