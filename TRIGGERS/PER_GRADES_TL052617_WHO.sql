--------------------------------------------------------
--  DDL for Trigger PER_GRADES_TL052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_GRADES_TL052617_WHO" 
before insert or update on "HR"."PER_GRADES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_GRADES_TL052617_WHO" ENABLE;
