--------------------------------------------------------
--  DDL for Trigger OTA_TEST_SECTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_TEST_SECTIONS_WHO" 
before insert or update on "OTA"."OTA_TEST_SECTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_TEST_SECTIONS_WHO" ENABLE;
