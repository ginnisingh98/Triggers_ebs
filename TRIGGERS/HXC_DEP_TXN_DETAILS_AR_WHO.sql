--------------------------------------------------------
--  DDL for Trigger HXC_DEP_TXN_DETAILS_AR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_DEP_TXN_DETAILS_AR_WHO" 
before insert or update on "HXC"."HXC_DEP_TXN_DETAILS_AR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_DEP_TXN_DETAILS_AR_WHO" ENABLE;
