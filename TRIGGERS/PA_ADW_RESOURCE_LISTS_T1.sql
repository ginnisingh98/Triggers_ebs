--------------------------------------------------------
--  DDL for Trigger PA_ADW_RESOURCE_LISTS_T1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PA_ADW_RESOURCE_LISTS_T1" 
-- $Header: PATRIG01.pls 115.5 99/07/16 15:14:43 porting ship  $
BEFORE UPDATE OF
  -- Columns required for data warehouse
  NAME,
  DESCRIPTION
ON "PA"."PA_RESOURCE_LISTS_ALL_BG"
FOR EACH ROW
...
/
ALTER TRIGGER "APPS"."PA_ADW_RESOURCE_LISTS_T1" ENABLE;
