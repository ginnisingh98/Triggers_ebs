--------------------------------------------------------
--  DDL for Trigger PER_LETTER_REQUEST_LINES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_LETTER_REQUEST_LINES_WHO" 
before insert or update on "HR"."PER_LETTER_REQUEST_LINES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_LETTER_REQUEST_LINES_WHO" ENABLE;
