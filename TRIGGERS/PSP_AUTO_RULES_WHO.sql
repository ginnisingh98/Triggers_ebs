--------------------------------------------------------
--  DDL for Trigger PSP_AUTO_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_AUTO_RULES_WHO" 
before insert or update on "PSP"."PSP_AUTO_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_AUTO_RULES_WHO" ENABLE;
