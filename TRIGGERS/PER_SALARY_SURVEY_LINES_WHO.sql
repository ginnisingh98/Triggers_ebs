--------------------------------------------------------
--  DDL for Trigger PER_SALARY_SURVEY_LINES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SALARY_SURVEY_LINES_WHO" 
before insert or update on "HR"."PER_SALARY_SURVEY_LINES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SALARY_SURVEY_LINES_WHO" ENABLE;
