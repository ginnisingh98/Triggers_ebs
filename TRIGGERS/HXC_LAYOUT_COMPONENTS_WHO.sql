--------------------------------------------------------
--  DDL for Trigger HXC_LAYOUT_COMPONENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_LAYOUT_COMPONENTS_WHO" 
before insert or update on "HXC"."HXC_LAYOUT_COMPONENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_LAYOUT_COMPONENTS_WHO" ENABLE;
