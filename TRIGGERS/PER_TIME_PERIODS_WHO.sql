--------------------------------------------------------
--  DDL for Trigger PER_TIME_PERIODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_TIME_PERIODS_WHO" 
before insert or update on "HR"."PER_TIME_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_TIME_PERIODS_WHO" ENABLE;
