--------------------------------------------------------
--  DDL for Trigger OTA_RESOURCE_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_RESOURCE_USAGES_WHO" 
before insert or update on "OTA"."OTA_RESOURCE_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_RESOURCE_USAGES_WHO" ENABLE;
