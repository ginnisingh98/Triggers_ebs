--------------------------------------------------------
--  DDL for Trigger HRI_EQ_BEN_ELCTN_EVTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_BEN_ELCTN_EVTS_WHO" 
before insert or update on "HRI"."HRI_EQ_BEN_ELCTN_EVTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_BEN_ELCTN_EVTS_WHO" ENABLE;
