--------------------------------------------------------
--  DDL for Trigger PER_ORG_HRCHY_SUMMARY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ORG_HRCHY_SUMMARY_WHO" 
before insert or update on "HR"."PER_ORG_HRCHY_SUMMARY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ORG_HRCHY_SUMMARY_WHO" ENABLE;
