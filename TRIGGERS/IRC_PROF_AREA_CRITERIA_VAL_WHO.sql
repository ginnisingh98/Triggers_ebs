--------------------------------------------------------
--  DDL for Trigger IRC_PROF_AREA_CRITERIA_VAL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_PROF_AREA_CRITERIA_VAL_WHO" 
before insert or update on "HR"."IRC_PROF_AREA_CRITERIA_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_PROF_AREA_CRITERIA_VAL_WHO" ENABLE;
