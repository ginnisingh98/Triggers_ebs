--------------------------------------------------------
--  DDL for Trigger BEN_CM_DLVRY_MTHD_TYP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CM_DLVRY_MTHD_TYP_WHO" 
before insert or update on "BEN"."BEN_CM_DLVRY_MTHD_TYP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CM_DLVRY_MTHD_TYP_WHO" ENABLE;
