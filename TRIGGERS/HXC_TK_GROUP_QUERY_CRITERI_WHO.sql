--------------------------------------------------------
--  DDL for Trigger HXC_TK_GROUP_QUERY_CRITERI_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_TK_GROUP_QUERY_CRITERI_WHO" 
before insert or update on "HXC"."HXC_TK_GROUP_QUERY_CRITERIA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_TK_GROUP_QUERY_CRITERI_WHO" ENABLE;
