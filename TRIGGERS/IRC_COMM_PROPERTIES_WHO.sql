--------------------------------------------------------
--  DDL for Trigger IRC_COMM_PROPERTIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_COMM_PROPERTIES_WHO" 
before insert or update on "HR"."IRC_COMM_PROPERTIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_COMM_PROPERTIES_WHO" ENABLE;
