--------------------------------------------------------
--  DDL for Trigger IRC_POSTING_CONTENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_POSTING_CONTENTS_WHO" 
before insert or update on "HR"."IRC_POSTING_CONTENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_POSTING_CONTENTS_WHO" ENABLE;
