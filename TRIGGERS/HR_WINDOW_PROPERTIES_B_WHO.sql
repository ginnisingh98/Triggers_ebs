--------------------------------------------------------
--  DDL for Trigger HR_WINDOW_PROPERTIES_B_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_WINDOW_PROPERTIES_B_WHO" 
before insert or update on "HR"."HR_WINDOW_PROPERTIES_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_WINDOW_PROPERTIES_B_WHO" ENABLE;
