--------------------------------------------------------
--  DDL for Trigger JAI_OM_WDD_ARIUD_T1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."JAI_OM_WDD_ARIUD_T1" 
AFTER INSERT OR UPDATE OR DELETE ON "WSH"."WSH_DELIVERY_DETAILS"
FOR EACH ROW
DECLARE
...
/
ALTER TRIGGER "APPS"."JAI_OM_WDD_ARIUD_T1" DISABLE;
