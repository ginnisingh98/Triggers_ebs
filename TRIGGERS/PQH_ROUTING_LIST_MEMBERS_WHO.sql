--------------------------------------------------------
--  DDL for Trigger PQH_ROUTING_LIST_MEMBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ROUTING_LIST_MEMBERS_WHO" 
before insert or update on "HR"."PQH_ROUTING_LIST_MEMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ROUTING_LIST_MEMBERS_WHO" ENABLE;
