--------------------------------------------------------
--  DDL for Trigger PER_SECURITY_USERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SECURITY_USERS_WHO" 
before insert or update on "HR"."PER_SECURITY_USERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SECURITY_USERS_WHO" ENABLE;
