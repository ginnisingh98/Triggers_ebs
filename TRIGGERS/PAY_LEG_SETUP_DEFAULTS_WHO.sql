--------------------------------------------------------
--  DDL for Trigger PAY_LEG_SETUP_DEFAULTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_LEG_SETUP_DEFAULTS_WHO" 
before insert or update on "HR"."PAY_LEG_SETUP_DEFAULTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_LEG_SETUP_DEFAULTS_WHO" ENABLE;
