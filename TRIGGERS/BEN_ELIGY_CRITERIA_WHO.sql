--------------------------------------------------------
--  DDL for Trigger BEN_ELIGY_CRITERIA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIGY_CRITERIA_WHO" 
before insert or update on "BEN"."BEN_ELIGY_CRITERIA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIGY_CRITERIA_WHO" ENABLE;
