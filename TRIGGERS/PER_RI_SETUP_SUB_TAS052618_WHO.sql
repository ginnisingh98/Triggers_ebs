--------------------------------------------------------
--  DDL for Trigger PER_RI_SETUP_SUB_TAS052618_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_SETUP_SUB_TAS052618_WHO" 
before insert or update on "HR"."PER_RI_SETUP_SUB_TASKS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_SETUP_SUB_TAS052618_WHO" ENABLE;
