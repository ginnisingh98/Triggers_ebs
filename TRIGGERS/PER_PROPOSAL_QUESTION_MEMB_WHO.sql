--------------------------------------------------------
--  DDL for Trigger PER_PROPOSAL_QUESTION_MEMB_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PROPOSAL_QUESTION_MEMB_WHO" 
before insert or update on "HR"."PER_PROPOSAL_QUESTION_MEMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PROPOSAL_QUESTION_MEMB_WHO" ENABLE;
