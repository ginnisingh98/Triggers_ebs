--------------------------------------------------------
--  DDL for Trigger DT_COLUMN_PROMPTS_TL052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."DT_COLUMN_PROMPTS_TL052617_WHO" 
before insert or update on "HR"."DT_COLUMN_PROMPTS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."DT_COLUMN_PROMPTS_TL052617_WHO" ENABLE;
