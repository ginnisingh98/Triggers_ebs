--------------------------------------------------------
--  DDL for Trigger PER_BF_PAYMENT_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BF_PAYMENT_DETAILS_WHO" 
before insert or update on "HR"."PER_BF_PAYMENT_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BF_PAYMENT_DETAILS_WHO" ENABLE;
