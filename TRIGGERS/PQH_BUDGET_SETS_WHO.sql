--------------------------------------------------------
--  DDL for Trigger PQH_BUDGET_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BUDGET_SETS_WHO" 
before insert or update on "HR"."PQH_BUDGET_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BUDGET_SETS_WHO" ENABLE;
