--------------------------------------------------------
--  DDL for Trigger GHR_PROCESS_LOG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PROCESS_LOG_WHO" 
before insert or update on "HR"."GHR_PROCESS_LOG"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PROCESS_LOG_WHO" ENABLE;
