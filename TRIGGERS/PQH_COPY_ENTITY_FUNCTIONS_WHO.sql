--------------------------------------------------------
--  DDL for Trigger PQH_COPY_ENTITY_FUNCTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_COPY_ENTITY_FUNCTIONS_WHO" 
before insert or update on "HR"."PQH_COPY_ENTITY_FUNCTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_COPY_ENTITY_FUNCTIONS_WHO" ENABLE;
