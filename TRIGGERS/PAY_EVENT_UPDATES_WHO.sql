--------------------------------------------------------
--  DDL for Trigger PAY_EVENT_UPDATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_EVENT_UPDATES_WHO" 
before insert or update on "HR"."PAY_EVENT_UPDATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_EVENT_UPDATES_WHO" ENABLE;
