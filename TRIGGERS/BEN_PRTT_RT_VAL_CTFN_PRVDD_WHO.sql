--------------------------------------------------------
--  DDL for Trigger BEN_PRTT_RT_VAL_CTFN_PRVDD_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTT_RT_VAL_CTFN_PRVDD_WHO" 
before insert or update on "BEN"."BEN_PRTT_RT_VAL_CTFN_PRVDD"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTT_RT_VAL_CTFN_PRVDD_WHO" ENABLE;
