--------------------------------------------------------
--  DDL for Trigger PER_QUALIFICATIONS_T052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_QUALIFICATIONS_T052616_WHO" 
before insert or update on "HR"."PER_QUALIFICATIONS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_QUALIFICATIONS_T052616_WHO" ENABLE;
