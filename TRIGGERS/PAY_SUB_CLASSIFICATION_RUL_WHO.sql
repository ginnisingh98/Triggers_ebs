--------------------------------------------------------
--  DDL for Trigger PAY_SUB_CLASSIFICATION_RUL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SUB_CLASSIFICATION_RUL_WHO" 
before insert or update on "HR"."PAY_SUB_CLASSIFICATION_RULES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SUB_CLASSIFICATION_RUL_WHO" ENABLE;
