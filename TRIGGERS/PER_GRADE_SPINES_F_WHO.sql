--------------------------------------------------------
--  DDL for Trigger PER_GRADE_SPINES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_GRADE_SPINES_F_WHO" 
before insert or update on "HR"."PER_GRADE_SPINES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_GRADE_SPINES_F_WHO" ENABLE;
