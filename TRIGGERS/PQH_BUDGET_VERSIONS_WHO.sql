--------------------------------------------------------
--  DDL for Trigger PQH_BUDGET_VERSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BUDGET_VERSIONS_WHO" 
before insert or update on "HR"."PQH_BUDGET_VERSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BUDGET_VERSIONS_WHO" ENABLE;
