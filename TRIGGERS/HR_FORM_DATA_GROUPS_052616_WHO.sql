--------------------------------------------------------
--  DDL for Trigger HR_FORM_DATA_GROUPS_052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_FORM_DATA_GROUPS_052616_WHO" 
before insert or update on "HR"."HR_FORM_DATA_GROUPS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_FORM_DATA_GROUPS_052616_WHO" ENABLE;
