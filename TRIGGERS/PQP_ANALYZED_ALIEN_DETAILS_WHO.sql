--------------------------------------------------------
--  DDL for Trigger PQP_ANALYZED_ALIEN_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_ANALYZED_ALIEN_DETAILS_WHO" 
before insert or update on "HR"."PQP_ANALYZED_ALIEN_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_ANALYZED_ALIEN_DETAILS_WHO" ENABLE;
