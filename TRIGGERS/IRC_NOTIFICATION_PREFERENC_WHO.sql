--------------------------------------------------------
--  DDL for Trigger IRC_NOTIFICATION_PREFERENC_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_NOTIFICATION_PREFERENC_WHO" 
before insert or update on "HR"."IRC_NOTIFICATION_PREFERENCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_NOTIFICATION_PREFERENC_WHO" ENABLE;
