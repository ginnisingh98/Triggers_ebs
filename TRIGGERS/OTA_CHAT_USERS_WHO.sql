--------------------------------------------------------
--  DDL for Trigger OTA_CHAT_USERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CHAT_USERS_WHO" 
before insert or update on "OTA"."OTA_CHAT_USERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CHAT_USERS_WHO" ENABLE;
