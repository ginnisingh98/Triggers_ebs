--------------------------------------------------------
--  DDL for Trigger BEN_ACTN_TYP_TL052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ACTN_TYP_TL052616_WHO" 
before insert or update on "BEN"."BEN_ACTN_TYP_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ACTN_TYP_TL052616_WHO" ENABLE;
