--------------------------------------------------------
--  DDL for Trigger FF_DATABASE_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_DATABASE_ITEMS_WHO" 
before insert or update on "HR"."FF_DATABASE_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_DATABASE_ITEMS_WHO" ENABLE;
