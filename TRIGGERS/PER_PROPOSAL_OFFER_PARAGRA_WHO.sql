--------------------------------------------------------
--  DDL for Trigger PER_PROPOSAL_OFFER_PARAGRA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PROPOSAL_OFFER_PARAGRA_WHO" 
before insert or update on "HR"."PER_PROPOSAL_OFFER_PARAGRAPHS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PROPOSAL_OFFER_PARAGRA_WHO" ENABLE;
