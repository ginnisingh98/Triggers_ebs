--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_LINKS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_LINKS_F_WHO" 
before insert or update on "HR"."PAY_ELEMENT_LINKS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_LINKS_F_WHO" ENABLE;
