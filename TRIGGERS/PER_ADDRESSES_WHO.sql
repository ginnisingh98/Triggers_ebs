--------------------------------------------------------
--  DDL for Trigger PER_ADDRESSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ADDRESSES_WHO" 
before insert or update on "HR"."PER_ADDRESSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ADDRESSES_WHO" ENABLE;
