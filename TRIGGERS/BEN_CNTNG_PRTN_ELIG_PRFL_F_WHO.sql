--------------------------------------------------------
--  DDL for Trigger BEN_CNTNG_PRTN_ELIG_PRFL_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CNTNG_PRTN_ELIG_PRFL_F_WHO" 
before insert or update on "BEN"."BEN_CNTNG_PRTN_ELIG_PRFL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CNTNG_PRTN_ELIG_PRFL_F_WHO" ENABLE;
