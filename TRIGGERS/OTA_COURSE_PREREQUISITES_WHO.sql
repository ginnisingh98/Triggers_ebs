--------------------------------------------------------
--  DDL for Trigger OTA_COURSE_PREREQUISITES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_COURSE_PREREQUISITES_WHO" 
before insert or update on "OTA"."OTA_COURSE_PREREQUISITES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_COURSE_PREREQUISITES_WHO" ENABLE;
