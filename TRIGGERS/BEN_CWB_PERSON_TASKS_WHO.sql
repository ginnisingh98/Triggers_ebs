--------------------------------------------------------
--  DDL for Trigger BEN_CWB_PERSON_TASKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_PERSON_TASKS_WHO" 
before insert or update on "BEN"."BEN_CWB_PERSON_TASKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_PERSON_TASKS_WHO" ENABLE;
