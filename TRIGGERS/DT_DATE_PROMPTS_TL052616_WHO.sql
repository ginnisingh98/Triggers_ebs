--------------------------------------------------------
--  DDL for Trigger DT_DATE_PROMPTS_TL052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."DT_DATE_PROMPTS_TL052616_WHO" 
before insert or update on "HR"."DT_DATE_PROMPTS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."DT_DATE_PROMPTS_TL052616_WHO" ENABLE;
