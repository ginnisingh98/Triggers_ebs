--------------------------------------------------------
--  DDL for Trigger HR_FORM_DATA_GROUPS_B_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_FORM_DATA_GROUPS_B_WHO" 
before insert or update on "HR"."HR_FORM_DATA_GROUPS_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_FORM_DATA_GROUPS_B_WHO" ENABLE;
