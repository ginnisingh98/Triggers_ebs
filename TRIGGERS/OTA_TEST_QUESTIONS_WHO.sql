--------------------------------------------------------
--  DDL for Trigger OTA_TEST_QUESTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_TEST_QUESTIONS_WHO" 
before insert or update on "OTA"."OTA_TEST_QUESTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_TEST_QUESTIONS_WHO" ENABLE;
