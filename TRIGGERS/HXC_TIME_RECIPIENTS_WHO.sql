--------------------------------------------------------
--  DDL for Trigger HXC_TIME_RECIPIENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_TIME_RECIPIENTS_WHO" 
before insert or update on "HXC"."HXC_TIME_RECIPIENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_TIME_RECIPIENTS_WHO" ENABLE;
