--------------------------------------------------------
--  DDL for Trigger PAY_INPUT_VALUES_F_T052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_INPUT_VALUES_F_T052617_WHO" 
before insert or update on "HR"."PAY_INPUT_VALUES_F_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_INPUT_VALUES_F_T052617_WHO" ENABLE;
