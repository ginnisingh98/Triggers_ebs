--------------------------------------------------------
--  DDL for Trigger PER_ELECTION_CANDIDATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ELECTION_CANDIDATES_WHO" 
before insert or update on "HR"."PER_ELECTION_CANDIDATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ELECTION_CANDIDATES_WHO" ENABLE;
