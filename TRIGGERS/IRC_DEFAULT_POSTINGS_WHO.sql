--------------------------------------------------------
--  DDL for Trigger IRC_DEFAULT_POSTINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_DEFAULT_POSTINGS_WHO" 
before insert or update on "HR"."IRC_DEFAULT_POSTINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_DEFAULT_POSTINGS_WHO" ENABLE;
