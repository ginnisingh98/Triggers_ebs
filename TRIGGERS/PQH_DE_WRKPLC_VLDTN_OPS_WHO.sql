--------------------------------------------------------
--  DDL for Trigger PQH_DE_WRKPLC_VLDTN_OPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_WRKPLC_VLDTN_OPS_WHO" 
before insert or update on "HR"."PQH_DE_WRKPLC_VLDTN_OPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_WRKPLC_VLDTN_OPS_WHO" ENABLE;
