--------------------------------------------------------
--  DDL for Trigger PER_CONTACT_RELATIONSHIPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CONTACT_RELATIONSHIPS_WHO" 
before insert or update on "HR"."PER_CONTACT_RELATIONSHIPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CONTACT_RELATIONSHIPS_WHO" ENABLE;
