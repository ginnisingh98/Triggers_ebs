--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_PER_OPT_F_RBV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_PER_OPT_F_RBV_WHO" 
before insert or update on "BEN"."BEN_ELIG_PER_OPT_F_RBV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_PER_OPT_F_RBV_WHO" ENABLE;
