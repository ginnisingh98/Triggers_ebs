--------------------------------------------------------
--  DDL for Trigger HXC_APPROVAL_PERIOD_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_APPROVAL_PERIOD_SETS_WHO" 
before insert or update on "HXC"."HXC_APPROVAL_PERIOD_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_APPROVAL_PERIOD_SETS_WHO" ENABLE;
