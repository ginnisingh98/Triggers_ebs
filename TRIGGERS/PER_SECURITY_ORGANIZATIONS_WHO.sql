--------------------------------------------------------
--  DDL for Trigger PER_SECURITY_ORGANIZATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SECURITY_ORGANIZATIONS_WHO" 
before insert or update on "HR"."PER_SECURITY_ORGANIZATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SECURITY_ORGANIZATIONS_WHO" ENABLE;
