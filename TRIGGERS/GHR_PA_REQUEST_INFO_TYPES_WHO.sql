--------------------------------------------------------
--  DDL for Trigger GHR_PA_REQUEST_INFO_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PA_REQUEST_INFO_TYPES_WHO" 
before insert or update on "HR"."GHR_PA_REQUEST_INFO_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PA_REQUEST_INFO_TYPES_WHO" ENABLE;
