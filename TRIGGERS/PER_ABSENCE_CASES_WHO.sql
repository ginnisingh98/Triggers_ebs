--------------------------------------------------------
--  DDL for Trigger PER_ABSENCE_CASES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ABSENCE_CASES_WHO" 
before insert or update on "HR"."PER_ABSENCE_CASES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ABSENCE_CASES_WHO" ENABLE;
