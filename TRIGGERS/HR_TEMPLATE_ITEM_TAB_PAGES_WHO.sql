--------------------------------------------------------
--  DDL for Trigger HR_TEMPLATE_ITEM_TAB_PAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_TEMPLATE_ITEM_TAB_PAGES_WHO" 
before insert or update on "HR"."HR_TEMPLATE_ITEM_TAB_PAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_TEMPLATE_ITEM_TAB_PAGES_WHO" ENABLE;
