--------------------------------------------------------
--  DDL for Trigger PAY_ACTION_INFORMATION_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ACTION_INFORMATION_WHO" 
before insert or update on "HR"."PAY_ACTION_INFORMATION"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ACTION_INFORMATION_WHO" ENABLE;
