--------------------------------------------------------
--  DDL for Trigger OTA_UTEST_QUESTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_UTEST_QUESTIONS_WHO" 
before insert or update on "OTA"."OTA_UTEST_QUESTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_UTEST_QUESTIONS_WHO" ENABLE;
