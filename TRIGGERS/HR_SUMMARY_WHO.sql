--------------------------------------------------------
--  DDL for Trigger HR_SUMMARY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_SUMMARY_WHO" 
before insert or update on "HR"."HR_SUMMARY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_SUMMARY_WHO" ENABLE;
