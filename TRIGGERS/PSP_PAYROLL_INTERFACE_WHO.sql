--------------------------------------------------------
--  DDL for Trigger PSP_PAYROLL_INTERFACE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_PAYROLL_INTERFACE_WHO" 
before insert or update on "PSP"."PSP_PAYROLL_INTERFACE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_PAYROLL_INTERFACE_WHO" ENABLE;
