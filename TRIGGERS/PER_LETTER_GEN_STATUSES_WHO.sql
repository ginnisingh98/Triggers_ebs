--------------------------------------------------------
--  DDL for Trigger PER_LETTER_GEN_STATUSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_LETTER_GEN_STATUSES_WHO" 
before insert or update on "HR"."PER_LETTER_GEN_STATUSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_LETTER_GEN_STATUSES_WHO" ENABLE;
