--------------------------------------------------------
--  DDL for Trigger PER_PAY_TRANSACTION_HISTOR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PAY_TRANSACTION_HISTOR_WHO" 
before insert or update on "HR"."PER_PAY_TRANSACTION_HISTORY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PAY_TRANSACTION_HISTOR_WHO" ENABLE;
