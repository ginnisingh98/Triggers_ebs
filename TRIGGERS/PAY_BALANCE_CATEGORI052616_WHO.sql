--------------------------------------------------------
--  DDL for Trigger PAY_BALANCE_CATEGORI052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_BALANCE_CATEGORI052616_WHO" 
before insert or update on "HR"."PAY_BALANCE_CATEGORIES_F_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_BALANCE_CATEGORI052616_WHO" ENABLE;
