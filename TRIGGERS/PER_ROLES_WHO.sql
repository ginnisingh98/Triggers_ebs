--------------------------------------------------------
--  DDL for Trigger PER_ROLES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ROLES_WHO" 
before insert or update on "HR"."PER_ROLES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ROLES_WHO" ENABLE;
