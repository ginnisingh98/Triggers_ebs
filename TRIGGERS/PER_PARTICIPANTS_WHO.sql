--------------------------------------------------------
--  DDL for Trigger PER_PARTICIPANTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PARTICIPANTS_WHO" 
before insert or update on "HR"."PER_PARTICIPANTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PARTICIPANTS_WHO" ENABLE;
