--------------------------------------------------------
--  DDL for Trigger HR_EFC_CURRENCY_HISTORIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_EFC_CURRENCY_HISTORIES_WHO" 
before insert or update on "HR"."HR_EFC_CURRENCY_HISTORIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_EFC_CURRENCY_HISTORIES_WHO" ENABLE;
