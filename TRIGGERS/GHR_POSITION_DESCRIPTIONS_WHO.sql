--------------------------------------------------------
--  DDL for Trigger GHR_POSITION_DESCRIPTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_POSITION_DESCRIPTIONS_WHO" 
before insert or update on "HR"."GHR_POSITION_DESCRIPTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_POSITION_DESCRIPTIONS_WHO" ENABLE;
