--------------------------------------------------------
--  DDL for Trigger HR_H2PI_ID_MAPPING_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_H2PI_ID_MAPPING_WHO" 
before insert or update on "HR"."HR_H2PI_ID_MAPPING"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_H2PI_ID_MAPPING_WHO" ENABLE;
