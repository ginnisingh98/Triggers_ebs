--------------------------------------------------------
--  DDL for Trigger PER_ESTABLISHMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ESTABLISHMENTS_WHO" 
before insert or update on "HR"."PER_ESTABLISHMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ESTABLISHMENTS_WHO" ENABLE;
