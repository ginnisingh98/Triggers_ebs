--------------------------------------------------------
--  DDL for Trigger PSP_EFF_REPORTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_EFF_REPORTS_WHO" 
before insert or update on "PSP"."PSP_EFF_REPORTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_EFF_REPORTS_WHO" ENABLE;
