--------------------------------------------------------
--  DDL for Trigger JAI_RCV_RT_ARIUD_T1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."JAI_RCV_RT_ARIUD_T1" 
AFTER INSERT OR UPDATE OR DELETE ON "PO"."RCV_TRANSACTIONS"
FOR EACH ROW
DECLARE
...
/
ALTER TRIGGER "APPS"."JAI_RCV_RT_ARIUD_T1" DISABLE;
