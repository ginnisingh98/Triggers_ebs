--------------------------------------------------------
--  DDL for Trigger HXC_MAPPING_COMPONENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_MAPPING_COMPONENTS_WHO" 
before insert or update on "HXC"."HXC_MAPPING_COMPONENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_MAPPING_COMPONENTS_WHO" ENABLE;
