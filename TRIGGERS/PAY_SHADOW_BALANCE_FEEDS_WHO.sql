--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_BALANCE_FEEDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_BALANCE_FEEDS_WHO" 
before insert or update on "HR"."PAY_SHADOW_BALANCE_FEEDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_BALANCE_FEEDS_WHO" ENABLE;
