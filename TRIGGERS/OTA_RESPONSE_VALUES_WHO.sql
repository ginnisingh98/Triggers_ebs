--------------------------------------------------------
--  DDL for Trigger OTA_RESPONSE_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_RESPONSE_VALUES_WHO" 
before insert or update on "OTA"."OTA_RESPONSE_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_RESPONSE_VALUES_WHO" ENABLE;
