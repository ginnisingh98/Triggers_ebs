--------------------------------------------------------
--  DDL for Trigger PAY_RESTRICTION_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_RESTRICTION_VALUES_WHO" 
before insert or update on "HR"."PAY_RESTRICTION_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_RESTRICTION_VALUES_WHO" ENABLE;
