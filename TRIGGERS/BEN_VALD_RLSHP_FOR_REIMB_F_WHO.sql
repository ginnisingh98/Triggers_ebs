--------------------------------------------------------
--  DDL for Trigger BEN_VALD_RLSHP_FOR_REIMB_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_VALD_RLSHP_FOR_REIMB_F_WHO" 
before insert or update on "BEN"."BEN_VALD_RLSHP_FOR_REIMB_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_VALD_RLSHP_FOR_REIMB_F_WHO" ENABLE;
