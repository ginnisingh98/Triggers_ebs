--------------------------------------------------------
--  DDL for Trigger PER_BF_BALANCE_AMOUNTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BF_BALANCE_AMOUNTS_WHO" 
before insert or update on "HR"."PER_BF_BALANCE_AMOUNTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BF_BALANCE_AMOUNTS_WHO" ENABLE;
