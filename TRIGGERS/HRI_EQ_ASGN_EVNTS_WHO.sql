--------------------------------------------------------
--  DDL for Trigger HRI_EQ_ASGN_EVNTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_ASGN_EVNTS_WHO" 
before insert or update on "HRI"."HRI_EQ_ASGN_EVNTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_ASGN_EVNTS_WHO" ENABLE;
