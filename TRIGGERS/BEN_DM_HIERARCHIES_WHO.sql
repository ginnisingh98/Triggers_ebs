--------------------------------------------------------
--  DDL for Trigger BEN_DM_HIERARCHIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DM_HIERARCHIES_WHO" 
before insert or update on "BEN"."BEN_DM_HIERARCHIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DM_HIERARCHIES_WHO" ENABLE;
