--------------------------------------------------------
--  DDL for Trigger GHR_NOAC_LAS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_NOAC_LAS_WHO" 
before insert or update on "HR"."GHR_NOAC_LAS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_NOAC_LAS_WHO" ENABLE;
