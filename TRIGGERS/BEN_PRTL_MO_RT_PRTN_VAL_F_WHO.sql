--------------------------------------------------------
--  DDL for Trigger BEN_PRTL_MO_RT_PRTN_VAL_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTL_MO_RT_PRTN_VAL_F_WHO" 
before insert or update on "BEN"."BEN_PRTL_MO_RT_PRTN_VAL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTL_MO_RT_PRTN_VAL_F_WHO" ENABLE;
