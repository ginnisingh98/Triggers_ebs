--------------------------------------------------------
--  DDL for Trigger PQH_FR_STAT_SITUATION_RULE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_FR_STAT_SITUATION_RULE_WHO" 
before insert or update on "HR"."PQH_FR_STAT_SITUATION_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_FR_STAT_SITUATION_RULE_WHO" ENABLE;
