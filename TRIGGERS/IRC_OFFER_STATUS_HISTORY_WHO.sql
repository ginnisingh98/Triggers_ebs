--------------------------------------------------------
--  DDL for Trigger IRC_OFFER_STATUS_HISTORY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_OFFER_STATUS_HISTORY_WHO" 
before insert or update on "HR"."IRC_OFFER_STATUS_HISTORY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_OFFER_STATUS_HISTORY_WHO" ENABLE;
