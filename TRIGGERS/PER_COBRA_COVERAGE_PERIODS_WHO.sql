--------------------------------------------------------
--  DDL for Trigger PER_COBRA_COVERAGE_PERIODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COBRA_COVERAGE_PERIODS_WHO" 
before insert or update on "HR"."PER_COBRA_COVERAGE_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COBRA_COVERAGE_PERIODS_WHO" ENABLE;
