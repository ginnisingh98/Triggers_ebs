--------------------------------------------------------
--  DDL for Trigger FF_ROUTE_PARAMETER_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_ROUTE_PARAMETER_VALUES_WHO" 
before insert or update on "HR"."FF_ROUTE_PARAMETER_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_ROUTE_PARAMETER_VALUES_WHO" ENABLE;
