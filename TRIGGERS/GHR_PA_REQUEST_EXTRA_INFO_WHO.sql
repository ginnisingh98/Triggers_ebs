--------------------------------------------------------
--  DDL for Trigger GHR_PA_REQUEST_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PA_REQUEST_EXTRA_INFO_WHO" 
before insert or update on "HR"."GHR_PA_REQUEST_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PA_REQUEST_EXTRA_INFO_WHO" ENABLE;
