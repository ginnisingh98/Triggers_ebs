--------------------------------------------------------
--  DDL for Trigger HR_FORM_TEMPLATES_TL052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_FORM_TEMPLATES_TL052615_WHO" 
before insert or update on "HR"."HR_FORM_TEMPLATES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_FORM_TEMPLATES_TL052615_WHO" ENABLE;
