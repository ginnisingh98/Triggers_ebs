--------------------------------------------------------
--  DDL for Trigger PER_TIME_PERIOD_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_TIME_PERIOD_RULES_WHO" 
before insert or update on "HR"."PER_TIME_PERIOD_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_TIME_PERIOD_RULES_WHO" ENABLE;
