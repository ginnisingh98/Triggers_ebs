--------------------------------------------------------
--  DDL for Trigger BOM_BICI_UNIQUE_ID_T
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BOM_BICI_UNIQUE_ID_T" 
...
END BOM_BICI_UNIQUE_ID_T;


/
ALTER TRIGGER "APPS"."BOM_BICI_UNIQUE_ID_T" ENABLE;
