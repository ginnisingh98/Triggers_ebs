--------------------------------------------------------
--  DDL for Trigger PAY_PEOPLE_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_PEOPLE_GROUPS_WHO" 
before insert or update on "HR"."PAY_PEOPLE_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_PEOPLE_GROUPS_WHO" ENABLE;
