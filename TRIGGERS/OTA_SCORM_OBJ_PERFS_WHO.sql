--------------------------------------------------------
--  DDL for Trigger OTA_SCORM_OBJ_PERFS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_SCORM_OBJ_PERFS_WHO" 
before insert or update on "OTA"."OTA_SCORM_OBJ_PERFS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_SCORM_OBJ_PERFS_WHO" ENABLE;
