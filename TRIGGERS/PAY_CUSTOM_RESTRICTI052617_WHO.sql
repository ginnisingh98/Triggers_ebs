--------------------------------------------------------
--  DDL for Trigger PAY_CUSTOM_RESTRICTI052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_CUSTOM_RESTRICTI052617_WHO" 
before insert or update on "HR"."PAY_CUSTOM_RESTRICTIONS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_CUSTOM_RESTRICTI052617_WHO" ENABLE;
