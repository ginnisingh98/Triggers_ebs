--------------------------------------------------------
--  DDL for Trigger PSP_ENC_PROCESSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ENC_PROCESSES_WHO" 
before insert or update on "PSP"."PSP_ENC_PROCESSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ENC_PROCESSES_WHO" ENABLE;
