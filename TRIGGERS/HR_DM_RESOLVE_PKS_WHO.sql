--------------------------------------------------------
--  DDL for Trigger HR_DM_RESOLVE_PKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_RESOLVE_PKS_WHO" 
before insert or update on "HR"."HR_DM_RESOLVE_PKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_RESOLVE_PKS_WHO" ENABLE;
