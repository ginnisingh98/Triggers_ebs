--------------------------------------------------------
--  DDL for Trigger PER_RI_CONFIGURATION052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_CONFIGURATION052616_WHO" 
before insert or update on "HR"."PER_RI_CONFIGURATIONS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_CONFIGURATION052616_WHO" ENABLE;
