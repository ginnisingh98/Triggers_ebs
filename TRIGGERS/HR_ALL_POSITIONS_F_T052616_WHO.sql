--------------------------------------------------------
--  DDL for Trigger HR_ALL_POSITIONS_F_T052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ALL_POSITIONS_F_T052616_WHO" 
before insert or update on "HR"."HR_ALL_POSITIONS_F_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ALL_POSITIONS_F_T052616_WHO" ENABLE;
