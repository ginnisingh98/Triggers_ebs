--------------------------------------------------------
--  DDL for Trigger BEN_STARTUP_LERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_STARTUP_LERS_WHO" 
before insert or update on "BEN"."BEN_STARTUP_LERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_STARTUP_LERS_WHO" ENABLE;
