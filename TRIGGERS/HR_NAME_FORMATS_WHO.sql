--------------------------------------------------------
--  DDL for Trigger HR_NAME_FORMATS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_NAME_FORMATS_WHO" 
before insert or update on "HR"."HR_NAME_FORMATS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_NAME_FORMATS_WHO" ENABLE;
