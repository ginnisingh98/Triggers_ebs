--------------------------------------------------------
--  DDL for Trigger PQP_SERVICE_HISTORY_PERIOD_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_SERVICE_HISTORY_PERIOD_WHO" 
before insert or update on "HR"."PQP_SERVICE_HISTORY_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_SERVICE_HISTORY_PERIOD_WHO" ENABLE;
