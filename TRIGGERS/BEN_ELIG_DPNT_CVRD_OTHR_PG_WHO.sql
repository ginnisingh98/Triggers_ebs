--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_DPNT_CVRD_OTHR_PG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_DPNT_CVRD_OTHR_PG_WHO" 
before insert or update on "BEN"."BEN_ELIG_DPNT_CVRD_OTHR_PGM_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_DPNT_CVRD_OTHR_PG_WHO" ENABLE;
