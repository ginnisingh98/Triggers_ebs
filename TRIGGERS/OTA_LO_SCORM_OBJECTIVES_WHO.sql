--------------------------------------------------------
--  DDL for Trigger OTA_LO_SCORM_OBJECTIVES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_LO_SCORM_OBJECTIVES_WHO" 
before insert or update on "OTA"."OTA_LO_SCORM_OBJECTIVES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_LO_SCORM_OBJECTIVES_WHO" ENABLE;
