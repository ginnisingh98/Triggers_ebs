--------------------------------------------------------
--  DDL for Trigger PQH_GL_INTERFACE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_GL_INTERFACE_WHO" 
before insert or update on "HR"."PQH_GL_INTERFACE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_GL_INTERFACE_WHO" ENABLE;
