--------------------------------------------------------
--  DDL for Trigger BEN_LE_CLSN_N_RSTR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_LE_CLSN_N_RSTR_WHO" 
before insert or update on "BEN"."BEN_LE_CLSN_N_RSTR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_LE_CLSN_N_RSTR_WHO" ENABLE;
