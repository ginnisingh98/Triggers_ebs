--------------------------------------------------------
--  DDL for Trigger PSP_AUTO_NA_BYPASS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_AUTO_NA_BYPASS_WHO" 
before insert or update on "PSP"."PSP_AUTO_NA_BYPASS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_AUTO_NA_BYPASS_WHO" ENABLE;
