--------------------------------------------------------
--  DDL for Trigger PER_ASSESSMENT_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASSESSMENT_GROUPS_WHO" 
before insert or update on "HR"."PER_ASSESSMENT_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ASSESSMENT_GROUPS_WHO" ENABLE;
