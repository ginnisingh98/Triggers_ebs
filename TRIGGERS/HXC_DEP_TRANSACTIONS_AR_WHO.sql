--------------------------------------------------------
--  DDL for Trigger HXC_DEP_TRANSACTIONS_AR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_DEP_TRANSACTIONS_AR_WHO" 
before insert or update on "HXC"."HXC_DEP_TRANSACTIONS_AR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_DEP_TRANSACTIONS_AR_WHO" ENABLE;
