--------------------------------------------------------
--  DDL for Trigger BEN_EXT_INCL_DATA_ELMT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_INCL_DATA_ELMT_WHO" 
before insert or update on "BEN"."BEN_EXT_INCL_DATA_ELMT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_INCL_DATA_ELMT_WHO" ENABLE;
