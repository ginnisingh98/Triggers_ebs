--------------------------------------------------------
--  DDL for Trigger PAY_BALANCE_CATEGORIES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_BALANCE_CATEGORIES_F_WHO" 
before insert or update on "HR"."PAY_BALANCE_CATEGORIES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_BALANCE_CATEGORIES_F_WHO" ENABLE;
