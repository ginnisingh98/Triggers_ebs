--------------------------------------------------------
--  DDL for Trigger HXC_TIME_SOURCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_TIME_SOURCES_WHO" 
before insert or update on "HXC"."HXC_TIME_SOURCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_TIME_SOURCES_WHO" ENABLE;
