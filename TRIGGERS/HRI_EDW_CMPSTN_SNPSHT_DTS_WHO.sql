--------------------------------------------------------
--  DDL for Trigger HRI_EDW_CMPSTN_SNPSHT_DTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EDW_CMPSTN_SNPSHT_DTS_WHO" 
before insert or update on "HRI"."HRI_EDW_CMPSTN_SNPSHT_DTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EDW_CMPSTN_SNPSHT_DTS_WHO" ENABLE;
