--------------------------------------------------------
--  DDL for Trigger HRI_EDW_EVENT_HRCHY_CMBNS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EDW_EVENT_HRCHY_CMBNS_WHO" 
before insert or update on "HRI"."HRI_EDW_EVENT_HRCHY_CMBNS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EDW_EVENT_HRCHY_CMBNS_WHO" ENABLE;
