--------------------------------------------------------
--  DDL for Trigger HRI_SERVICE_BANDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_SERVICE_BANDS_WHO" 
before insert or update on "HRI"."HRI_SERVICE_BANDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_SERVICE_BANDS_WHO" ENABLE;
