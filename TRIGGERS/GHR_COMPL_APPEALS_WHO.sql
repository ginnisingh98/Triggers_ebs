--------------------------------------------------------
--  DDL for Trigger GHR_COMPL_APPEALS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPL_APPEALS_WHO" 
before insert or update on "HR"."GHR_COMPL_APPEALS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPL_APPEALS_WHO" ENABLE;
