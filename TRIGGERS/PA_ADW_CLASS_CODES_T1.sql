--------------------------------------------------------
--  DDL for Trigger PA_ADW_CLASS_CODES_T1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PA_ADW_CLASS_CODES_T1" 
-- $Header: PATRIG01.pls 115.5 99/07/16 15:14:43 porting ship  $
BEFORE UPDATE OF
  -- Columns required for data warehouse
  CLASS_CODE,
  DESCRIPTION
ON "PA"."PA_CLASS_CODES"
FOR EACH ROW
...
/
ALTER TRIGGER "APPS"."PA_ADW_CLASS_CODES_T1" ENABLE;
