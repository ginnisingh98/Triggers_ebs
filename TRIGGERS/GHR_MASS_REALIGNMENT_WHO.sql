--------------------------------------------------------
--  DDL for Trigger GHR_MASS_REALIGNMENT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_MASS_REALIGNMENT_WHO" 
before insert or update on "HR"."GHR_MASS_REALIGNMENT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_MASS_REALIGNMENT_WHO" ENABLE;
