--------------------------------------------------------
--  DDL for Trigger GHR_GROUPBOX_USERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_GROUPBOX_USERS_WHO" 
before insert or update on "HR"."GHR_GROUPBOX_USERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_GROUPBOX_USERS_WHO" ENABLE;
