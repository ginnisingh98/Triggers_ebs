--------------------------------------------------------
--  DDL for Trigger PER_INFO_TYPE_SECURITY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_INFO_TYPE_SECURITY_WHO" 
before insert or update on "HR"."PER_INFO_TYPE_SECURITY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_INFO_TYPE_SECURITY_WHO" ENABLE;
