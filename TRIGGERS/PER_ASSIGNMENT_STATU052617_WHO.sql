--------------------------------------------------------
--  DDL for Trigger PER_ASSIGNMENT_STATU052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASSIGNMENT_STATU052617_WHO" 
before insert or update on "HR"."PER_ASSIGNMENT_STATUS_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ASSIGNMENT_STATU052617_WHO" ENABLE;
