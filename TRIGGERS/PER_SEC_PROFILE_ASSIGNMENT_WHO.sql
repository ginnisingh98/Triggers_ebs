--------------------------------------------------------
--  DDL for Trigger PER_SEC_PROFILE_ASSIGNMENT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SEC_PROFILE_ASSIGNMENT_WHO" 
before insert or update on "HR"."PER_SEC_PROFILE_ASSIGNMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SEC_PROFILE_ASSIGNMENT_WHO" ENABLE;
