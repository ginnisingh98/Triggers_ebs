--------------------------------------------------------
--  DDL for Trigger HR_EFC_ROUNDING_ERRORS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_EFC_ROUNDING_ERRORS_WHO" 
before insert or update on "HR"."HR_EFC_ROUNDING_ERRORS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_EFC_ROUNDING_ERRORS_WHO" ENABLE;
