--------------------------------------------------------
--  DDL for Trigger PER_WORK_INCIDENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_WORK_INCIDENTS_WHO" 
before insert or update on "HR"."PER_WORK_INCIDENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_WORK_INCIDENTS_WHO" ENABLE;
