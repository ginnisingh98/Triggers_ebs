--------------------------------------------------------
--  DDL for Trigger HXC_DEP_TRANSACTION_DETAIL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_DEP_TRANSACTION_DETAIL_WHO" 
before insert or update on "HXC"."HXC_DEP_TRANSACTION_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_DEP_TRANSACTION_DETAIL_WHO" ENABLE;
