--------------------------------------------------------
--  DDL for Trigger PQP_VEH_REPOS_INFO_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_VEH_REPOS_INFO_TYPES_WHO" 
before insert or update on "HR"."PQP_VEH_REPOS_INFO_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_VEH_REPOS_INFO_TYPES_WHO" ENABLE;
