--------------------------------------------------------
--  DDL for Trigger OTA_FORUM_MESSAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_FORUM_MESSAGES_WHO" 
before insert or update on "OTA"."OTA_FORUM_MESSAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_FORUM_MESSAGES_WHO" ENABLE;
