--------------------------------------------------------
--  DDL for Trigger BEN_DM_RESOLVE_MAPPINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DM_RESOLVE_MAPPINGS_WHO" 
before insert or update on "BEN"."BEN_DM_RESOLVE_MAPPINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DM_RESOLVE_MAPPINGS_WHO" ENABLE;
