--------------------------------------------------------
--  DDL for Trigger BEN_EXT_FLD_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_FLD_WHO" 
before insert or update on "BEN"."BEN_EXT_FLD"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_FLD_WHO" ENABLE;
