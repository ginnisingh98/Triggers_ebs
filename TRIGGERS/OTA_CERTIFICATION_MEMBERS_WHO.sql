--------------------------------------------------------
--  DDL for Trigger OTA_CERTIFICATION_MEMBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CERTIFICATION_MEMBERS_WHO" 
before insert or update on "OTA"."OTA_CERTIFICATION_MEMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CERTIFICATION_MEMBERS_WHO" ENABLE;
