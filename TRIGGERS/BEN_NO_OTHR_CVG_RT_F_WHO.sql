--------------------------------------------------------
--  DDL for Trigger BEN_NO_OTHR_CVG_RT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_NO_OTHR_CVG_RT_F_WHO" 
before insert or update on "BEN"."BEN_NO_OTHR_CVG_RT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_NO_OTHR_CVG_RT_F_WHO" ENABLE;
