--------------------------------------------------------
--  DDL for Trigger HR_DM_SEQUENCE_HISTORIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_SEQUENCE_HISTORIES_WHO" 
before insert or update on "HR"."HR_DM_SEQUENCE_HISTORIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_SEQUENCE_HISTORIES_WHO" ENABLE;
