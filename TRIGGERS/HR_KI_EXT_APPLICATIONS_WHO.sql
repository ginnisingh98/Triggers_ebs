--------------------------------------------------------
--  DDL for Trigger HR_KI_EXT_APPLICATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_EXT_APPLICATIONS_WHO" 
before insert or update on "HR"."HR_KI_EXT_APPLICATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_EXT_APPLICATIONS_WHO" ENABLE;
