--------------------------------------------------------
--  DDL for Trigger PER_PERSON_DLVRY_METHODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERSON_DLVRY_METHODS_WHO" 
before insert or update on "HR"."PER_PERSON_DLVRY_METHODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERSON_DLVRY_METHODS_WHO" ENABLE;
