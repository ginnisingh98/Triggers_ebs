--------------------------------------------------------
--  DDL for Trigger HR_TEMPLATE_ITEMS_B_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_TEMPLATE_ITEMS_B_WHO" 
before insert or update on "HR"."HR_TEMPLATE_ITEMS_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_TEMPLATE_ITEMS_B_WHO" ENABLE;
