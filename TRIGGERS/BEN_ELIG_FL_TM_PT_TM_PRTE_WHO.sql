--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_FL_TM_PT_TM_PRTE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_FL_TM_PT_TM_PRTE_WHO" 
before insert or update on "BEN"."BEN_ELIG_FL_TM_PT_TM_PRTE_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_FL_TM_PT_TM_PRTE_WHO" ENABLE;
