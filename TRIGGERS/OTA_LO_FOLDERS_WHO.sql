--------------------------------------------------------
--  DDL for Trigger OTA_LO_FOLDERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_LO_FOLDERS_WHO" 
before insert or update on "OTA"."OTA_LO_FOLDERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_LO_FOLDERS_WHO" ENABLE;
