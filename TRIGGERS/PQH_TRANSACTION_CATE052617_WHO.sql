--------------------------------------------------------
--  DDL for Trigger PQH_TRANSACTION_CATE052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_TRANSACTION_CATE052617_WHO" 
before insert or update on "HR"."PQH_TRANSACTION_CATEGORIES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_TRANSACTION_CATE052617_WHO" ENABLE;
