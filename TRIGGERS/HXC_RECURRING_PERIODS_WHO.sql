--------------------------------------------------------
--  DDL for Trigger HXC_RECURRING_PERIODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_RECURRING_PERIODS_WHO" 
before insert or update on "HXC"."HXC_RECURRING_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_RECURRING_PERIODS_WHO" ENABLE;
