--------------------------------------------------------
--  DDL for Trigger HR_KI_SESSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_SESSIONS_WHO" 
before insert or update on "HR"."HR_KI_SESSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_SESSIONS_WHO" ENABLE;
