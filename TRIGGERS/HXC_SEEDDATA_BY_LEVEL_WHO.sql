--------------------------------------------------------
--  DDL for Trigger HXC_SEEDDATA_BY_LEVEL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_SEEDDATA_BY_LEVEL_WHO" 
before insert or update on "HXC"."HXC_SEEDDATA_BY_LEVEL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_SEEDDATA_BY_LEVEL_WHO" ENABLE;
