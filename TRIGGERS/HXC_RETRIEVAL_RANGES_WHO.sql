--------------------------------------------------------
--  DDL for Trigger HXC_RETRIEVAL_RANGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_RETRIEVAL_RANGES_WHO" 
before insert or update on "HXC"."HXC_RETRIEVAL_RANGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_RETRIEVAL_RANGES_WHO" ENABLE;
