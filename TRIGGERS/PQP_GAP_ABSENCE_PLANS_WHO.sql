--------------------------------------------------------
--  DDL for Trigger PQP_GAP_ABSENCE_PLANS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_GAP_ABSENCE_PLANS_WHO" 
before insert or update on "HR"."PQP_GAP_ABSENCE_PLANS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_GAP_ABSENCE_PLANS_WHO" ENABLE;
