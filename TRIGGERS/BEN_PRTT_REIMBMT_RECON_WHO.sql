--------------------------------------------------------
--  DDL for Trigger BEN_PRTT_REIMBMT_RECON_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTT_REIMBMT_RECON_WHO" 
before insert or update on "BEN"."BEN_PRTT_REIMBMT_RECON"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTT_REIMBMT_RECON_WHO" ENABLE;
