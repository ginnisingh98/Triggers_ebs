--------------------------------------------------------
--  DDL for Trigger PSP_AUTO_SEGMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_AUTO_SEGMENTS_WHO" 
before insert or update on "PSP"."PSP_AUTO_SEGMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_AUTO_SEGMENTS_WHO" ENABLE;
