--------------------------------------------------------
--  DDL for Trigger PER_COBRA_COV_ENROLLMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COBRA_COV_ENROLLMENTS_WHO" 
before insert or update on "HR"."PER_COBRA_COV_ENROLLMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COBRA_COV_ENROLLMENTS_WHO" ENABLE;
