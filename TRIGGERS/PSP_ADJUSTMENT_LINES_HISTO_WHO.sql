--------------------------------------------------------
--  DDL for Trigger PSP_ADJUSTMENT_LINES_HISTO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ADJUSTMENT_LINES_HISTO_WHO" 
before insert or update on "PSP"."PSP_ADJUSTMENT_LINES_HISTORY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ADJUSTMENT_LINES_HISTO_WHO" ENABLE;
