--------------------------------------------------------
--  DDL for Trigger HR_PUMP_MODULE_PARAMETERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PUMP_MODULE_PARAMETERS_WHO" 
before insert or update on "HR"."HR_PUMP_MODULE_PARAMETERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PUMP_MODULE_PARAMETERS_WHO" ENABLE;
