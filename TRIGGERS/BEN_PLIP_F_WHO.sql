--------------------------------------------------------
--  DDL for Trigger BEN_PLIP_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PLIP_F_WHO" 
before insert or update on "BEN"."BEN_PLIP_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PLIP_F_WHO" ENABLE;
