--------------------------------------------------------
--  DDL for Trigger PQH_TXN_CATEGORY_DOCUMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_TXN_CATEGORY_DOCUMENTS_WHO" 
before insert or update on "HR"."PQH_TXN_CATEGORY_DOCUMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_TXN_CATEGORY_DOCUMENTS_WHO" ENABLE;
