--------------------------------------------------------
--  DDL for Trigger IRC_VAC_ALLOWED_STATUS_TYP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_VAC_ALLOWED_STATUS_TYP_WHO" 
before insert or update on "HR"."IRC_VAC_ALLOWED_STATUS_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_VAC_ALLOWED_STATUS_TYP_WHO" ENABLE;
