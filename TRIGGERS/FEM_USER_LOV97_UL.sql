--------------------------------------------------------
--  DDL for Trigger FEM_USER_LOV97_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_LOV97_UL" 
instead of update on FEM_USER_LOV97_VL
...
/
ALTER TRIGGER "APPS"."FEM_USER_LOV97_UL" ENABLE;
