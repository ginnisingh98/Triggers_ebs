--------------------------------------------------------
--  DDL for Trigger HR_FORM_TAB_STACKED_CANVAS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_FORM_TAB_STACKED_CANVAS_WHO" 
before insert or update on "HR"."HR_FORM_TAB_STACKED_CANVASES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_FORM_TAB_STACKED_CANVAS_WHO" ENABLE;
