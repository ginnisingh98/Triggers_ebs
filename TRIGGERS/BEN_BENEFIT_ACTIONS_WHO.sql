--------------------------------------------------------
--  DDL for Trigger BEN_BENEFIT_ACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_BENEFIT_ACTIONS_WHO" 
before insert or update on "BEN"."BEN_BENEFIT_ACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_BENEFIT_ACTIONS_WHO" ENABLE;
