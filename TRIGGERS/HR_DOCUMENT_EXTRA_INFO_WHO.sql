--------------------------------------------------------
--  DDL for Trigger HR_DOCUMENT_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DOCUMENT_EXTRA_INFO_WHO" 
before insert or update on "HR"."HR_DOCUMENT_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DOCUMENT_EXTRA_INFO_WHO" ENABLE;
