--------------------------------------------------------
--  DDL for Trigger HRI_MAP_SUP_WRKFC_ASG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_MAP_SUP_WRKFC_ASG_WHO" 
before insert or update on "HRI"."HRI_MAP_SUP_WRKFC_ASG"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_MAP_SUP_WRKFC_ASG_WHO" ENABLE;
