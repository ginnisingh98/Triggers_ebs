--------------------------------------------------------
--  DDL for Trigger HR_EFC_ACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_EFC_ACTIONS_WHO" 
before insert or update on "HR"."HR_EFC_ACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_EFC_ACTIONS_WHO" ENABLE;
