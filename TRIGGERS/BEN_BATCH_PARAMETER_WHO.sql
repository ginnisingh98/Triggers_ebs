--------------------------------------------------------
--  DDL for Trigger BEN_BATCH_PARAMETER_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_BATCH_PARAMETER_WHO" 
before insert or update on "BEN"."BEN_BATCH_PARAMETER"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_BATCH_PARAMETER_WHO" ENABLE;
