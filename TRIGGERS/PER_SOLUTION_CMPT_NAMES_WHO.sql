--------------------------------------------------------
--  DDL for Trigger PER_SOLUTION_CMPT_NAMES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SOLUTION_CMPT_NAMES_WHO" 
before insert or update on "HR"."PER_SOLUTION_CMPT_NAMES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SOLUTION_CMPT_NAMES_WHO" ENABLE;
