--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_DEFINED_BALANCE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_DEFINED_BALANCE_WHO" 
before insert or update on "HR"."PAY_SHADOW_DEFINED_BALANCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_DEFINED_BALANCE_WHO" ENABLE;
