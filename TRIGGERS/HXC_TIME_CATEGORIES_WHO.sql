--------------------------------------------------------
--  DDL for Trigger HXC_TIME_CATEGORIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_TIME_CATEGORIES_WHO" 
before insert or update on "HXC"."HXC_TIME_CATEGORIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_TIME_CATEGORIES_WHO" ENABLE;
