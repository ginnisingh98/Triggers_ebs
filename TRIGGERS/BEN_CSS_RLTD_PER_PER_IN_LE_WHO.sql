--------------------------------------------------------
--  DDL for Trigger BEN_CSS_RLTD_PER_PER_IN_LE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CSS_RLTD_PER_PER_IN_LE_WHO" 
before insert or update on "BEN"."BEN_CSS_RLTD_PER_PER_IN_LER_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CSS_RLTD_PER_PER_IN_LE_WHO" ENABLE;
