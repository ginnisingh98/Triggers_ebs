--------------------------------------------------------
--  DDL for Trigger HR_KI_USER_INTERFACES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_USER_INTERFACES_WHO" 
before insert or update on "HR"."HR_KI_USER_INTERFACES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_USER_INTERFACES_WHO" ENABLE;
