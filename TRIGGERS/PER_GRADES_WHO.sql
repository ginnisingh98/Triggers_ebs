--------------------------------------------------------
--  DDL for Trigger PER_GRADES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_GRADES_WHO" 
before insert or update on "HR"."PER_GRADES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_GRADES_WHO" ENABLE;
