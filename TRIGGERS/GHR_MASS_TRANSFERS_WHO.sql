--------------------------------------------------------
--  DDL for Trigger GHR_MASS_TRANSFERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_MASS_TRANSFERS_WHO" 
before insert or update on "HR"."GHR_MASS_TRANSFERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_MASS_TRANSFERS_WHO" ENABLE;
