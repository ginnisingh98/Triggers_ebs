--------------------------------------------------------
--  DDL for Trigger BEN_ELCTBL_CHC_CTFN_RBV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELCTBL_CHC_CTFN_RBV_WHO" 
before insert or update on "BEN"."BEN_ELCTBL_CHC_CTFN_RBV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELCTBL_CHC_CTFN_RBV_WHO" ENABLE;
