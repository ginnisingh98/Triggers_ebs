--------------------------------------------------------
--  DDL for Trigger PER_RECRUITMENT_ACTIVITY_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RECRUITMENT_ACTIVITY_F_WHO" 
before insert or update on "HR"."PER_RECRUITMENT_ACTIVITY_FOR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RECRUITMENT_ACTIVITY_F_WHO" ENABLE;
