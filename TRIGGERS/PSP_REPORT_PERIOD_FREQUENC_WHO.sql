--------------------------------------------------------
--  DDL for Trigger PSP_REPORT_PERIOD_FREQUENC_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_REPORT_PERIOD_FREQUENC_WHO" 
before insert or update on "PSP"."PSP_REPORT_PERIOD_FREQUENCY_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_REPORT_PERIOD_FREQUENC_WHO" ENABLE;
