--------------------------------------------------------
--  DDL for Trigger OTA_CATEGORY_USAGES_052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CATEGORY_USAGES_052615_WHO" 
before insert or update on "OTA"."OTA_CATEGORY_USAGES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CATEGORY_USAGES_052615_WHO" ENABLE;
