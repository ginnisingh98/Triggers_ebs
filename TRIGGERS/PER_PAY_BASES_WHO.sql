--------------------------------------------------------
--  DDL for Trigger PER_PAY_BASES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PAY_BASES_WHO" 
before insert or update on "HR"."PER_PAY_BASES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PAY_BASES_WHO" ENABLE;
