--------------------------------------------------------
--  DDL for Trigger FF_USER_ENTITIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_USER_ENTITIES_WHO" 
before insert or update on "HR"."FF_USER_ENTITIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_USER_ENTITIES_WHO" ENABLE;
