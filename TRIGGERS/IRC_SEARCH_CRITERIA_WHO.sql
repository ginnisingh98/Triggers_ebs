--------------------------------------------------------
--  DDL for Trigger IRC_SEARCH_CRITERIA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_SEARCH_CRITERIA_WHO" 
before insert or update on "HR"."IRC_SEARCH_CRITERIA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_SEARCH_CRITERIA_WHO" ENABLE;
