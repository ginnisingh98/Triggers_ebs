--------------------------------------------------------
--  DDL for Trigger OTA_QUESTION_BANKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_QUESTION_BANKS_WHO" 
before insert or update on "OTA"."OTA_QUESTION_BANKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_QUESTION_BANKS_WHO" ENABLE;
