--------------------------------------------------------
--  DDL for Trigger PAY_RATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_RATES_WHO" 
before insert or update on "HR"."PAY_RATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_RATES_WHO" ENABLE;
