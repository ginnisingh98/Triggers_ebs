--------------------------------------------------------
--  DDL for Trigger PQP_FLXDU_XML_TAGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_FLXDU_XML_TAGS_WHO" 
before insert or update on "HR"."PQP_FLXDU_XML_TAGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_FLXDU_XML_TAGS_WHO" ENABLE;
