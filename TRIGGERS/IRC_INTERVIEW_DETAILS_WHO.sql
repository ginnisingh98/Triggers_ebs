--------------------------------------------------------
--  DDL for Trigger IRC_INTERVIEW_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_INTERVIEW_DETAILS_WHO" 
before insert or update on "HR"."IRC_INTERVIEW_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_INTERVIEW_DETAILS_WHO" ENABLE;
