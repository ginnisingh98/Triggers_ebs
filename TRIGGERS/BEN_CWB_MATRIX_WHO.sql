--------------------------------------------------------
--  DDL for Trigger BEN_CWB_MATRIX_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_MATRIX_WHO" 
before insert or update on "BEN"."BEN_CWB_MATRIX"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_MATRIX_WHO" ENABLE;
