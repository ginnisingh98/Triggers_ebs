--------------------------------------------------------
--  DDL for Trigger XTR_BU_EXPOSURE_TRANSACTIONS_T
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."XTR_BU_EXPOSURE_TRANSACTIONS_T" 
	 BEFORE UPDATE on "XTR"."XTR_EXPOSURE_TRANSACTIONS"
	 FOR EACH ROW
...
/
ALTER TRIGGER "APPS"."XTR_BU_EXPOSURE_TRANSACTIONS_T" ENABLE;
