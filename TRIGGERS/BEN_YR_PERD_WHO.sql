--------------------------------------------------------
--  DDL for Trigger BEN_YR_PERD_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_YR_PERD_WHO" 
before insert or update on "BEN"."BEN_YR_PERD"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_YR_PERD_WHO" ENABLE;
