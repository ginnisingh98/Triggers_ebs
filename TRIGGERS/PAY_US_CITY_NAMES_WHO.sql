--------------------------------------------------------
--  DDL for Trigger PAY_US_CITY_NAMES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_US_CITY_NAMES_WHO" 
before insert or update on "HR"."PAY_US_CITY_NAMES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_US_CITY_NAMES_WHO" ENABLE;
