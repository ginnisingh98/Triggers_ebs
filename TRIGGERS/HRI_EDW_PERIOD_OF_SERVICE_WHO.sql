--------------------------------------------------------
--  DDL for Trigger HRI_EDW_PERIOD_OF_SERVICE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EDW_PERIOD_OF_SERVICE_WHO" 
before insert or update on "HRI"."HRI_EDW_PERIOD_OF_SERVICE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EDW_PERIOD_OF_SERVICE_WHO" ENABLE;
