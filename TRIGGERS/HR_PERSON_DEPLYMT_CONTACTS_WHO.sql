--------------------------------------------------------
--  DDL for Trigger HR_PERSON_DEPLYMT_CONTACTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PERSON_DEPLYMT_CONTACTS_WHO" 
before insert or update on "HR"."HR_PERSON_DEPLYMT_CONTACTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PERSON_DEPLYMT_CONTACTS_WHO" ENABLE;
