--------------------------------------------------------
--  DDL for Trigger PER_MASS_MOVES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_MASS_MOVES_WHO" 
before insert or update on "HR"."PER_MASS_MOVES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_MASS_MOVES_WHO" ENABLE;
