--------------------------------------------------------
--  DDL for Trigger BEN_DM_TABLES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DM_TABLES_WHO" 
before insert or update on "BEN"."BEN_DM_TABLES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DM_TABLES_WHO" ENABLE;
