--------------------------------------------------------
--  DDL for Trigger BEN_TCS_CAT_LINK_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_TCS_CAT_LINK_WHO" 
before insert or update on "BEN"."BEN_TCS_CAT_LINK"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_TCS_CAT_LINK_WHO" ENABLE;
