--------------------------------------------------------
--  DDL for Trigger FF_FORMULA_TYPE_COMPONENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_FORMULA_TYPE_COMPONENTS_WHO" 
before insert or update on "HR"."FF_FORMULA_TYPE_COMPONENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_FORMULA_TYPE_COMPONENTS_WHO" ENABLE;
