--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_SETS_TL052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_SETS_TL052617_WHO" 
before insert or update on "HR"."PAY_ELEMENT_SETS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_SETS_TL052617_WHO" ENABLE;
