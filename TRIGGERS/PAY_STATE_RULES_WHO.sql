--------------------------------------------------------
--  DDL for Trigger PAY_STATE_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_STATE_RULES_WHO" 
before insert or update on "HR"."PAY_STATE_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_STATE_RULES_WHO" ENABLE;
