--------------------------------------------------------
--  DDL for Trigger PQH_GMS_EXCESS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_GMS_EXCESS_WHO" 
before insert or update on "HR"."PQH_GMS_EXCESS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_GMS_EXCESS_WHO" ENABLE;
