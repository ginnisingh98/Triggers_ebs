--------------------------------------------------------
--  DDL for Trigger HR_TAB_PAGE_PROPERTI052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_TAB_PAGE_PROPERTI052617_WHO" 
before insert or update on "HR"."HR_TAB_PAGE_PROPERTIES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_TAB_PAGE_PROPERTI052617_WHO" ENABLE;
