--------------------------------------------------------
--  DDL for Trigger BEN_POP_UP_MESSAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_POP_UP_MESSAGES_WHO" 
before insert or update on "BEN"."BEN_POP_UP_MESSAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_POP_UP_MESSAGES_WHO" ENABLE;
