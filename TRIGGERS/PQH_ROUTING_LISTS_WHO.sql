--------------------------------------------------------
--  DDL for Trigger PQH_ROUTING_LISTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ROUTING_LISTS_WHO" 
before insert or update on "HR"."PQH_ROUTING_LISTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ROUTING_LISTS_WHO" ENABLE;
