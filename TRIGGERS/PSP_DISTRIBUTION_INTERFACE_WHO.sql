--------------------------------------------------------
--  DDL for Trigger PSP_DISTRIBUTION_INTERFACE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_DISTRIBUTION_INTERFACE_WHO" 
before insert or update on "PSP"."PSP_DISTRIBUTION_INTERFACE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_DISTRIBUTION_INTERFACE_WHO" ENABLE;
