--------------------------------------------------------
--  DDL for Trigger PQP_GAP_DURATION_SUMMARY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_GAP_DURATION_SUMMARY_WHO" 
before insert or update on "HR"."PQP_GAP_DURATION_SUMMARY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_GAP_DURATION_SUMMARY_WHO" ENABLE;
