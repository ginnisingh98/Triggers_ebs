--------------------------------------------------------
--  DDL for Trigger PAY_ALL_PAYROLLS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ALL_PAYROLLS_F_WHO" 
before insert or update on "HR"."PAY_ALL_PAYROLLS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ALL_PAYROLLS_F_WHO" ENABLE;
