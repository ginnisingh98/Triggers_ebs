--------------------------------------------------------
--  DDL for Trigger HRI_EDW_USER_EVENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EDW_USER_EVENTS_WHO" 
before insert or update on "HRI"."HRI_EDW_USER_EVENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EDW_USER_EVENTS_WHO" ENABLE;
