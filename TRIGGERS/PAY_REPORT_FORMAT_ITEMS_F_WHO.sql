--------------------------------------------------------
--  DDL for Trigger PAY_REPORT_FORMAT_ITEMS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_REPORT_FORMAT_ITEMS_F_WHO" 
before insert or update on "HR"."PAY_REPORT_FORMAT_ITEMS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_REPORT_FORMAT_ITEMS_F_WHO" ENABLE;
