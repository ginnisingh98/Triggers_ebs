--------------------------------------------------------
--  DDL for Trigger OTA_ANNOUNCEMENTS_TL052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_ANNOUNCEMENTS_TL052615_WHO" 
before insert or update on "OTA"."OTA_ANNOUNCEMENTS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_ANNOUNCEMENTS_TL052615_WHO" ENABLE;
