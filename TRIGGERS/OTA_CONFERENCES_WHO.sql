--------------------------------------------------------
--  DDL for Trigger OTA_CONFERENCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CONFERENCES_WHO" 
before insert or update on "OTA"."OTA_CONFERENCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CONFERENCES_WHO" ENABLE;
