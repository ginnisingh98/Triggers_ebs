--------------------------------------------------------
--  DDL for Trigger PSP_AUTO_ACCTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_AUTO_ACCTS_WHO" 
before insert or update on "PSP"."PSP_AUTO_ACCTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_AUTO_ACCTS_WHO" ENABLE;
