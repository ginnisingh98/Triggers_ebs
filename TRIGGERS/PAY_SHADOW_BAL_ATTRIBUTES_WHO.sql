--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_BAL_ATTRIBUTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_BAL_ATTRIBUTES_WHO" 
before insert or update on "HR"."PAY_SHADOW_BAL_ATTRIBUTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_BAL_ATTRIBUTES_WHO" ENABLE;
