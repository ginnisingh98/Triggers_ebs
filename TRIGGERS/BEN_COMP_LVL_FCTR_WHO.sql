--------------------------------------------------------
--  DDL for Trigger BEN_COMP_LVL_FCTR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_COMP_LVL_FCTR_WHO" 
before insert or update on "BEN"."BEN_COMP_LVL_FCTR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_COMP_LVL_FCTR_WHO" ENABLE;
