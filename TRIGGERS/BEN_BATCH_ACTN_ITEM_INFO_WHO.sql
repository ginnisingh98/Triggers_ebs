--------------------------------------------------------
--  DDL for Trigger BEN_BATCH_ACTN_ITEM_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_BATCH_ACTN_ITEM_INFO_WHO" 
before insert or update on "BEN"."BEN_BATCH_ACTN_ITEM_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_BATCH_ACTN_ITEM_INFO_WHO" ENABLE;
