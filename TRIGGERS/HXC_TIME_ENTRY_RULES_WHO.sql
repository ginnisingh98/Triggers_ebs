--------------------------------------------------------
--  DDL for Trigger HXC_TIME_ENTRY_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_TIME_ENTRY_RULES_WHO" 
before insert or update on "HXC"."HXC_TIME_ENTRY_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_TIME_ENTRY_RULES_WHO" ENABLE;
