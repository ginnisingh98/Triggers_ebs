--------------------------------------------------------
--  DDL for Trigger PAY_LINK_INPUT_VALUES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_LINK_INPUT_VALUES_F_WHO" 
before insert or update on "HR"."PAY_LINK_INPUT_VALUES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_LINK_INPUT_VALUES_F_WHO" ENABLE;
