--------------------------------------------------------
--  DDL for Trigger PER_ABSENCE_ATTENDANCE_TYP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ABSENCE_ATTENDANCE_TYP_WHO" 
before insert or update on "HR"."PER_ABSENCE_ATTENDANCE_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ABSENCE_ATTENDANCE_TYP_WHO" ENABLE;
