--------------------------------------------------------
--  DDL for Trigger HXC_LAYOUT_COMP_QUALIFIERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_LAYOUT_COMP_QUALIFIERS_WHO" 
before insert or update on "HXC"."HXC_LAYOUT_COMP_QUALIFIERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_LAYOUT_COMP_QUALIFIERS_WHO" ENABLE;
