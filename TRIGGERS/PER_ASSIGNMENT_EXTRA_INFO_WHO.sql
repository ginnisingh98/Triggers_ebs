--------------------------------------------------------
--  DDL for Trigger PER_ASSIGNMENT_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASSIGNMENT_EXTRA_INFO_WHO" 
before insert or update on "HR"."PER_ASSIGNMENT_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ASSIGNMENT_EXTRA_INFO_WHO" ENABLE;
