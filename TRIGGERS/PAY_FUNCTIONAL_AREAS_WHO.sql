--------------------------------------------------------
--  DDL for Trigger PAY_FUNCTIONAL_AREAS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_FUNCTIONAL_AREAS_WHO" 
before insert or update on "HR"."PAY_FUNCTIONAL_AREAS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_FUNCTIONAL_AREAS_WHO" ENABLE;
