--------------------------------------------------------
--  DDL for Trigger IRC_AGENCY_VACANCIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_AGENCY_VACANCIES_WHO" 
before insert or update on "HR"."IRC_AGENCY_VACANCIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_AGENCY_VACANCIES_WHO" ENABLE;
