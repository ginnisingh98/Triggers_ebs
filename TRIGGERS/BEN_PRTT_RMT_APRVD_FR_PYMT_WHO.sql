--------------------------------------------------------
--  DDL for Trigger BEN_PRTT_RMT_APRVD_FR_PYMT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTT_RMT_APRVD_FR_PYMT_WHO" 
before insert or update on "BEN"."BEN_PRTT_RMT_APRVD_FR_PYMT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTT_RMT_APRVD_FR_PYMT_WHO" ENABLE;
