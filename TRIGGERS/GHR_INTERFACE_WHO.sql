--------------------------------------------------------
--  DDL for Trigger GHR_INTERFACE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_INTERFACE_WHO" 
before insert or update on "HR"."GHR_INTERFACE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_INTERFACE_WHO" ENABLE;
