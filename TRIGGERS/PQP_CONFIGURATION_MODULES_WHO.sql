--------------------------------------------------------
--  DDL for Trigger PQP_CONFIGURATION_MODULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_CONFIGURATION_MODULES_WHO" 
before insert or update on "HR"."PQP_CONFIGURATION_MODULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_CONFIGURATION_MODULES_WHO" ENABLE;
