--------------------------------------------------------
--  DDL for Trigger BEN_PIN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PIN_WHO" 
before insert or update on "BEN"."BEN_PIN"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PIN_WHO" ENABLE;
