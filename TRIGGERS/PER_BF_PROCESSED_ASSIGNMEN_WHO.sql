--------------------------------------------------------
--  DDL for Trigger PER_BF_PROCESSED_ASSIGNMEN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BF_PROCESSED_ASSIGNMEN_WHO" 
before insert or update on "HR"."PER_BF_PROCESSED_ASSIGNMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BF_PROCESSED_ASSIGNMEN_WHO" ENABLE;
