--------------------------------------------------------
--  DDL for Trigger OTA_TESTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_TESTS_WHO" 
before insert or update on "OTA"."OTA_TESTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_TESTS_WHO" ENABLE;
