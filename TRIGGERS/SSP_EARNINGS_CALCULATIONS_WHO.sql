--------------------------------------------------------
--  DDL for Trigger SSP_EARNINGS_CALCULATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."SSP_EARNINGS_CALCULATIONS_WHO" 
before insert or update on "SSP"."SSP_EARNINGS_CALCULATIONS"
for each row
...
/
ALTER TRIGGER "APPS"."SSP_EARNINGS_CALCULATIONS_WHO" ENABLE;
