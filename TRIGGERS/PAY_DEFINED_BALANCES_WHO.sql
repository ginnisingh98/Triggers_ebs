--------------------------------------------------------
--  DDL for Trigger PAY_DEFINED_BALANCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_DEFINED_BALANCES_WHO" 
before insert or update on "HR"."PAY_DEFINED_BALANCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_DEFINED_BALANCES_WHO" ENABLE;
