--------------------------------------------------------
--  DDL for Trigger OTA_RESOURCE_ALLOCATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_RESOURCE_ALLOCATIONS_WHO" 
before insert or update on "OTA"."OTA_RESOURCE_ALLOCATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_RESOURCE_ALLOCATIONS_WHO" ENABLE;
