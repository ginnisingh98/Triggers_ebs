--------------------------------------------------------
--  DDL for Trigger PQH_POSITION_TRANSACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_POSITION_TRANSACTIONS_WHO" 
before insert or update on "HR"."PQH_POSITION_TRANSACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_POSITION_TRANSACTIONS_WHO" ENABLE;
