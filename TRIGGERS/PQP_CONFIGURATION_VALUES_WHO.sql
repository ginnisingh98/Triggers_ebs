--------------------------------------------------------
--  DDL for Trigger PQP_CONFIGURATION_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_CONFIGURATION_VALUES_WHO" 
before insert or update on "HR"."PQP_CONFIGURATION_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_CONFIGURATION_VALUES_WHO" ENABLE;
