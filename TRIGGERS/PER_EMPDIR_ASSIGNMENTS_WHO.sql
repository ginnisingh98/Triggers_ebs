--------------------------------------------------------
--  DDL for Trigger PER_EMPDIR_ASSIGNMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_EMPDIR_ASSIGNMENTS_WHO" 
before insert or update on "HR"."PER_EMPDIR_ASSIGNMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_EMPDIR_ASSIGNMENTS_WHO" ENABLE;
