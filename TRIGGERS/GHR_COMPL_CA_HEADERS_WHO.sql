--------------------------------------------------------
--  DDL for Trigger GHR_COMPL_CA_HEADERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPL_CA_HEADERS_WHO" 
before insert or update on "HR"."GHR_COMPL_CA_HEADERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPL_CA_HEADERS_WHO" ENABLE;
