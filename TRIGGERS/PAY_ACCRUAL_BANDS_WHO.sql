--------------------------------------------------------
--  DDL for Trigger PAY_ACCRUAL_BANDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ACCRUAL_BANDS_WHO" 
before insert or update on "HR"."PAY_ACCRUAL_BANDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ACCRUAL_BANDS_WHO" ENABLE;
