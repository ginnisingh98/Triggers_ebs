--------------------------------------------------------
--  DDL for Trigger HR_EFC_WORKER_AUDITS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_EFC_WORKER_AUDITS_WHO" 
before insert or update on "HR"."HR_EFC_WORKER_AUDITS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_EFC_WORKER_AUDITS_WHO" ENABLE;
