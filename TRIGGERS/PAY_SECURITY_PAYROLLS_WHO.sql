--------------------------------------------------------
--  DDL for Trigger PAY_SECURITY_PAYROLLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SECURITY_PAYROLLS_WHO" 
before insert or update on "HR"."PAY_SECURITY_PAYROLLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SECURITY_PAYROLLS_WHO" ENABLE;
