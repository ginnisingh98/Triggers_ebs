--------------------------------------------------------
--  DDL for Trigger PER_RI_CONFIG_DEFAULTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_CONFIG_DEFAULTS_WHO" 
before insert or update on "HR"."PER_RI_CONFIG_DEFAULTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_CONFIG_DEFAULTS_WHO" ENABLE;
