--------------------------------------------------------
--  DDL for Trigger OTA_SKILL_PROVISIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_SKILL_PROVISIONS_WHO" 
before insert or update on "OTA"."OTA_SKILL_PROVISIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_SKILL_PROVISIONS_WHO" ENABLE;
