--------------------------------------------------------
--  DDL for Trigger PAY_CA_EMP_PROV_TAX_INFO_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_CA_EMP_PROV_TAX_INFO_F_WHO" 
before insert or update on "HR"."PAY_CA_EMP_PROV_TAX_INFO_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_CA_EMP_PROV_TAX_INFO_F_WHO" ENABLE;
