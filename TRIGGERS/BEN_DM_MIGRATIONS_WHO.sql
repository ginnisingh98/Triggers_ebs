--------------------------------------------------------
--  DDL for Trigger BEN_DM_MIGRATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DM_MIGRATIONS_WHO" 
before insert or update on "BEN"."BEN_DM_MIGRATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DM_MIGRATIONS_WHO" ENABLE;
