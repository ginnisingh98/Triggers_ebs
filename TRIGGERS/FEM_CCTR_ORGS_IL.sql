--------------------------------------------------------
--  DDL for Trigger FEM_CCTR_ORGS_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_CCTR_ORGS_IL" 
instead of insert on FEM_CCTR_ORGS_VL
...
begin
  FEM_CCTR_ORGS_PKG.INSERT_ROW(
    ...
    X_CREATION_DATE => :FEM_CCTR_ORGS_B.CREATION_DATE,
    X_CREATED_BY => :FEM_CCTR_ORGS_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_CCTR_ORGS_IL" ENABLE;
