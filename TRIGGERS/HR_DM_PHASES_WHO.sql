--------------------------------------------------------
--  DDL for Trigger HR_DM_PHASES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_PHASES_WHO" 
before insert or update on "HR"."HR_DM_PHASES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_PHASES_WHO" ENABLE;
