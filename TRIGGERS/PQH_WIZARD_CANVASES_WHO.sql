--------------------------------------------------------
--  DDL for Trigger PQH_WIZARD_CANVASES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_WIZARD_CANVASES_WHO" 
before insert or update on "HR"."PQH_WIZARD_CANVASES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_WIZARD_CANVASES_WHO" ENABLE;
