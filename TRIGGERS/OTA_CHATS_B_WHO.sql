--------------------------------------------------------
--  DDL for Trigger OTA_CHATS_B_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CHATS_B_WHO" 
before insert or update on "OTA"."OTA_CHATS_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CHATS_B_WHO" ENABLE;
