--------------------------------------------------------
--  DDL for Trigger HRI_MDP_ORGH_TRANSFERS_CT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_MDP_ORGH_TRANSFERS_CT_WHO" 
before insert or update on "HRI"."HRI_MDP_ORGH_TRANSFERS_CT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_MDP_ORGH_TRANSFERS_CT_WHO" ENABLE;
