--------------------------------------------------------
--  DDL for Trigger PQH_FR_EMP_STAT_SITUATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_FR_EMP_STAT_SITUATIONS_WHO" 
before insert or update on "HR"."PQH_FR_EMP_STAT_SITUATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_FR_EMP_STAT_SITUATIONS_WHO" ENABLE;
