--------------------------------------------------------
--  DDL for Trigger OTA_CONFERENCE_SERVERS_B_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CONFERENCE_SERVERS_B_WHO" 
before insert or update on "OTA"."OTA_CONFERENCE_SERVERS_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CONFERENCE_SERVERS_B_WHO" ENABLE;
