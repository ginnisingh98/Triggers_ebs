--------------------------------------------------------
--  DDL for Trigger GHR_MASS_AWARD_CRITERIA_VA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_MASS_AWARD_CRITERIA_VA_WHO" 
before insert or update on "HR"."GHR_MASS_AWARD_CRITERIA_VALS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_MASS_AWARD_CRITERIA_VA_WHO" ENABLE;
