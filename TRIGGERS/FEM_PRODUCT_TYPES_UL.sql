--------------------------------------------------------
--  DDL for Trigger FEM_PRODUCT_TYPES_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_PRODUCT_TYPES_UL" 
instead of update on FEM_PRODUCT_TYPES_VL
referencing new as FEM_PRODUCT_TYPES_B
for each row
begin
  FEM_PRODUCT_TYPES_PKG.UPDATE_ROW(
...
/
ALTER TRIGGER "APPS"."FEM_PRODUCT_TYPES_UL" ENABLE;
