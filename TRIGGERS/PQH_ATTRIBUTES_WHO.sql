--------------------------------------------------------
--  DDL for Trigger PQH_ATTRIBUTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ATTRIBUTES_WHO" 
before insert or update on "HR"."PQH_ATTRIBUTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ATTRIBUTES_WHO" ENABLE;
