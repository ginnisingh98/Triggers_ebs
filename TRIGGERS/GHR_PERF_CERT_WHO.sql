--------------------------------------------------------
--  DDL for Trigger GHR_PERF_CERT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PERF_CERT_WHO" 
before insert or update on "HR"."GHR_PERF_CERT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PERF_CERT_WHO" ENABLE;
