--------------------------------------------------------
--  DDL for Trigger HR_LEGISLATION_SUB_INST_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_LEGISLATION_SUB_INST_WHO" 
before insert or update on "HR"."HR_LEGISLATION_SUB_INST"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_LEGISLATION_SUB_INST_WHO" ENABLE;
