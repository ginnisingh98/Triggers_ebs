--------------------------------------------------------
--  DDL for Trigger IRC_DOCUMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_DOCUMENTS_WHO" 
before insert or update on "HR"."IRC_DOCUMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_DOCUMENTS_WHO" ENABLE;
