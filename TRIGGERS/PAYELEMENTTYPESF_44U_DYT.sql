--------------------------------------------------------
--  DDL for Trigger PAYELEMENTTYPESF_44U_DYT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAYELEMENTTYPESF_44U_DYT" AFTER UPDATE ON "HR"."PAY_ELEMENT_TYPES_F" FOR EACH ROW DECLARE 
...
/*
  ...
  ------------------------------------------------
    ...
    Info.:  Continuous Calculation trigger on update of element type
  ================================================
*/
--
...
EXCEPTION
  WHEN OTHERS THEN
    hr_utility.set_location('PAYELEMENTTYPESF_44U_DYT',ABS(SQLCODE));
    pay_dyn_triggers.g_dyt_mode := l_mode;
    RAISE;
  --
END;
...
/
ALTER TRIGGER "APPS"."PAYELEMENTTYPESF_44U_DYT" ENABLE;
