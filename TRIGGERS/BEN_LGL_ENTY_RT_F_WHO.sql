--------------------------------------------------------
--  DDL for Trigger BEN_LGL_ENTY_RT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_LGL_ENTY_RT_F_WHO" 
before insert or update on "BEN"."BEN_LGL_ENTY_RT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_LGL_ENTY_RT_F_WHO" ENABLE;
