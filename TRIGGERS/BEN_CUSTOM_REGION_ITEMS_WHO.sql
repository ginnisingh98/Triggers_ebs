--------------------------------------------------------
--  DDL for Trigger BEN_CUSTOM_REGION_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CUSTOM_REGION_ITEMS_WHO" 
before insert or update on "BEN"."BEN_CUSTOM_REGION_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CUSTOM_REGION_ITEMS_WHO" ENABLE;
