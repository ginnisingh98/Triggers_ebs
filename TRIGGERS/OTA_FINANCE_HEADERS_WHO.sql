--------------------------------------------------------
--  DDL for Trigger OTA_FINANCE_HEADERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_FINANCE_HEADERS_WHO" 
before insert or update on "OTA"."OTA_FINANCE_HEADERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_FINANCE_HEADERS_WHO" ENABLE;
