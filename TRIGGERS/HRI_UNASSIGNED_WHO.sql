--------------------------------------------------------
--  DDL for Trigger HRI_UNASSIGNED_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_UNASSIGNED_WHO" 
before insert or update on "HRI"."HRI_UNASSIGNED"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_UNASSIGNED_WHO" ENABLE;
