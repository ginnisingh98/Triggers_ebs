--------------------------------------------------------
--  DDL for Trigger PAY_USER_ROWS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_USER_ROWS_F_WHO" 
before insert or update on "HR"."PAY_USER_ROWS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_USER_ROWS_F_WHO" ENABLE;
