--------------------------------------------------------
--  DDL for Trigger PQH_COPY_ENTITY_ATTRIBS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_COPY_ENTITY_ATTRIBS_WHO" 
before insert or update on "HR"."PQH_COPY_ENTITY_ATTRIBS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_COPY_ENTITY_ATTRIBS_WHO" ENABLE;
