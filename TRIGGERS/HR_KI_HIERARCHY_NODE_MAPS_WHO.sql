--------------------------------------------------------
--  DDL for Trigger HR_KI_HIERARCHY_NODE_MAPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_HIERARCHY_NODE_MAPS_WHO" 
before insert or update on "HR"."HR_KI_HIERARCHY_NODE_MAPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_HIERARCHY_NODE_MAPS_WHO" ENABLE;
