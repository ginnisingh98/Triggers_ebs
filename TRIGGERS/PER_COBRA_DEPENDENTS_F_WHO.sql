--------------------------------------------------------
--  DDL for Trigger PER_COBRA_DEPENDENTS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COBRA_DEPENDENTS_F_WHO" 
before insert or update on "HR"."PER_COBRA_DEPENDENTS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COBRA_DEPENDENTS_F_WHO" ENABLE;
