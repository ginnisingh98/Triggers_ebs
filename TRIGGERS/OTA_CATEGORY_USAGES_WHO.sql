--------------------------------------------------------
--  DDL for Trigger OTA_CATEGORY_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CATEGORY_USAGES_WHO" 
before insert or update on "OTA"."OTA_CATEGORY_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CATEGORY_USAGES_WHO" ENABLE;
