--------------------------------------------------------
--  DDL for Trigger IRC_LOCATION_CRITERIA_VALU_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_LOCATION_CRITERIA_VALU_WHO" 
before insert or update on "HR"."IRC_LOCATION_CRITERIA_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_LOCATION_CRITERIA_VALU_WHO" ENABLE;
