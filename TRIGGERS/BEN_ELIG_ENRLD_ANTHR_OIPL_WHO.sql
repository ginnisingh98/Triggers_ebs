--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_ENRLD_ANTHR_OIPL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_ENRLD_ANTHR_OIPL_WHO" 
before insert or update on "BEN"."BEN_ELIG_ENRLD_ANTHR_OIPL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_ENRLD_ANTHR_OIPL_WHO" ENABLE;
