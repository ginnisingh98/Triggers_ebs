--------------------------------------------------------
--  DDL for Trigger PQH_PROCESS_LOG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_PROCESS_LOG_WHO" 
before insert or update on "HR"."PQH_PROCESS_LOG"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_PROCESS_LOG_WHO" ENABLE;
