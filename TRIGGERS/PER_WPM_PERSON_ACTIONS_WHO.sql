--------------------------------------------------------
--  DDL for Trigger PER_WPM_PERSON_ACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_WPM_PERSON_ACTIONS_WHO" 
before insert or update on "HR"."PER_WPM_PERSON_ACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_WPM_PERSON_ACTIONS_WHO" ENABLE;
