--------------------------------------------------------
--  DDL for Trigger GHR_GROUPBOXES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_GROUPBOXES_WHO" 
before insert or update on "HR"."GHR_GROUPBOXES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_GROUPBOXES_WHO" ENABLE;
