--------------------------------------------------------
--  DDL for Trigger PSP_ENC_PAYROLLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ENC_PAYROLLS_WHO" 
before insert or update on "PSP"."PSP_ENC_PAYROLLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ENC_PAYROLLS_WHO" ENABLE;
