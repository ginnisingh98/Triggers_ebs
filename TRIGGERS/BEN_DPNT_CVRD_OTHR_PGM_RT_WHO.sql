--------------------------------------------------------
--  DDL for Trigger BEN_DPNT_CVRD_OTHR_PGM_RT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DPNT_CVRD_OTHR_PGM_RT_WHO" 
before insert or update on "BEN"."BEN_DPNT_CVRD_OTHR_PGM_RT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DPNT_CVRD_OTHR_PGM_RT_WHO" ENABLE;
