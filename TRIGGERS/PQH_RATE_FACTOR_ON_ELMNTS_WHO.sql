--------------------------------------------------------
--  DDL for Trigger PQH_RATE_FACTOR_ON_ELMNTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_RATE_FACTOR_ON_ELMNTS_WHO" 
before insert or update on "HR"."PQH_RATE_FACTOR_ON_ELMNTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_RATE_FACTOR_ON_ELMNTS_WHO" ENABLE;
