--------------------------------------------------------
--  DDL for Trigger PAY_WC_FUNDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_WC_FUNDS_WHO" 
before insert or update on "HR"."PAY_WC_FUNDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_WC_FUNDS_WHO" ENABLE;
