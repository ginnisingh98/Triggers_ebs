--------------------------------------------------------
--  DDL for Trigger PER_ASSIGN_PROPOSAL_ANSWER_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASSIGN_PROPOSAL_ANSWER_WHO" 
before insert or update on "HR"."PER_ASSIGN_PROPOSAL_ANSWERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ASSIGN_PROPOSAL_ANSWER_WHO" ENABLE;
