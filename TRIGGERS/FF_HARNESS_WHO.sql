--------------------------------------------------------
--  DDL for Trigger FF_HARNESS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_HARNESS_WHO" 
before insert or update on "HR"."FF_HARNESS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_HARNESS_WHO" ENABLE;
