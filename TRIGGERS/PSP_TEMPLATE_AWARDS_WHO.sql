--------------------------------------------------------
--  DDL for Trigger PSP_TEMPLATE_AWARDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_TEMPLATE_AWARDS_WHO" 
before insert or update on "PSP"."PSP_TEMPLATE_AWARDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_TEMPLATE_AWARDS_WHO" ENABLE;
