--------------------------------------------------------
--  DDL for Trigger PSP_REPORT_TEMPLATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_REPORT_TEMPLATES_WHO" 
before insert or update on "PSP"."PSP_REPORT_TEMPLATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_REPORT_TEMPLATES_WHO" ENABLE;
