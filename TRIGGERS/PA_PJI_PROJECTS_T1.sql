--------------------------------------------------------
--  DDL for Trigger PA_PJI_PROJECTS_T1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PA_PJI_PROJECTS_T1" 
AFTER INSERT ON "PA"."PA_PROJECTS_ALL"
FOR EACH ROW
DECLARE
	l_event_id NUMBER;
...
/
ALTER TRIGGER "APPS"."PA_PJI_PROJECTS_T1" ENABLE;
