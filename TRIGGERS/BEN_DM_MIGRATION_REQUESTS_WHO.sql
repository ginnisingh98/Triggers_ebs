--------------------------------------------------------
--  DDL for Trigger BEN_DM_MIGRATION_REQUESTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DM_MIGRATION_REQUESTS_WHO" 
before insert or update on "BEN"."BEN_DM_MIGRATION_REQUESTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DM_MIGRATION_REQUESTS_WHO" ENABLE;
