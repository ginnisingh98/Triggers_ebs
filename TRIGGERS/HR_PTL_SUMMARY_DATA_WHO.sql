--------------------------------------------------------
--  DDL for Trigger HR_PTL_SUMMARY_DATA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PTL_SUMMARY_DATA_WHO" 
before insert or update on "HR"."HR_PTL_SUMMARY_DATA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PTL_SUMMARY_DATA_WHO" ENABLE;
