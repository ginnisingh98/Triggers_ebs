--------------------------------------------------------
--  DDL for Trigger PER_ORG_STRUCTURE_ELEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ORG_STRUCTURE_ELEMENTS_WHO" 
before insert or update on "HR"."PER_ORG_STRUCTURE_ELEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ORG_STRUCTURE_ELEMENTS_WHO" ENABLE;
