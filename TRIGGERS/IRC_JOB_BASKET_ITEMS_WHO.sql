--------------------------------------------------------
--  DDL for Trigger IRC_JOB_BASKET_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_JOB_BASKET_ITEMS_WHO" 
before insert or update on "HR"."IRC_JOB_BASKET_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_JOB_BASKET_ITEMS_WHO" ENABLE;
