--------------------------------------------------------
--  DDL for Trigger PER_LETTER_REQUESTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_LETTER_REQUESTS_WHO" 
before insert or update on "HR"."PER_LETTER_REQUESTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_LETTER_REQUESTS_WHO" ENABLE;
