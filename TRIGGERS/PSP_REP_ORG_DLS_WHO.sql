--------------------------------------------------------
--  DDL for Trigger PSP_REP_ORG_DLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_REP_ORG_DLS_WHO" 
before insert or update on "PSP"."PSP_REP_ORG_DLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_REP_ORG_DLS_WHO" ENABLE;
