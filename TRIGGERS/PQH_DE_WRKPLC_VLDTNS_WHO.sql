--------------------------------------------------------
--  DDL for Trigger PQH_DE_WRKPLC_VLDTNS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_WRKPLC_VLDTNS_WHO" 
before insert or update on "HR"."PQH_DE_WRKPLC_VLDTNS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_WRKPLC_VLDTNS_WHO" ENABLE;
