--------------------------------------------------------
--  DDL for Trigger HR_KI_INTEGRATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_INTEGRATIONS_WHO" 
before insert or update on "HR"."HR_KI_INTEGRATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_INTEGRATIONS_WHO" ENABLE;
