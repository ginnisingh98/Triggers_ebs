--------------------------------------------------------
--  DDL for Trigger PER_SPINAL_POINT_STEPS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SPINAL_POINT_STEPS_F_WHO" 
before insert or update on "HR"."PER_SPINAL_POINT_STEPS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SPINAL_POINT_STEPS_F_WHO" ENABLE;
