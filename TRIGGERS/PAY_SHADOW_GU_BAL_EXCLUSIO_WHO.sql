--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_GU_BAL_EXCLUSIO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_GU_BAL_EXCLUSIO_WHO" 
before insert or update on "HR"."PAY_SHADOW_GU_BAL_EXCLUSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_GU_BAL_EXCLUSIO_WHO" ENABLE;
