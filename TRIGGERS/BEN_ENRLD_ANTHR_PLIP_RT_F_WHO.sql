--------------------------------------------------------
--  DDL for Trigger BEN_ENRLD_ANTHR_PLIP_RT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ENRLD_ANTHR_PLIP_RT_F_WHO" 
before insert or update on "BEN"."BEN_ENRLD_ANTHR_PLIP_RT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ENRLD_ANTHR_PLIP_RT_F_WHO" ENABLE;
