--------------------------------------------------------
--  DDL for Trigger PER_SPECIAL_INFO_TYPE_USAG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SPECIAL_INFO_TYPE_USAG_WHO" 
before insert or update on "HR"."PER_SPECIAL_INFO_TYPE_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SPECIAL_INFO_TYPE_USAG_WHO" ENABLE;
