--------------------------------------------------------
--  DDL for Trigger HR_PAY_IF_PPM_ARD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PAY_IF_PPM_ARD" AFTER DELETE
ON "HR"."PAY_PERSONAL_PAYMENT_METHODS_F"
DECLARE
  /* declare the cursors */
...
/
ALTER TRIGGER "APPS"."HR_PAY_IF_PPM_ARD" ENABLE;
