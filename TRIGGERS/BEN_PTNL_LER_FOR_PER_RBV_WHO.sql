--------------------------------------------------------
--  DDL for Trigger BEN_PTNL_LER_FOR_PER_RBV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PTNL_LER_FOR_PER_RBV_WHO" 
before insert or update on "BEN"."BEN_PTNL_LER_FOR_PER_RBV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PTNL_LER_FOR_PER_RBV_WHO" ENABLE;
