--------------------------------------------------------
--  DDL for Trigger PAY_PROCESS_EVENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_PROCESS_EVENTS_WHO" 
before insert or update on "HR"."PAY_PROCESS_EVENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_PROCESS_EVENTS_WHO" ENABLE;
