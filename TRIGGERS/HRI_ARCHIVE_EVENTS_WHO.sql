--------------------------------------------------------
--  DDL for Trigger HRI_ARCHIVE_EVENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_ARCHIVE_EVENTS_WHO" 
before insert or update on "HRI"."HRI_ARCHIVE_EVENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_ARCHIVE_EVENTS_WHO" ENABLE;
