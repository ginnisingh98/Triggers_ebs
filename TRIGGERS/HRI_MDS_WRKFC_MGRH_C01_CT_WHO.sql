--------------------------------------------------------
--  DDL for Trigger HRI_MDS_WRKFC_MGRH_C01_CT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_MDS_WRKFC_MGRH_C01_CT_WHO" 
before insert or update on "HRI"."HRI_MDS_WRKFC_MGRH_C01_CT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_MDS_WRKFC_MGRH_C01_CT_WHO" ENABLE;
