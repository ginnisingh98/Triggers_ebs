--------------------------------------------------------
--  DDL for Trigger FEM_PROPTYPES_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_PROPTYPES_IL" 
instead of insert on FEM_PROPTYPES_VL
...
begin
  FEM_PROPTYPES_PKG.INSERT_ROW(
    ...
    X_CREATION_DATE => :FEM_PROPTYPES_B.CREATION_DATE,
    X_CREATED_BY => :FEM_PROPTYPES_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_PROPTYPES_IL" ENABLE;
