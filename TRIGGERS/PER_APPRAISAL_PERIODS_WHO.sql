--------------------------------------------------------
--  DDL for Trigger PER_APPRAISAL_PERIODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_APPRAISAL_PERIODS_WHO" 
before insert or update on "HR"."PER_APPRAISAL_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_APPRAISAL_PERIODS_WHO" ENABLE;
