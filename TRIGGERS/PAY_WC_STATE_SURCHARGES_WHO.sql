--------------------------------------------------------
--  DDL for Trigger PAY_WC_STATE_SURCHARGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_WC_STATE_SURCHARGES_WHO" 
before insert or update on "HR"."PAY_WC_STATE_SURCHARGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_WC_STATE_SURCHARGES_WHO" ENABLE;
