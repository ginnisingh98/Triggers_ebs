--------------------------------------------------------
--  DDL for Trigger PQH_SS_VALUE_HISTORY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_SS_VALUE_HISTORY_WHO" 
before insert or update on "HR"."PQH_SS_VALUE_HISTORY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_SS_VALUE_HISTORY_WHO" ENABLE;
