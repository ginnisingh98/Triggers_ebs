--------------------------------------------------------
--  DDL for Trigger FEM_USER_LOV142_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_LOV142_UL" 
instead of update on FEM_USER_LOV142_VL
...
/
ALTER TRIGGER "APPS"."FEM_USER_LOV142_UL" ENABLE;
