--------------------------------------------------------
--  DDL for Trigger PQH_BUDGET_GL_FLEX_MAPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BUDGET_GL_FLEX_MAPS_WHO" 
before insert or update on "HR"."PQH_BUDGET_GL_FLEX_MAPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BUDGET_GL_FLEX_MAPS_WHO" ENABLE;
