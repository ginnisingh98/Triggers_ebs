--------------------------------------------------------
--  DDL for Trigger HRI_PRIMARY_HRCHYS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_PRIMARY_HRCHYS_WHO" 
before insert or update on "HRI"."HRI_PRIMARY_HRCHYS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_PRIMARY_HRCHYS_WHO" ENABLE;
