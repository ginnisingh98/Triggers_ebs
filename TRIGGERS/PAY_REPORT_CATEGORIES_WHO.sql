--------------------------------------------------------
--  DDL for Trigger PAY_REPORT_CATEGORIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_REPORT_CATEGORIES_WHO" 
before insert or update on "HR"."PAY_REPORT_CATEGORIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_REPORT_CATEGORIES_WHO" ENABLE;
