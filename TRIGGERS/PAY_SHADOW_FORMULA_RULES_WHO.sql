--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_FORMULA_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_FORMULA_RULES_WHO" 
before insert or update on "HR"."PAY_SHADOW_FORMULA_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_FORMULA_RULES_WHO" ENABLE;
