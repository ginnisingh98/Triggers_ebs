--------------------------------------------------------
--  DDL for Trigger PER_BEN_IDENTIFIED_EVENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BEN_IDENTIFIED_EVENTS_WHO" 
before insert or update on "HR"."PER_BEN_IDENTIFIED_EVENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BEN_IDENTIFIED_EVENTS_WHO" ENABLE;
