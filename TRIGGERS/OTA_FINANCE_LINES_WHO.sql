--------------------------------------------------------
--  DDL for Trigger OTA_FINANCE_LINES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_FINANCE_LINES_WHO" 
before insert or update on "OTA"."OTA_FINANCE_LINES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_FINANCE_LINES_WHO" ENABLE;
