--------------------------------------------------------
--  DDL for Trigger PQH_PA_WHATIF_RESULTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_PA_WHATIF_RESULTS_WHO" 
before insert or update on "HR"."PQH_PA_WHATIF_RESULTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_PA_WHATIF_RESULTS_WHO" ENABLE;
