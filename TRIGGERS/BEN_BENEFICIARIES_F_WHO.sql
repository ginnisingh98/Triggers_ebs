--------------------------------------------------------
--  DDL for Trigger BEN_BENEFICIARIES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_BENEFICIARIES_F_WHO" 
before insert or update on "HR"."BEN_BENEFICIARIES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_BENEFICIARIES_F_WHO" ENABLE;
