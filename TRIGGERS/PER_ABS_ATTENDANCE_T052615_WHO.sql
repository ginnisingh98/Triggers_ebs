--------------------------------------------------------
--  DDL for Trigger PER_ABS_ATTENDANCE_T052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ABS_ATTENDANCE_T052615_WHO" 
before insert or update on "HR"."PER_ABS_ATTENDANCE_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ABS_ATTENDANCE_T052615_WHO" ENABLE;
