--------------------------------------------------------
--  DDL for Trigger OTA_BULK_ENR_REQ_MEMBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_BULK_ENR_REQ_MEMBERS_WHO" 
before insert or update on "OTA"."OTA_BULK_ENR_REQ_MEMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_BULK_ENR_REQ_MEMBERS_WHO" ENABLE;
