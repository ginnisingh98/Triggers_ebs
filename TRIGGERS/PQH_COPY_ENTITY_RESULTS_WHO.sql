--------------------------------------------------------
--  DDL for Trigger PQH_COPY_ENTITY_RESULTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_COPY_ENTITY_RESULTS_WHO" 
before insert or update on "HR"."PQH_COPY_ENTITY_RESULTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_COPY_ENTITY_RESULTS_WHO" ENABLE;
