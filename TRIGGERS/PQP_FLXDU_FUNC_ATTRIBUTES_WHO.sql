--------------------------------------------------------
--  DDL for Trigger PQP_FLXDU_FUNC_ATTRIBUTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_FLXDU_FUNC_ATTRIBUTES_WHO" 
before insert or update on "HR"."PQP_FLXDU_FUNC_ATTRIBUTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_FLXDU_FUNC_ATTRIBUTES_WHO" ENABLE;
