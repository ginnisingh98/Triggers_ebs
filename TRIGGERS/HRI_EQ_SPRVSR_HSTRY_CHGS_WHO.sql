--------------------------------------------------------
--  DDL for Trigger HRI_EQ_SPRVSR_HSTRY_CHGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_SPRVSR_HSTRY_CHGS_WHO" 
before insert or update on "HRI"."HRI_EQ_SPRVSR_HSTRY_CHGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_SPRVSR_HSTRY_CHGS_WHO" ENABLE;
