--------------------------------------------------------
--  DDL for Trigger BEN_PIL_ELCTBL_CHC_POPL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PIL_ELCTBL_CHC_POPL_WHO" 
before insert or update on "BEN"."BEN_PIL_ELCTBL_CHC_POPL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PIL_ELCTBL_CHC_POPL_WHO" ENABLE;
