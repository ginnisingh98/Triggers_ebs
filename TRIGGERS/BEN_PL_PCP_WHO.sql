--------------------------------------------------------
--  DDL for Trigger BEN_PL_PCP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PL_PCP_WHO" 
before insert or update on "BEN"."BEN_PL_PCP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PL_PCP_WHO" ENABLE;
