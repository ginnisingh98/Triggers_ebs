--------------------------------------------------------
--  DDL for Trigger HR_AUTHORIA_MAPPINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_AUTHORIA_MAPPINGS_WHO" 
before insert or update on "HR"."HR_AUTHORIA_MAPPINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_AUTHORIA_MAPPINGS_WHO" ENABLE;
