--------------------------------------------------------
--  DDL for Trigger PERSPINALPOINTPLACEM_2132I_DYT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PERSPINALPOINTPLACEM_2132I_DYT" AFTER INSERT ON "HR"."PER_SPINAL_POINT_PLACEMENTS_F" FOR EACH ROW DECLARE 
...
/*
  ...
  ------------------------------------------------
    ...
    Name:   PER_SPINAL_POINT_PLACEMENTS_F_ARI
    Info.:  Continuous Calculation trigger on Insert of Spinal Point placements
  ================================================
*/
--
...
END IF;
  ...
  pay_continuous_calc.PER_SPIN_PNT_PLACEMENTS_F_ari(
...
EXCEPTION
  WHEN OTHERS THEN
    hr_utility.set_location('PERSPINALPOINTPLACEM_2132I_DYT',ABS(SQLCODE));
    pay_dyn_triggers.g_dyt_mode := l_mode;
    RAISE;
  --
END;
...
/
ALTER TRIGGER "APPS"."PERSPINALPOINTPLACEM_2132I_DYT" ENABLE;
