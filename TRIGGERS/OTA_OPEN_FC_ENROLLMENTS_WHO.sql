--------------------------------------------------------
--  DDL for Trigger OTA_OPEN_FC_ENROLLMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_OPEN_FC_ENROLLMENTS_WHO" 
before insert or update on "OTA"."OTA_OPEN_FC_ENROLLMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_OPEN_FC_ENROLLMENTS_WHO" ENABLE;
