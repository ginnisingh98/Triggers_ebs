--------------------------------------------------------
--  DDL for Trigger HR_API_HOOKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_API_HOOKS_WHO" 
before insert or update on "HR"."HR_API_HOOKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_API_HOOKS_WHO" ENABLE;
