--------------------------------------------------------
--  DDL for Trigger BEN_PRTN_ELIGY_RL_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTN_ELIGY_RL_F_WHO" 
before insert or update on "BEN"."BEN_PRTN_ELIGY_RL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTN_ELIGY_RL_F_WHO" ENABLE;
