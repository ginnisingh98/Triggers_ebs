--------------------------------------------------------
--  DDL for Trigger GHR_COMPL_INCIDENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPL_INCIDENTS_WHO" 
before insert or update on "HR"."GHR_COMPL_INCIDENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPL_INCIDENTS_WHO" ENABLE;
