--------------------------------------------------------
--  DDL for Trigger HXC_TK_GROUP_QUERIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_TK_GROUP_QUERIES_WHO" 
before insert or update on "HXC"."HXC_TK_GROUP_QUERIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_TK_GROUP_QUERIES_WHO" ENABLE;
