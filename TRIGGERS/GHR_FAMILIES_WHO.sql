--------------------------------------------------------
--  DDL for Trigger GHR_FAMILIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_FAMILIES_WHO" 
before insert or update on "HR"."GHR_FAMILIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_FAMILIES_WHO" ENABLE;
