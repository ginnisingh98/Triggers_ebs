--------------------------------------------------------
--  DDL for Trigger BEN_ICD_CHC_RATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ICD_CHC_RATES_WHO" 
before insert or update on "BEN"."BEN_ICD_CHC_RATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ICD_CHC_RATES_WHO" ENABLE;
