--------------------------------------------------------
--  DDL for Trigger PQH_DE_RESULT_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_RESULT_SETS_WHO" 
before insert or update on "HR"."PQH_DE_RESULT_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_RESULT_SETS_WHO" ENABLE;
