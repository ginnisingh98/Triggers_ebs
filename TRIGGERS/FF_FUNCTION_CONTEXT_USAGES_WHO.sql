--------------------------------------------------------
--  DDL for Trigger FF_FUNCTION_CONTEXT_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_FUNCTION_CONTEXT_USAGES_WHO" 
before insert or update on "HR"."FF_FUNCTION_CONTEXT_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_FUNCTION_CONTEXT_USAGES_WHO" ENABLE;
