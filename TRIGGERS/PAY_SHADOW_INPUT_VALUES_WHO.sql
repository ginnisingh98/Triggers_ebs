--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_INPUT_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_INPUT_VALUES_WHO" 
before insert or update on "HR"."PAY_SHADOW_INPUT_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_INPUT_VALUES_WHO" ENABLE;
