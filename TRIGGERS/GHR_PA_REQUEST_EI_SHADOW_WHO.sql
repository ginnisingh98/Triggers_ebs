--------------------------------------------------------
--  DDL for Trigger GHR_PA_REQUEST_EI_SHADOW_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PA_REQUEST_EI_SHADOW_WHO" 
before insert or update on "HR"."GHR_PA_REQUEST_EI_SHADOW"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PA_REQUEST_EI_SHADOW_WHO" ENABLE;
