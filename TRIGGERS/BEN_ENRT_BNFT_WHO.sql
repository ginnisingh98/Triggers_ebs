--------------------------------------------------------
--  DDL for Trigger BEN_ENRT_BNFT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ENRT_BNFT_WHO" 
before insert or update on "BEN"."BEN_ENRT_BNFT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ENRT_BNFT_WHO" ENABLE;
