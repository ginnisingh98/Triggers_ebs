--------------------------------------------------------
--  DDL for Trigger PER_KR_GRADE_AMOUNT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_KR_GRADE_AMOUNT_F_WHO" 
before insert or update on "HR"."PER_KR_GRADE_AMOUNT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_KR_GRADE_AMOUNT_F_WHO" ENABLE;
