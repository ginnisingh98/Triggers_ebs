--------------------------------------------------------
--  DDL for Trigger PSP_SUB_LINE_REASONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_SUB_LINE_REASONS_WHO" 
before insert or update on "PSP"."PSP_SUB_LINE_REASONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_SUB_LINE_REASONS_WHO" ENABLE;
