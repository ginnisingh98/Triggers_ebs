--------------------------------------------------------
--  DDL for Trigger PAY_NL_IZA_UPLD_STATUS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_NL_IZA_UPLD_STATUS_WHO" 
before insert or update on "HR"."PAY_NL_IZA_UPLD_STATUS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_NL_IZA_UPLD_STATUS_WHO" ENABLE;
