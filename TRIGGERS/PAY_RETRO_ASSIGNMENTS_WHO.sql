--------------------------------------------------------
--  DDL for Trigger PAY_RETRO_ASSIGNMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_RETRO_ASSIGNMENTS_WHO" 
before insert or update on "HR"."PAY_RETRO_ASSIGNMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_RETRO_ASSIGNMENTS_WHO" ENABLE;
