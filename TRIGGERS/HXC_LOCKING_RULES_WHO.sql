--------------------------------------------------------
--  DDL for Trigger HXC_LOCKING_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_LOCKING_RULES_WHO" 
before insert or update on "HXC"."HXC_LOCKING_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_LOCKING_RULES_WHO" ENABLE;
