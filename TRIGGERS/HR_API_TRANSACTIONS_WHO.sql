--------------------------------------------------------
--  DDL for Trigger HR_API_TRANSACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_API_TRANSACTIONS_WHO" 
before insert or update on "HR"."HR_API_TRANSACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_API_TRANSACTIONS_WHO" ENABLE;
