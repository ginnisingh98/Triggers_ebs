--------------------------------------------------------
--  DDL for Trigger PQH_ATTRIBUTE_RANGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ATTRIBUTE_RANGES_WHO" 
before insert or update on "HR"."PQH_ATTRIBUTE_RANGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ATTRIBUTE_RANGES_WHO" ENABLE;
