--------------------------------------------------------
--  DDL for Trigger SSP_MEDICALS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."SSP_MEDICALS_WHO" 
before insert or update on "SSP"."SSP_MEDICALS"
for each row
...
/
ALTER TRIGGER "APPS"."SSP_MEDICALS_WHO" ENABLE;
