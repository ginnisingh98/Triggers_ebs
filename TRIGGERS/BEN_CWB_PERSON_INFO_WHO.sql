--------------------------------------------------------
--  DDL for Trigger BEN_CWB_PERSON_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_PERSON_INFO_WHO" 
before insert or update on "BEN"."BEN_CWB_PERSON_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_PERSON_INFO_WHO" ENABLE;
