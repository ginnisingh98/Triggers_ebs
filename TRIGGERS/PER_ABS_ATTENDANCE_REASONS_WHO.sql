--------------------------------------------------------
--  DDL for Trigger PER_ABS_ATTENDANCE_REASONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ABS_ATTENDANCE_REASONS_WHO" 
before insert or update on "HR"."PER_ABS_ATTENDANCE_REASONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ABS_ATTENDANCE_REASONS_WHO" ENABLE;
