--------------------------------------------------------
--  DDL for Trigger PER_KR_ASSIGNMENT_YEA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_KR_ASSIGNMENT_YEA_INFO_WHO" 
before insert or update on "HR"."PER_KR_ASSIGNMENT_YEA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_KR_ASSIGNMENT_YEA_INFO_WHO" ENABLE;
