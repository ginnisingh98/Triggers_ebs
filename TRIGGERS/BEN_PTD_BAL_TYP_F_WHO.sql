--------------------------------------------------------
--  DDL for Trigger BEN_PTD_BAL_TYP_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PTD_BAL_TYP_F_WHO" 
before insert or update on "BEN"."BEN_PTD_BAL_TYP_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PTD_BAL_TYP_F_WHO" ENABLE;
