--------------------------------------------------------
--  DDL for Trigger HRI_EQ_WRKFC_EVT_ORGH_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_WRKFC_EVT_ORGH_WHO" 
before insert or update on "HRI"."HRI_EQ_WRKFC_EVT_ORGH"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_WRKFC_EVT_ORGH_WHO" ENABLE;
