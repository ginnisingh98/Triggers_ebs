--------------------------------------------------------
--  DDL for Trigger HR_KI_OPTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_OPTIONS_WHO" 
before insert or update on "HR"."HR_KI_OPTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_OPTIONS_WHO" ENABLE;
