--------------------------------------------------------
--  DDL for Trigger HXC_RETRIEVAL_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_RETRIEVAL_RULES_WHO" 
before insert or update on "HXC"."HXC_RETRIEVAL_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_RETRIEVAL_RULES_WHO" ENABLE;
