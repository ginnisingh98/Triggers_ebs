--------------------------------------------------------
--  DDL for Trigger PAY_PAYROLL_ACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_PAYROLL_ACTIONS_WHO" 
before insert or update on "HR"."PAY_PAYROLL_ACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_PAYROLL_ACTIONS_WHO" ENABLE;
