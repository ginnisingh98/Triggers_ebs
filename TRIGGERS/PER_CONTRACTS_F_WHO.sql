--------------------------------------------------------
--  DDL for Trigger PER_CONTRACTS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CONTRACTS_F_WHO" 
before insert or update on "HR"."PER_CONTRACTS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CONTRACTS_F_WHO" ENABLE;
