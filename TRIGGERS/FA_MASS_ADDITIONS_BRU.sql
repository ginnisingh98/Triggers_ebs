--------------------------------------------------------
--  DDL for Trigger FA_MASS_ADDITIONS_BRU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FA_MASS_ADDITIONS_BRU" 
BEFORE  UPDATE ON "FA"."FA_MASS_ADDITIONS"
REFERENCING
 NEW AS NEW
 OLD AS OLD
FOR EACH ROW
...
v_asset_id number;
Begin
 /* $Header: faxtrg02.sql 120.1.12010000.1 2008/07/28 13:28:09 appldev ship $ */
...
/
ALTER TRIGGER "APPS"."FA_MASS_ADDITIONS_BRU" ENABLE;
