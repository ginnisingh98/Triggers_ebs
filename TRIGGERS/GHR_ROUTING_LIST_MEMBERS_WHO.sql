--------------------------------------------------------
--  DDL for Trigger GHR_ROUTING_LIST_MEMBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_ROUTING_LIST_MEMBERS_WHO" 
before insert or update on "HR"."GHR_ROUTING_LIST_MEMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_ROUTING_LIST_MEMBERS_WHO" ENABLE;
