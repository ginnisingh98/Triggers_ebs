--------------------------------------------------------
--  DDL for Trigger BEN_ENRT_CTFN_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ENRT_CTFN_F_WHO" 
before insert or update on "BEN"."BEN_ENRT_CTFN_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ENRT_CTFN_F_WHO" ENABLE;
