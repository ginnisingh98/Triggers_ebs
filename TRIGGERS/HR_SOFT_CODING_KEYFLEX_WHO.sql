--------------------------------------------------------
--  DDL for Trigger HR_SOFT_CODING_KEYFLEX_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_SOFT_CODING_KEYFLEX_WHO" 
before insert or update on "HR"."HR_SOFT_CODING_KEYFLEX"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_SOFT_CODING_KEYFLEX_WHO" ENABLE;
