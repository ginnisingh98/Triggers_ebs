--------------------------------------------------------
--  DDL for Trigger BOM_STD_SUB_OP_RESOURCES_T3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BOM_STD_SUB_OP_RESOURCES_T3" 
	BEFORE DELETE ON "BOM"."BOM_STD_SUB_OP_RESOURCES" FOR EACH ROW
...
/
ALTER TRIGGER "APPS"."BOM_STD_SUB_OP_RESOURCES_T3" ENABLE;
