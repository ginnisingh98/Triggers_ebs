--------------------------------------------------------
--  DDL for Trigger BEN_PREM_CSTG_BY_SGMT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PREM_CSTG_BY_SGMT_F_WHO" 
before insert or update on "BEN"."BEN_PREM_CSTG_BY_SGMT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PREM_CSTG_BY_SGMT_F_WHO" ENABLE;
