--------------------------------------------------------
--  DDL for Trigger PER_SALARY_SURVEYS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SALARY_SURVEYS_WHO" 
before insert or update on "HR"."PER_SALARY_SURVEYS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SALARY_SURVEYS_WHO" ENABLE;
