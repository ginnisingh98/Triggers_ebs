--------------------------------------------------------
--  DDL for Trigger PQP_EXCEPTION_REPORT_GROUP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_EXCEPTION_REPORT_GROUP_WHO" 
before insert or update on "HR"."PQP_EXCEPTION_REPORT_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_EXCEPTION_REPORT_GROUP_WHO" ENABLE;
