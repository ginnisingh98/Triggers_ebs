--------------------------------------------------------
--  DDL for Trigger PQH_RULE_SETS_TL052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_RULE_SETS_TL052616_WHO" 
before insert or update on "HR"."PQH_RULE_SETS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_RULE_SETS_TL052616_WHO" ENABLE;
