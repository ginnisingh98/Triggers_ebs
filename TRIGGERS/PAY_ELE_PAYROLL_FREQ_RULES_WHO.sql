--------------------------------------------------------
--  DDL for Trigger PAY_ELE_PAYROLL_FREQ_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELE_PAYROLL_FREQ_RULES_WHO" 
before insert or update on "HR"."PAY_ELE_PAYROLL_FREQ_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELE_PAYROLL_FREQ_RULES_WHO" ENABLE;
