--------------------------------------------------------
--  DDL for Trigger BEN_COMP_ASSET_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_COMP_ASSET_WHO" 
before insert or update on "BEN"."BEN_COMP_ASSET"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_COMP_ASSET_WHO" ENABLE;
