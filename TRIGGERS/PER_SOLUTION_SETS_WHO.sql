--------------------------------------------------------
--  DDL for Trigger PER_SOLUTION_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SOLUTION_SETS_WHO" 
before insert or update on "HR"."PER_SOLUTION_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SOLUTION_SETS_WHO" ENABLE;
