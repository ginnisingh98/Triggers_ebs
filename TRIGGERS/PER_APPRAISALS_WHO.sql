--------------------------------------------------------
--  DDL for Trigger PER_APPRAISALS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_APPRAISALS_WHO" 
before insert or update on "HR"."PER_APPRAISALS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_APPRAISALS_WHO" ENABLE;
