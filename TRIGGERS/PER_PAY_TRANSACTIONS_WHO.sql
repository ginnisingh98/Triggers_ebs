--------------------------------------------------------
--  DDL for Trigger PER_PAY_TRANSACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PAY_TRANSACTIONS_WHO" 
before insert or update on "HR"."PER_PAY_TRANSACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PAY_TRANSACTIONS_WHO" ENABLE;
