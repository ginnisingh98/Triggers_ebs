--------------------------------------------------------
--  DDL for Trigger PAY_ZA_CDV_PARAMETERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ZA_CDV_PARAMETERS_WHO" 
...
/
ALTER TRIGGER "APPS"."PAY_ZA_CDV_PARAMETERS_WHO" ENABLE;
