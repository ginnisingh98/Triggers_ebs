--------------------------------------------------------
--  DDL for Trigger HR_DU_UPLOAD_HEADERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DU_UPLOAD_HEADERS_WHO" 
before insert or update on "HR"."HR_DU_UPLOAD_HEADERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DU_UPLOAD_HEADERS_WHO" ENABLE;
