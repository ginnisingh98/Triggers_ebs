--------------------------------------------------------
--  DDL for Trigger BEN_POPL_ACTN_TYP_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_POPL_ACTN_TYP_F_WHO" 
before insert or update on "BEN"."BEN_POPL_ACTN_TYP_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_POPL_ACTN_TYP_F_WHO" ENABLE;
