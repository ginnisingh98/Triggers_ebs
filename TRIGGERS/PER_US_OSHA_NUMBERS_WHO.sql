--------------------------------------------------------
--  DDL for Trigger PER_US_OSHA_NUMBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_US_OSHA_NUMBERS_WHO" 
before insert or update on "HR"."PER_US_OSHA_NUMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_US_OSHA_NUMBERS_WHO" ENABLE;
