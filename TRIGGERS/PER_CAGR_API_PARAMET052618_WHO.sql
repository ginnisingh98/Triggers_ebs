--------------------------------------------------------
--  DDL for Trigger PER_CAGR_API_PARAMET052618_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_API_PARAMET052618_WHO" 
before insert or update on "HR"."PER_CAGR_API_PARAMETERS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_API_PARAMET052618_WHO" ENABLE;
