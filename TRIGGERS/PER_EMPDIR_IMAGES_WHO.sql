--------------------------------------------------------
--  DDL for Trigger PER_EMPDIR_IMAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_EMPDIR_IMAGES_WHO" 
before insert or update on "HR"."PER_EMPDIR_IMAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_EMPDIR_IMAGES_WHO" ENABLE;
