--------------------------------------------------------
--  DDL for Trigger IRC_NOTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_NOTES_WHO" 
before insert or update on "HR"."IRC_NOTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_NOTES_WHO" ENABLE;
