--------------------------------------------------------
--  DDL for Trigger OTA_FORUMS_B_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_FORUMS_B_WHO" 
before insert or update on "OTA"."OTA_FORUMS_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_FORUMS_B_WHO" ENABLE;
