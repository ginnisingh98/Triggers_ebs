--------------------------------------------------------
--  DDL for Trigger OTA_EVENT_ASSOCIATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_EVENT_ASSOCIATIONS_WHO" 
before insert or update on "OTA"."OTA_EVENT_ASSOCIATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_EVENT_ASSOCIATIONS_WHO" ENABLE;
