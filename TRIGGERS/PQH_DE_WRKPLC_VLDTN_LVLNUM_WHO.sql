--------------------------------------------------------
--  DDL for Trigger PQH_DE_WRKPLC_VLDTN_LVLNUM_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_WRKPLC_VLDTN_LVLNUM_WHO" 
before insert or update on "HR"."PQH_DE_WRKPLC_VLDTN_LVLNUMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_WRKPLC_VLDTN_LVLNUM_WHO" ENABLE;
