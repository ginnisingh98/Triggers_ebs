--------------------------------------------------------
--  DDL for Trigger OTA_PVT_FRM_THREAD_USERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_PVT_FRM_THREAD_USERS_WHO" 
before insert or update on "OTA"."OTA_PVT_FRM_THREAD_USERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_PVT_FRM_THREAD_USERS_WHO" ENABLE;
