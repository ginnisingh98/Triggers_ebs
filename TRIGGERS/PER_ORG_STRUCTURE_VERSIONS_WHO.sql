--------------------------------------------------------
--  DDL for Trigger PER_ORG_STRUCTURE_VERSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ORG_STRUCTURE_VERSIONS_WHO" 
before insert or update on "HR"."PER_ORG_STRUCTURE_VERSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ORG_STRUCTURE_VERSIONS_WHO" ENABLE;
