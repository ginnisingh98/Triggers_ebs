--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_SETS_WHO" 
before insert or update on "HR"."PAY_ELEMENT_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_SETS_WHO" ENABLE;
