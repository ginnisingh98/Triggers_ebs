--------------------------------------------------------
--  DDL for Trigger BEN_VSTG_LOS_RQMT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_VSTG_LOS_RQMT_WHO" 
before insert or update on "BEN"."BEN_VSTG_LOS_RQMT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_VSTG_LOS_RQMT_WHO" ENABLE;
