--------------------------------------------------------
--  DDL for Trigger PER_BUDGET_VERSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BUDGET_VERSIONS_WHO" 
before insert or update on "HR"."PER_BUDGET_VERSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BUDGET_VERSIONS_WHO" ENABLE;
