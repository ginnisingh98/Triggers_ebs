--------------------------------------------------------
--  DDL for Trigger HXC_TK_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_TK_GROUPS_WHO" 
before insert or update on "HXC"."HXC_TK_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_TK_GROUPS_WHO" ENABLE;
