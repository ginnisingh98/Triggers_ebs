--------------------------------------------------------
--  DDL for Trigger GMA_PS_TEXT_TBL_T1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GMA_PS_TEXT_TBL_T1" 
instead of insert on PS_TEXT_TBL_VL
referencing new as PS_TEXT_TBL
for each row
declare
  row_id rowid;
begin
  GMA_PS_TEXT_TBL_PKG.INSERT_ROW(
    X_ROWID => ROW_ID,
    ...
    X_CREATION_DATE => :PS_TEXT_TBL.CREATION_DATE,
    X_CREATED_BY => :PS_TEXT_TBL.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."GMA_PS_TEXT_TBL_T1" ENABLE;
