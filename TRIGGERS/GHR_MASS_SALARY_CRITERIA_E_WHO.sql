--------------------------------------------------------
--  DDL for Trigger GHR_MASS_SALARY_CRITERIA_E_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_MASS_SALARY_CRITERIA_E_WHO" 
before insert or update on "HR"."GHR_MASS_SALARY_CRITERIA_EXT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_MASS_SALARY_CRITERIA_E_WHO" ENABLE;
