--------------------------------------------------------
--  DDL for Trigger IRC_REFERENCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_REFERENCES_WHO" 
before insert or update on "HR"."IRC_REFERENCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_REFERENCES_WHO" ENABLE;
