--------------------------------------------------------
--  DDL for Trigger BEN_DSGN_RQMT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DSGN_RQMT_F_WHO" 
before insert or update on "BEN"."BEN_DSGN_RQMT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DSGN_RQMT_F_WHO" ENABLE;
