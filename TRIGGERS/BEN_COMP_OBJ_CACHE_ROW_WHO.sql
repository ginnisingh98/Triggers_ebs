--------------------------------------------------------
--  DDL for Trigger BEN_COMP_OBJ_CACHE_ROW_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_COMP_OBJ_CACHE_ROW_WHO" 
before insert or update on "BEN"."BEN_COMP_OBJ_CACHE_ROW"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_COMP_OBJ_CACHE_ROW_WHO" ENABLE;
