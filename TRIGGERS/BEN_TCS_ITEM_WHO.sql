--------------------------------------------------------
--  DDL for Trigger BEN_TCS_ITEM_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_TCS_ITEM_WHO" 
before insert or update on "BEN"."BEN_TCS_ITEM"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_TCS_ITEM_WHO" ENABLE;
