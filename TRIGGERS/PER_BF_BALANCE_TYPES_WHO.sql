--------------------------------------------------------
--  DDL for Trigger PER_BF_BALANCE_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BF_BALANCE_TYPES_WHO" 
before insert or update on "HR"."PER_BF_BALANCE_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BF_BALANCE_TYPES_WHO" ENABLE;
