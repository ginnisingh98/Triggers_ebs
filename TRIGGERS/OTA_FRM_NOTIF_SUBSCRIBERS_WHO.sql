--------------------------------------------------------
--  DDL for Trigger OTA_FRM_NOTIF_SUBSCRIBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_FRM_NOTIF_SUBSCRIBERS_WHO" 
before insert or update on "OTA"."OTA_FRM_NOTIF_SUBSCRIBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_FRM_NOTIF_SUBSCRIBERS_WHO" ENABLE;
