--------------------------------------------------------
--  DDL for Trigger HR_PATTERNS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PATTERNS_WHO" 
before insert or update on "HR"."HR_PATTERNS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PATTERNS_WHO" ENABLE;
