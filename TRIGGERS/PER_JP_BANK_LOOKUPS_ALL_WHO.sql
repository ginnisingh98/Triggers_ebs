--------------------------------------------------------
--  DDL for Trigger PER_JP_BANK_LOOKUPS_ALL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_JP_BANK_LOOKUPS_ALL_WHO" 
before insert or update on "HR"."PER_JP_BANK_LOOKUPS_ALL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_JP_BANK_LOOKUPS_ALL_WHO" ENABLE;
