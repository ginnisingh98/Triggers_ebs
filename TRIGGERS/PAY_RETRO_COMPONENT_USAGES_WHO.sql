--------------------------------------------------------
--  DDL for Trigger PAY_RETRO_COMPONENT_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_RETRO_COMPONENT_USAGES_WHO" 
before insert or update on "HR"."PAY_RETRO_COMPONENT_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_RETRO_COMPONENT_USAGES_WHO" ENABLE;
