--------------------------------------------------------
--  DDL for Trigger PER_ESTABLISHMENT_ATTENDAN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ESTABLISHMENT_ATTENDAN_WHO" 
before insert or update on "HR"."PER_ESTABLISHMENT_ATTENDANCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ESTABLISHMENT_ATTENDAN_WHO" ENABLE;
