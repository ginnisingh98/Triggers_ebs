--------------------------------------------------------
--  DDL for Trigger PQH_RANK_PROCESSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_RANK_PROCESSES_WHO" 
before insert or update on "HR"."PQH_RANK_PROCESSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_RANK_PROCESSES_WHO" ENABLE;
