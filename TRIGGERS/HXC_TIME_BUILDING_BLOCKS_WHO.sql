--------------------------------------------------------
--  DDL for Trigger HXC_TIME_BUILDING_BLOCKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_TIME_BUILDING_BLOCKS_WHO" 
before insert or update on "HXC"."HXC_TIME_BUILDING_BLOCKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_TIME_BUILDING_BLOCKS_WHO" ENABLE;
