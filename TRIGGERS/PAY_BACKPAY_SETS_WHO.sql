--------------------------------------------------------
--  DDL for Trigger PAY_BACKPAY_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_BACKPAY_SETS_WHO" 
before insert or update on "HR"."PAY_BACKPAY_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_BACKPAY_SETS_WHO" ENABLE;
