--------------------------------------------------------
--  DDL for Trigger PQP_VEHICLE_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_VEHICLE_DETAILS_WHO" 
before insert or update on "HR"."PQP_VEHICLE_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_VEHICLE_DETAILS_WHO" ENABLE;
