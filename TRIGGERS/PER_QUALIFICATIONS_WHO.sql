--------------------------------------------------------
--  DDL for Trigger PER_QUALIFICATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_QUALIFICATIONS_WHO" 
before insert or update on "HR"."PER_QUALIFICATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_QUALIFICATIONS_WHO" ENABLE;
