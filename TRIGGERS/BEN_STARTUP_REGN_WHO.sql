--------------------------------------------------------
--  DDL for Trigger BEN_STARTUP_REGN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_STARTUP_REGN_WHO" 
before insert or update on "BEN"."BEN_STARTUP_REGN"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_STARTUP_REGN_WHO" ENABLE;
