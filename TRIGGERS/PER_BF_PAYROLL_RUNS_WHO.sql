--------------------------------------------------------
--  DDL for Trigger PER_BF_PAYROLL_RUNS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BF_PAYROLL_RUNS_WHO" 
before insert or update on "HR"."PER_BF_PAYROLL_RUNS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BF_PAYROLL_RUNS_WHO" ENABLE;
