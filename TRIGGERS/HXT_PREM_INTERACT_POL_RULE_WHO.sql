--------------------------------------------------------
--  DDL for Trigger HXT_PREM_INTERACT_POL_RULE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_PREM_INTERACT_POL_RULE_WHO" 
before insert or update on "HXT"."HXT_PREM_INTERACT_POL_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_PREM_INTERACT_POL_RULE_WHO" ENABLE;
