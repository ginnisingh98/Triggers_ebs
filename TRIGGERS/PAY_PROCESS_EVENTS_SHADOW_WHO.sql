--------------------------------------------------------
--  DDL for Trigger PAY_PROCESS_EVENTS_SHADOW_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_PROCESS_EVENTS_SHADOW_WHO" 
before insert or update on "HR"."PAY_PROCESS_EVENTS_SHADOW"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_PROCESS_EVENTS_SHADOW_WHO" ENABLE;
