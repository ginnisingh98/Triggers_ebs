--------------------------------------------------------
--  DDL for Trigger HXT_PREM_ELIGBLTY_POLICIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_PREM_ELIGBLTY_POLICIES_WHO" 
before insert or update on "HXT"."HXT_PREM_ELIGBLTY_POLICIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_PREM_ELIGBLTY_POLICIES_WHO" ENABLE;
