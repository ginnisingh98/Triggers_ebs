--------------------------------------------------------
--  DDL for Trigger HXC_DATA_SET_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_DATA_SET_DETAILS_WHO" 
before insert or update on "HXC"."HXC_DATA_SET_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_DATA_SET_DETAILS_WHO" ENABLE;
