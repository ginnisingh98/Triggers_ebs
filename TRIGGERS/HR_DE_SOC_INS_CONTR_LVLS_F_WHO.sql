--------------------------------------------------------
--  DDL for Trigger HR_DE_SOC_INS_CONTR_LVLS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DE_SOC_INS_CONTR_LVLS_F_WHO" 
before insert or update on "HR"."HR_DE_SOC_INS_CONTR_LVLS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DE_SOC_INS_CONTR_LVLS_F_WHO" ENABLE;
