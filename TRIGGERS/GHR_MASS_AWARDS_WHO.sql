--------------------------------------------------------
--  DDL for Trigger GHR_MASS_AWARDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_MASS_AWARDS_WHO" 
before insert or update on "HR"."GHR_MASS_AWARDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_MASS_AWARDS_WHO" ENABLE;
