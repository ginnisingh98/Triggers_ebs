--------------------------------------------------------
--  DDL for Trigger IRC_ALL_RECRUITING_SITES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_ALL_RECRUITING_SITES_WHO" 
before insert or update on "HR"."IRC_ALL_RECRUITING_SITES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_ALL_RECRUITING_SITES_WHO" ENABLE;
