--------------------------------------------------------
--  DDL for Trigger HRI_EQ_SUP_ABSNC_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_SUP_ABSNC_WHO" 
before insert or update on "HRI"."HRI_EQ_SUP_ABSNC"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_SUP_ABSNC_WHO" ENABLE;
