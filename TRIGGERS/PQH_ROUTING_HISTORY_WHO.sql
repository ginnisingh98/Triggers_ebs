--------------------------------------------------------
--  DDL for Trigger PQH_ROUTING_HISTORY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ROUTING_HISTORY_WHO" 
before insert or update on "HR"."PQH_ROUTING_HISTORY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ROUTING_HISTORY_WHO" ENABLE;
