--------------------------------------------------------
--  DDL for Trigger HR_API_TRANSACTION_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_API_TRANSACTION_VALUES_WHO" 
before insert or update on "HR"."HR_API_TRANSACTION_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_API_TRANSACTION_VALUES_WHO" ENABLE;
