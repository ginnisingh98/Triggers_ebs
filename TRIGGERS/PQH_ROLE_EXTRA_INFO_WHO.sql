--------------------------------------------------------
--  DDL for Trigger PQH_ROLE_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ROLE_EXTRA_INFO_WHO" 
before insert or update on "HR"."PQH_ROLE_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ROLE_EXTRA_INFO_WHO" ENABLE;
