--------------------------------------------------------
--  DDL for Trigger FF_FUNCTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_FUNCTIONS_WHO" 
before insert or update on "HR"."FF_FUNCTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_FUNCTIONS_WHO" ENABLE;
