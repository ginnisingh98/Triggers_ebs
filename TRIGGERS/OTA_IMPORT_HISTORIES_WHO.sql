--------------------------------------------------------
--  DDL for Trigger OTA_IMPORT_HISTORIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_IMPORT_HISTORIES_WHO" 
before insert or update on "OTA"."OTA_IMPORT_HISTORIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_IMPORT_HISTORIES_WHO" ENABLE;
