--------------------------------------------------------
--  DDL for Trigger JA_AU_LOCAL_ACCOUNTING
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."JA_AU_LOCAL_ACCOUNTING" 
after update of costed_flag on "INV"."MTL_MATERIAL_TRANSACTIONS"
for each row    WHEN (old.transaction_type_id in (50,54,61,62) and
...
/
ALTER TRIGGER "APPS"."JA_AU_LOCAL_ACCOUNTING" ENABLE;
