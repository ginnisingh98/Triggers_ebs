--------------------------------------------------------
--  DDL for Trigger PAY_STATUS_PROCESSING_RULE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_STATUS_PROCESSING_RULE_WHO" 
before insert or update on "HR"."PAY_STATUS_PROCESSING_RULES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_STATUS_PROCESSING_RULE_WHO" ENABLE;
