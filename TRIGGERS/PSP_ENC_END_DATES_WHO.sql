--------------------------------------------------------
--  DDL for Trigger PSP_ENC_END_DATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ENC_END_DATES_WHO" 
before insert or update on "PSP"."PSP_ENC_END_DATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ENC_END_DATES_WHO" ENABLE;
