--------------------------------------------------------
--  DDL for Trigger PQH_FR_VALIDATION_PERIODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_FR_VALIDATION_PERIODS_WHO" 
before insert or update on "HR"."PQH_FR_VALIDATION_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_FR_VALIDATION_PERIODS_WHO" ENABLE;
