--------------------------------------------------------
--  DDL for Trigger PER_POSITION_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_POSITION_EXTRA_INFO_WHO" 
before insert or update on "HR"."PER_POSITION_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_POSITION_EXTRA_INFO_WHO" ENABLE;
