--------------------------------------------------------
--  DDL for Trigger BEN_VRBL_RT_PRFL_RL_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_VRBL_RT_PRFL_RL_F_WHO" 
before insert or update on "BEN"."BEN_VRBL_RT_PRFL_RL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_VRBL_RT_PRFL_RL_F_WHO" ENABLE;
