--------------------------------------------------------
--  DDL for Trigger PQP_PENSION_TYPES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_PENSION_TYPES_F_WHO" 
before insert or update on "HR"."PQP_PENSION_TYPES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_PENSION_TYPES_F_WHO" ENABLE;
