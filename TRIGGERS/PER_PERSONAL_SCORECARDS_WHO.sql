--------------------------------------------------------
--  DDL for Trigger PER_PERSONAL_SCORECARDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERSONAL_SCORECARDS_WHO" 
before insert or update on "HR"."PER_PERSONAL_SCORECARDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERSONAL_SCORECARDS_WHO" ENABLE;
