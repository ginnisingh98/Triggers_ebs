--------------------------------------------------------
--  DDL for Trigger PAY_JP_BANKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_JP_BANKS_WHO" 
before insert or update on "HR"."PAY_JP_BANKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_JP_BANKS_WHO" ENABLE;
