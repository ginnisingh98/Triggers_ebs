--------------------------------------------------------
--  DDL for Trigger PER_WPM_APPRAISAL_SUMMARY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_WPM_APPRAISAL_SUMMARY_WHO" 
before insert or update on "HR"."PER_WPM_APPRAISAL_SUMMARY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_WPM_APPRAISAL_SUMMARY_WHO" ENABLE;
