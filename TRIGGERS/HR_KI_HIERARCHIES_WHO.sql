--------------------------------------------------------
--  DDL for Trigger HR_KI_HIERARCHIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_HIERARCHIES_WHO" 
before insert or update on "HR"."HR_KI_HIERARCHIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_HIERARCHIES_WHO" ENABLE;
