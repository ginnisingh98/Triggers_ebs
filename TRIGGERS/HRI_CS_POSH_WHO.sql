--------------------------------------------------------
--  DDL for Trigger HRI_CS_POSH_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_CS_POSH_WHO" 
before insert or update on "HRI"."HRI_CS_POSH"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_CS_POSH_WHO" ENABLE;
