--------------------------------------------------------
--  DDL for Trigger PER_RI_RT_METADATA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_RT_METADATA_WHO" 
before insert or update on "HR"."PER_RI_RT_METADATA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_RT_METADATA_WHO" ENABLE;
