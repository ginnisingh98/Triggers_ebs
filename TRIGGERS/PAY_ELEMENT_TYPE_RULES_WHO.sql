--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_TYPE_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_TYPE_RULES_WHO" 
before insert or update on "HR"."PAY_ELEMENT_TYPE_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_TYPE_RULES_WHO" ENABLE;
