--------------------------------------------------------
--  DDL for Trigger PQH_DE_TATIGKEIT_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_TATIGKEIT_DETAILS_WHO" 
before insert or update on "HR"."PQH_DE_TATIGKEIT_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_TATIGKEIT_DETAILS_WHO" ENABLE;
