--------------------------------------------------------
--  DDL for Trigger PER_PERF_MGMT_PLANS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERF_MGMT_PLANS_WHO" 
before insert or update on "HR"."PER_PERF_MGMT_PLANS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERF_MGMT_PLANS_WHO" ENABLE;
