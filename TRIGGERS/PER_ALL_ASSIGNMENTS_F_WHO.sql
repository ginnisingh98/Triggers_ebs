--------------------------------------------------------
--  DDL for Trigger PER_ALL_ASSIGNMENTS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ALL_ASSIGNMENTS_F_WHO" 
before insert or update on "HR"."PER_ALL_ASSIGNMENTS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ALL_ASSIGNMENTS_F_WHO" ENABLE;
