--------------------------------------------------------
--  DDL for Trigger HR_KI_HIERARCHIES_TL052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_HIERARCHIES_TL052616_WHO" 
before insert or update on "HR"."HR_KI_HIERARCHIES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_HIERARCHIES_TL052616_WHO" ENABLE;
