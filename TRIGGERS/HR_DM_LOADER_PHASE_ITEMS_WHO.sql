--------------------------------------------------------
--  DDL for Trigger HR_DM_LOADER_PHASE_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_LOADER_PHASE_ITEMS_WHO" 
before insert or update on "HR"."HR_DM_LOADER_PHASE_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_LOADER_PHASE_ITEMS_WHO" ENABLE;
