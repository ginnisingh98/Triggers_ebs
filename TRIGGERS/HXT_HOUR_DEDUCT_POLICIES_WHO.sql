--------------------------------------------------------
--  DDL for Trigger HXT_HOUR_DEDUCT_POLICIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_HOUR_DEDUCT_POLICIES_WHO" 
before insert or update on "HXT"."HXT_HOUR_DEDUCT_POLICIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_HOUR_DEDUCT_POLICIES_WHO" ENABLE;
