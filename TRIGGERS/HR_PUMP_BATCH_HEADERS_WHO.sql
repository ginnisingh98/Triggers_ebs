--------------------------------------------------------
--  DDL for Trigger HR_PUMP_BATCH_HEADERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PUMP_BATCH_HEADERS_WHO" 
before insert or update on "HR"."HR_PUMP_BATCH_HEADERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PUMP_BATCH_HEADERS_WHO" ENABLE;
