--------------------------------------------------------
--  DDL for Trigger HXT_WEEKLY_WORK_SCHEDULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_WEEKLY_WORK_SCHEDULES_WHO" 
before insert or update on "HXT"."HXT_WEEKLY_WORK_SCHEDULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_WEEKLY_WORK_SCHEDULES_WHO" ENABLE;
