--------------------------------------------------------
--  DDL for Trigger BEN_PERSON_ACTION_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PERSON_ACTION_ITEMS_WHO" 
before insert or update on "BEN"."BEN_PERSON_ACTION_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PERSON_ACTION_ITEMS_WHO" ENABLE;
