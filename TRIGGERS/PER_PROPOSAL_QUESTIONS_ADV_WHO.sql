--------------------------------------------------------
--  DDL for Trigger PER_PROPOSAL_QUESTIONS_ADV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PROPOSAL_QUESTIONS_ADV_WHO" 
before insert or update on "HR"."PER_PROPOSAL_QUESTIONS_ADV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PROPOSAL_QUESTIONS_ADV_WHO" ENABLE;
