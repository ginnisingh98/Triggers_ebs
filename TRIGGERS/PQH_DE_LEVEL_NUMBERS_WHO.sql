--------------------------------------------------------
--  DDL for Trigger PQH_DE_LEVEL_NUMBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_LEVEL_NUMBERS_WHO" 
before insert or update on "HR"."PQH_DE_LEVEL_NUMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_LEVEL_NUMBERS_WHO" ENABLE;
