--------------------------------------------------------
--  DDL for Trigger HR_NAVIGATION_UNITS_052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_NAVIGATION_UNITS_052616_WHO" 
before insert or update on "HR"."HR_NAVIGATION_UNITS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_NAVIGATION_UNITS_052616_WHO" ENABLE;
