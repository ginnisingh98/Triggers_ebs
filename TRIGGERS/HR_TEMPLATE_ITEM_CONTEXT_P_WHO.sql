--------------------------------------------------------
--  DDL for Trigger HR_TEMPLATE_ITEM_CONTEXT_P_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_TEMPLATE_ITEM_CONTEXT_P_WHO" 
before insert or update on "HR"."HR_TEMPLATE_ITEM_CONTEXT_PAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_TEMPLATE_ITEM_CONTEXT_P_WHO" ENABLE;
