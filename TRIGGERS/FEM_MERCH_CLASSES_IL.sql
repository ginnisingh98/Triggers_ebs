--------------------------------------------------------
--  DDL for Trigger FEM_MERCH_CLASSES_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_MERCH_CLASSES_IL" 
instead of insert on FEM_MERCH_CLASSES_VL
...
declare
 ...
 ---
begin
  FEM_MERCH_CLASSES_PKG.INSERT_ROW(
    X_ROWID => ROW_ID,
    ...
    X_CREATION_DATE => :FEM_MERCH_CLASSES_B.CREATION_DATE,
    X_CREATED_BY => :FEM_MERCH_CLASSES_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_MERCH_CLASSES_IL" ENABLE;
