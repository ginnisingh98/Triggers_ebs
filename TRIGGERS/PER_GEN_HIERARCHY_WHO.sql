--------------------------------------------------------
--  DDL for Trigger PER_GEN_HIERARCHY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_GEN_HIERARCHY_WHO" 
before insert or update on "HR"."PER_GEN_HIERARCHY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_GEN_HIERARCHY_WHO" ENABLE;
