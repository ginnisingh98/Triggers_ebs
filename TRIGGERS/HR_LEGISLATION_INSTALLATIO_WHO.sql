--------------------------------------------------------
--  DDL for Trigger HR_LEGISLATION_INSTALLATIO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_LEGISLATION_INSTALLATIO_WHO" 
before insert or update on "HR"."HR_LEGISLATION_INSTALLATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_LEGISLATION_INSTALLATIO_WHO" ENABLE;
