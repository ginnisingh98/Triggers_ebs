--------------------------------------------------------
--  DDL for Trigger HR_DM_LOADER_PARAMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_LOADER_PARAMS_WHO" 
before insert or update on "HR"."HR_DM_LOADER_PARAMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_LOADER_PARAMS_WHO" ENABLE;
