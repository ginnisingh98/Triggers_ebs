--------------------------------------------------------
--  DDL for Trigger HR_DM_MIGRATION_RANGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_MIGRATION_RANGES_WHO" 
before insert or update on "HR"."HR_DM_MIGRATION_RANGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_MIGRATION_RANGES_WHO" ENABLE;
