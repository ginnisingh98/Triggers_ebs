--------------------------------------------------------
--  DDL for Trigger PSP_TEMPLATE_PROJECTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_TEMPLATE_PROJECTS_WHO" 
before insert or update on "PSP"."PSP_TEMPLATE_PROJECTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_TEMPLATE_PROJECTS_WHO" ENABLE;
