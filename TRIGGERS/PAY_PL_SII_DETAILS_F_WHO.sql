--------------------------------------------------------
--  DDL for Trigger PAY_PL_SII_DETAILS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_PL_SII_DETAILS_F_WHO" 
before insert or update on "HR"."PAY_PL_SII_DETAILS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_PL_SII_DETAILS_F_WHO" ENABLE;
