--------------------------------------------------------
--  DDL for Trigger PAY_BATCH_HEADERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_BATCH_HEADERS_WHO" 
before insert or update on "HR"."PAY_BATCH_HEADERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_BATCH_HEADERS_WHO" ENABLE;
