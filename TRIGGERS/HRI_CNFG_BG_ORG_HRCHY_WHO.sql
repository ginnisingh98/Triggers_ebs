--------------------------------------------------------
--  DDL for Trigger HRI_CNFG_BG_ORG_HRCHY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_CNFG_BG_ORG_HRCHY_WHO" 
before insert or update on "HRI"."HRI_CNFG_BG_ORG_HRCHY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_CNFG_BG_ORG_HRCHY_WHO" ENABLE;
