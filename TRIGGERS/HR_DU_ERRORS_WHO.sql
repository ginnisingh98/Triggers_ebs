--------------------------------------------------------
--  DDL for Trigger HR_DU_ERRORS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DU_ERRORS_WHO" 
before insert or update on "HR"."HR_DU_ERRORS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DU_ERRORS_WHO" ENABLE;
