--------------------------------------------------------
--  DDL for Trigger HR_DU_DESCRIPTORS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DU_DESCRIPTORS_WHO" 
before insert or update on "HR"."HR_DU_DESCRIPTORS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DU_DESCRIPTORS_WHO" ENABLE;
