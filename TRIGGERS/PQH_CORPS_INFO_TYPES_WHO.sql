--------------------------------------------------------
--  DDL for Trigger PQH_CORPS_INFO_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_CORPS_INFO_TYPES_WHO" 
before insert or update on "HR"."PQH_CORPS_INFO_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_CORPS_INFO_TYPES_WHO" ENABLE;
