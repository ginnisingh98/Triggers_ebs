--------------------------------------------------------
--  DDL for Trigger HR_FORM_DATA_GROUP_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_FORM_DATA_GROUP_ITEMS_WHO" 
before insert or update on "HR"."HR_FORM_DATA_GROUP_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_FORM_DATA_GROUP_ITEMS_WHO" ENABLE;
