--------------------------------------------------------
--  DDL for Trigger HRI_ORG_PARAMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_ORG_PARAMS_WHO" 
before insert or update on "HRI"."HRI_ORG_PARAMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_ORG_PARAMS_WHO" ENABLE;
