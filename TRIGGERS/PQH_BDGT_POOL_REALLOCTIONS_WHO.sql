--------------------------------------------------------
--  DDL for Trigger PQH_BDGT_POOL_REALLOCTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BDGT_POOL_REALLOCTIONS_WHO" 
before insert or update on "HR"."PQH_BDGT_POOL_REALLOCTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BDGT_POOL_REALLOCTIONS_WHO" ENABLE;
