--------------------------------------------------------
--  DDL for Trigger PER_CAGR_ENTITLEMENT_LINES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_ENTITLEMENT_LINES_WHO" 
before insert or update on "HR"."PER_CAGR_ENTITLEMENT_LINES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_ENTITLEMENT_LINES_WHO" ENABLE;
