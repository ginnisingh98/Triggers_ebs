--------------------------------------------------------
--  DDL for Trigger PER_CAGR_APIS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_APIS_WHO" 
before insert or update on "HR"."PER_CAGR_APIS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_APIS_WHO" ENABLE;
