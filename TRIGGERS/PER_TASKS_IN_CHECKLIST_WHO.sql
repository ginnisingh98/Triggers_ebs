--------------------------------------------------------
--  DDL for Trigger PER_TASKS_IN_CHECKLIST_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_TASKS_IN_CHECKLIST_WHO" 
before insert or update on "HR"."PER_TASKS_IN_CHECKLIST"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_TASKS_IN_CHECKLIST_WHO" ENABLE;
