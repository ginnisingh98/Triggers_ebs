--------------------------------------------------------
--  DDL for Trigger PAY_COST_ALLOCATIONS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_COST_ALLOCATIONS_F_WHO" 
before insert or update on "HR"."PAY_COST_ALLOCATIONS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_COST_ALLOCATIONS_F_WHO" ENABLE;
