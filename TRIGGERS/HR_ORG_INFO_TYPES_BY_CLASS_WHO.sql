--------------------------------------------------------
--  DDL for Trigger HR_ORG_INFO_TYPES_BY_CLASS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ORG_INFO_TYPES_BY_CLASS_WHO" 
before insert or update on "HR"."HR_ORG_INFO_TYPES_BY_CLASS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ORG_INFO_TYPES_BY_CLASS_WHO" ENABLE;
