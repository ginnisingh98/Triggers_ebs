--------------------------------------------------------
--  DDL for Trigger PQH_CORPS_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_CORPS_DEFINITIONS_WHO" 
before insert or update on "HR"."PQH_CORPS_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_CORPS_DEFINITIONS_WHO" ENABLE;
