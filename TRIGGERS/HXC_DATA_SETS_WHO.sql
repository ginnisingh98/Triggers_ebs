--------------------------------------------------------
--  DDL for Trigger HXC_DATA_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_DATA_SETS_WHO" 
before insert or update on "HXC"."HXC_DATA_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_DATA_SETS_WHO" ENABLE;
