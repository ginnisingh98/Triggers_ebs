--------------------------------------------------------
--  DDL for Trigger HR_QUESTIONNAIRES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_QUESTIONNAIRES_WHO" 
before insert or update on "HR"."HR_QUESTIONNAIRES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_QUESTIONNAIRES_WHO" ENABLE;
