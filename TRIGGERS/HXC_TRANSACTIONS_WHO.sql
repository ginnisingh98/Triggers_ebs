--------------------------------------------------------
--  DDL for Trigger HXC_TRANSACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_TRANSACTIONS_WHO" 
before insert or update on "HXC"."HXC_TRANSACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_TRANSACTIONS_WHO" ENABLE;
