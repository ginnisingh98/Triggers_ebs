--------------------------------------------------------
--  DDL for Trigger PSP_ELEMENT_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ELEMENT_GROUPS_WHO" 
before insert or update on "PSP"."PSP_ELEMENT_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ELEMENT_GROUPS_WHO" ENABLE;
