--------------------------------------------------------
--  DDL for Trigger BEN_PL_REGN_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PL_REGN_F_WHO" 
before insert or update on "BEN"."BEN_PL_REGN_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PL_REGN_F_WHO" ENABLE;
