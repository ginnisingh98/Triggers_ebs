--------------------------------------------------------
--  DDL for Trigger PQH_WORKSHEET_BDGT_ELMNTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_WORKSHEET_BDGT_ELMNTS_WHO" 
before insert or update on "HR"."PQH_WORKSHEET_BDGT_ELMNTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_WORKSHEET_BDGT_ELMNTS_WHO" ENABLE;
