--------------------------------------------------------
--  DDL for Trigger PER_STANDARD_HOLIDAYS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_STANDARD_HOLIDAYS_WHO" 
before insert or update on "HR"."PER_STANDARD_HOLIDAYS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_STANDARD_HOLIDAYS_WHO" ENABLE;
