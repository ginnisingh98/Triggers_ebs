--------------------------------------------------------
--  DDL for Trigger HRI_CL_WKR_SUP_STATUS_CT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_CL_WKR_SUP_STATUS_CT_WHO" 
before insert or update on "HRI"."HRI_CL_WKR_SUP_STATUS_CT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_CL_WKR_SUP_STATUS_CT_WHO" ENABLE;
