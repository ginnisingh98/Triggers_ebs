--------------------------------------------------------
--  DDL for Trigger PQH_SITUATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_SITUATIONS_WHO" 
before insert or update on "HR"."PQH_SITUATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_SITUATIONS_WHO" ENABLE;
