--------------------------------------------------------
--  DDL for Trigger PER_STARTUP_PERSON_T052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_STARTUP_PERSON_T052615_WHO" 
before insert or update on "HR"."PER_STARTUP_PERSON_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_STARTUP_PERSON_T052615_WHO" ENABLE;
