--------------------------------------------------------
--  DDL for Trigger PER_ENTERPRISES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ENTERPRISES_WHO" 
before insert or update on "HR"."PER_ENTERPRISES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ENTERPRISES_WHO" ENABLE;
