--------------------------------------------------------
--  DDL for Trigger PER_COMPETENCE_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COMPETENCE_DEFINITIONS_WHO" 
before insert or update on "HR"."PER_COMPETENCE_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COMPETENCE_DEFINITIONS_WHO" ENABLE;
