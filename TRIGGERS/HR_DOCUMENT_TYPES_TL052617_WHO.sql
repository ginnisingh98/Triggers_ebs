--------------------------------------------------------
--  DDL for Trigger HR_DOCUMENT_TYPES_TL052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DOCUMENT_TYPES_TL052617_WHO" 
before insert or update on "HR"."HR_DOCUMENT_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DOCUMENT_TYPES_TL052617_WHO" ENABLE;
