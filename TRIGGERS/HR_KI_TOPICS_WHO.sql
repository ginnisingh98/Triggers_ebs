--------------------------------------------------------
--  DDL for Trigger HR_KI_TOPICS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_TOPICS_WHO" 
before insert or update on "HR"."HR_KI_TOPICS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_TOPICS_WHO" ENABLE;
