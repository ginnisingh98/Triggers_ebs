--------------------------------------------------------
--  DDL for Trigger PER_PTU_DFF_MAPPING_LINES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PTU_DFF_MAPPING_LINES_WHO" 
before insert or update on "HR"."PER_PTU_DFF_MAPPING_LINES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PTU_DFF_MAPPING_LINES_WHO" ENABLE;
