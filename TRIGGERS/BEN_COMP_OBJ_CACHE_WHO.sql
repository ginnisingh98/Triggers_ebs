--------------------------------------------------------
--  DDL for Trigger BEN_COMP_OBJ_CACHE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_COMP_OBJ_CACHE_WHO" 
before insert or update on "BEN"."BEN_COMP_OBJ_CACHE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_COMP_OBJ_CACHE_WHO" ENABLE;
