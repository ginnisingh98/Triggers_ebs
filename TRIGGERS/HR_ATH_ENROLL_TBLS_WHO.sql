--------------------------------------------------------
--  DDL for Trigger HR_ATH_ENROLL_TBLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ATH_ENROLL_TBLS_WHO" 
before insert or update on "HR"."HR_ATH_ENROLL_TBLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ATH_ENROLL_TBLS_WHO" ENABLE;
