--------------------------------------------------------
--  DDL for Trigger GHR_MASS_SALARIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_MASS_SALARIES_WHO" 
before insert or update on "HR"."GHR_MASS_SALARIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_MASS_SALARIES_WHO" ENABLE;
