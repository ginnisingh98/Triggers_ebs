--------------------------------------------------------
--  DDL for Trigger PA_PJI_PROJ_CLASS_T2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PA_PJI_PROJ_CLASS_T2" 
AFTER UPDATE OF
...
BEGIN
	...
	if (l_include_in_pji_flag1 = 'Y' or l_include_in_pji_flag2 = 'Y') and l_template_flag  <> 'Y' then --Bug 6603019
...
/
ALTER TRIGGER "APPS"."PA_PJI_PROJ_CLASS_T2" ENABLE;
