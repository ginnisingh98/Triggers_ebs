--------------------------------------------------------
--  DDL for Trigger BEN_DRVBL_FCTR_UOM_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DRVBL_FCTR_UOM_WHO" 
before insert or update on "BEN"."BEN_DRVBL_FCTR_UOM"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DRVBL_FCTR_UOM_WHO" ENABLE;
