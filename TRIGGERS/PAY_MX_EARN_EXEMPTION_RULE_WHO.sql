--------------------------------------------------------
--  DDL for Trigger PAY_MX_EARN_EXEMPTION_RULE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_MX_EARN_EXEMPTION_RULE_WHO" 
before insert or update on "HR"."PAY_MX_EARN_EXEMPTION_RULES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_MX_EARN_EXEMPTION_RULE_WHO" ENABLE;
