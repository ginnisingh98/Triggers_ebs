--------------------------------------------------------
--  DDL for Trigger PQH_FR_GLOBAL_INDICES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_FR_GLOBAL_INDICES_F_WHO" 
before insert or update on "HR"."PQH_FR_GLOBAL_INDICES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_FR_GLOBAL_INDICES_F_WHO" ENABLE;
