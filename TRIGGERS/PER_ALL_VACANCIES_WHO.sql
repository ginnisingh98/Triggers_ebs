--------------------------------------------------------
--  DDL for Trigger PER_ALL_VACANCIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ALL_VACANCIES_WHO" 
before insert or update on "HR"."PER_ALL_VACANCIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ALL_VACANCIES_WHO" ENABLE;
