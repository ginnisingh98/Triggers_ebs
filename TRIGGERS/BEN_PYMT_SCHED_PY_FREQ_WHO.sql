--------------------------------------------------------
--  DDL for Trigger BEN_PYMT_SCHED_PY_FREQ_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PYMT_SCHED_PY_FREQ_WHO" 
before insert or update on "BEN"."BEN_PYMT_SCHED_PY_FREQ"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PYMT_SCHED_PY_FREQ_WHO" ENABLE;
