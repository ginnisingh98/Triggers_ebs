--------------------------------------------------------
--  DDL for Trigger BEN_VALID_DEPENDENT_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_VALID_DEPENDENT_TYPES_WHO" 
before insert or update on "HR"."BEN_VALID_DEPENDENT_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_VALID_DEPENDENT_TYPES_WHO" ENABLE;
