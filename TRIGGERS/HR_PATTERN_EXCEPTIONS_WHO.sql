--------------------------------------------------------
--  DDL for Trigger HR_PATTERN_EXCEPTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PATTERN_EXCEPTIONS_WHO" 
before insert or update on "HR"."HR_PATTERN_EXCEPTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PATTERN_EXCEPTIONS_WHO" ENABLE;
