--------------------------------------------------------
--  DDL for Trigger PER_PREVIOUS_JOB_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PREVIOUS_JOB_USAGES_WHO" 
before insert or update on "HR"."PER_PREVIOUS_JOB_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PREVIOUS_JOB_USAGES_WHO" ENABLE;
