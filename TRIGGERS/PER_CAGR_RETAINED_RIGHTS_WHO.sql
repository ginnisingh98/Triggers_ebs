--------------------------------------------------------
--  DDL for Trigger PER_CAGR_RETAINED_RIGHTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_RETAINED_RIGHTS_WHO" 
before insert or update on "HR"."PER_CAGR_RETAINED_RIGHTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_RETAINED_RIGHTS_WHO" ENABLE;
