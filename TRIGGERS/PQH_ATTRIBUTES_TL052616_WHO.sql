--------------------------------------------------------
--  DDL for Trigger PQH_ATTRIBUTES_TL052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ATTRIBUTES_TL052616_WHO" 
before insert or update on "HR"."PQH_ATTRIBUTES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ATTRIBUTES_TL052616_WHO" ENABLE;
