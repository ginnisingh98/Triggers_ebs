--------------------------------------------------------
--  DDL for Trigger OTA_PRICE_LIST_ENTRIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_PRICE_LIST_ENTRIES_WHO" 
before insert or update on "OTA"."OTA_PRICE_LIST_ENTRIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_PRICE_LIST_ENTRIES_WHO" ENABLE;
