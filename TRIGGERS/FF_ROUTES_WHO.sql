--------------------------------------------------------
--  DDL for Trigger FF_ROUTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_ROUTES_WHO" 
before insert or update on "HR"."FF_ROUTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_ROUTES_WHO" ENABLE;
