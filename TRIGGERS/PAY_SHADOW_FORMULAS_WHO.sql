--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_FORMULAS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_FORMULAS_WHO" 
before insert or update on "HR"."PAY_SHADOW_FORMULAS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_FORMULAS_WHO" ENABLE;
