--------------------------------------------------------
--  DDL for Trigger HXC_ERRORS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_ERRORS_WHO" 
before insert or update on "HXC"."HXC_ERRORS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_ERRORS_WHO" ENABLE;
