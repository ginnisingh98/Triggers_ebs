--------------------------------------------------------
--  DDL for Trigger BEN_CM_TYP_F_TL052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CM_TYP_F_TL052615_WHO" 
before insert or update on "BEN"."BEN_CM_TYP_F_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CM_TYP_F_TL052615_WHO" ENABLE;
