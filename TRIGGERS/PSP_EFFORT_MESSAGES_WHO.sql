--------------------------------------------------------
--  DDL for Trigger PSP_EFFORT_MESSAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_EFFORT_MESSAGES_WHO" 
before insert or update on "PSP"."PSP_EFFORT_MESSAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_EFFORT_MESSAGES_WHO" ENABLE;
