--------------------------------------------------------
--  DDL for Trigger PER_ASSIGNMENT_BUDGET_VALU_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASSIGNMENT_BUDGET_VALU_WHO" 
before insert or update on "HR"."PER_ASSIGNMENT_BUDGET_VALUES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ASSIGNMENT_BUDGET_VALU_WHO" ENABLE;
