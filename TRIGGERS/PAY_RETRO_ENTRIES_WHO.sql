--------------------------------------------------------
--  DDL for Trigger PAY_RETRO_ENTRIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_RETRO_ENTRIES_WHO" 
before insert or update on "HR"."PAY_RETRO_ENTRIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_RETRO_ENTRIES_WHO" ENABLE;
