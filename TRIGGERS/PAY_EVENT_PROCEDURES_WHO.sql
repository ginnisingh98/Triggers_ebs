--------------------------------------------------------
--  DDL for Trigger PAY_EVENT_PROCEDURES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_EVENT_PROCEDURES_WHO" 
before insert or update on "HR"."PAY_EVENT_PROCEDURES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_EVENT_PROCEDURES_WHO" ENABLE;
