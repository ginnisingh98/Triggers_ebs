--------------------------------------------------------
--  DDL for Trigger HXT_SHIFT_DIFF_POLICIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_SHIFT_DIFF_POLICIES_WHO" 
before insert or update on "HXT"."HXT_SHIFT_DIFF_POLICIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_SHIFT_DIFF_POLICIES_WHO" ENABLE;
