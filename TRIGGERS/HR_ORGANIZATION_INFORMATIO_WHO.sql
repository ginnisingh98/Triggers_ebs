--------------------------------------------------------
--  DDL for Trigger HR_ORGANIZATION_INFORMATIO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ORGANIZATION_INFORMATIO_WHO" 
...
/
ALTER TRIGGER "APPS"."HR_ORGANIZATION_INFORMATIO_WHO" ENABLE;
