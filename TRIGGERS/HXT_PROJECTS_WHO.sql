--------------------------------------------------------
--  DDL for Trigger HXT_PROJECTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_PROJECTS_WHO" 
before insert or update on "HXT"."HXT_PROJECTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_PROJECTS_WHO" ENABLE;
