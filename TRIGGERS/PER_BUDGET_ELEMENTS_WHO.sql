--------------------------------------------------------
--  DDL for Trigger PER_BUDGET_ELEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BUDGET_ELEMENTS_WHO" 
before insert or update on "HR"."PER_BUDGET_ELEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BUDGET_ELEMENTS_WHO" ENABLE;
