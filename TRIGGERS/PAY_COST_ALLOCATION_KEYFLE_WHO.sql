--------------------------------------------------------
--  DDL for Trigger PAY_COST_ALLOCATION_KEYFLE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_COST_ALLOCATION_KEYFLE_WHO" 
before insert or update on "HR"."PAY_COST_ALLOCATION_KEYFLEX"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_COST_ALLOCATION_KEYFLE_WHO" ENABLE;
