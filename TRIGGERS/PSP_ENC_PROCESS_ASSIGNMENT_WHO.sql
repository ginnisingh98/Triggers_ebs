--------------------------------------------------------
--  DDL for Trigger PSP_ENC_PROCESS_ASSIGNMENT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ENC_PROCESS_ASSIGNMENT_WHO" 
before insert or update on "PSP"."PSP_ENC_PROCESS_ASSIGNMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ENC_PROCESS_ASSIGNMENT_WHO" ENABLE;
