--------------------------------------------------------
--  DDL for Trigger OTA_USER_GROUPS_B_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_USER_GROUPS_B_WHO" 
before insert or update on "OTA"."OTA_USER_GROUPS_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_USER_GROUPS_B_WHO" ENABLE;
