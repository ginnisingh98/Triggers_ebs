--------------------------------------------------------
--  DDL for Trigger HRI_CNFG_JOBH_FLEX_COLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_CNFG_JOBH_FLEX_COLS_WHO" 
before insert or update on "HRI"."HRI_CNFG_JOBH_FLEX_COLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_CNFG_JOBH_FLEX_COLS_WHO" ENABLE;
