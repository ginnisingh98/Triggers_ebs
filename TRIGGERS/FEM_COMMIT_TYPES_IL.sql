--------------------------------------------------------
--  DDL for Trigger FEM_COMMIT_TYPES_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_COMMIT_TYPES_IL" 
instead of insert on FEM_COMMIT_TYPES_VL
...
declare
 ...
 ---
begin
  FEM_COMMIT_TYPES_PKG.INSERT_ROW(
    X_ROWID => ROW_ID,
    ...
    X_CREATION_DATE => :FEM_COMMIT_TYPES_B.CREATION_DATE,
    X_CREATED_BY => :FEM_COMMIT_TYPES_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_COMMIT_TYPES_IL" ENABLE;
