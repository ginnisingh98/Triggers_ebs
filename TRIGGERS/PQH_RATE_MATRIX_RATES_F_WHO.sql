--------------------------------------------------------
--  DDL for Trigger PQH_RATE_MATRIX_RATES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_RATE_MATRIX_RATES_F_WHO" 
before insert or update on "HR"."PQH_RATE_MATRIX_RATES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_RATE_MATRIX_RATES_F_WHO" ENABLE;
