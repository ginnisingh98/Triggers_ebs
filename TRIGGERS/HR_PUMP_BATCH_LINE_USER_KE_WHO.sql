--------------------------------------------------------
--  DDL for Trigger HR_PUMP_BATCH_LINE_USER_KE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PUMP_BATCH_LINE_USER_KE_WHO" 
before insert or update on "HR"."HR_PUMP_BATCH_LINE_USER_KEYS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PUMP_BATCH_LINE_USER_KE_WHO" ENABLE;
