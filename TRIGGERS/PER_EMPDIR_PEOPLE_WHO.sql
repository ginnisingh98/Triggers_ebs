--------------------------------------------------------
--  DDL for Trigger PER_EMPDIR_PEOPLE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_EMPDIR_PEOPLE_WHO" 
before insert or update on "HR"."PER_EMPDIR_PEOPLE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_EMPDIR_PEOPLE_WHO" ENABLE;
