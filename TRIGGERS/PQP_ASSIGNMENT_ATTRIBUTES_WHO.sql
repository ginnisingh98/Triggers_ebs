--------------------------------------------------------
--  DDL for Trigger PQP_ASSIGNMENT_ATTRIBUTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_ASSIGNMENT_ATTRIBUTES_WHO" 
before insert or update on "HR"."PQP_ASSIGNMENT_ATTRIBUTES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_ASSIGNMENT_ATTRIBUTES_WHO" ENABLE;
