--------------------------------------------------------
--  DDL for Trigger HXT_ADD_ELEM_INFO_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_ADD_ELEM_INFO_F_WHO" 
before insert or update on "HXT"."HXT_ADD_ELEM_INFO_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_ADD_ELEM_INFO_F_WHO" ENABLE;
