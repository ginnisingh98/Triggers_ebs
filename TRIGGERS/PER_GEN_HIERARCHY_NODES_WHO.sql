--------------------------------------------------------
--  DDL for Trigger PER_GEN_HIERARCHY_NODES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_GEN_HIERARCHY_NODES_WHO" 
before insert or update on "HR"."PER_GEN_HIERARCHY_NODES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_GEN_HIERARCHY_NODES_WHO" ENABLE;
