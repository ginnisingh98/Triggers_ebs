--------------------------------------------------------
--  DDL for Trigger XTR_AD_MIRROR_DDA_LIMIT_ROW_T
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."XTR_AD_MIRROR_DDA_LIMIT_ROW_T" 
 AFTER DELETE on "XTR"."XTR_MIRROR_DDA_LIMIT_ROW" FOR EACH ROW
--
declare
...
/
ALTER TRIGGER "APPS"."XTR_AD_MIRROR_DDA_LIMIT_ROW_T" ENABLE;
