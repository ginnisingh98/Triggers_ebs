--------------------------------------------------------
--  DDL for Trigger GHR_PA_ROUTING_HISTORY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PA_ROUTING_HISTORY_WHO" 
before insert or update on "HR"."GHR_PA_ROUTING_HISTORY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PA_ROUTING_HISTORY_WHO" ENABLE;
