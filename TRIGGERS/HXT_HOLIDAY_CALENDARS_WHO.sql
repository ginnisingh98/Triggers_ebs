--------------------------------------------------------
--  DDL for Trigger HXT_HOLIDAY_CALENDARS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_HOLIDAY_CALENDARS_WHO" 
before insert or update on "HXT"."HXT_HOLIDAY_CALENDARS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_HOLIDAY_CALENDARS_WHO" ENABLE;
