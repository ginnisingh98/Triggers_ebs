--------------------------------------------------------
--  DDL for Trigger PAY_PAYMENT_TYPES_TL052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_PAYMENT_TYPES_TL052617_WHO" 
before insert or update on "HR"."PAY_PAYMENT_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_PAYMENT_TYPES_TL052617_WHO" ENABLE;
