--------------------------------------------------------
--  DDL for Trigger PQP_EXCEPTION_REPORT_SUFFI_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_EXCEPTION_REPORT_SUFFI_WHO" 
before insert or update on "HR"."PQP_EXCEPTION_REPORT_SUFFIX"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_EXCEPTION_REPORT_SUFFI_WHO" ENABLE;
