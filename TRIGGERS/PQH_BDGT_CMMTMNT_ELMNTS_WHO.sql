--------------------------------------------------------
--  DDL for Trigger PQH_BDGT_CMMTMNT_ELMNTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BDGT_CMMTMNT_ELMNTS_WHO" 
before insert or update on "HR"."PQH_BDGT_CMMTMNT_ELMNTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BDGT_CMMTMNT_ELMNTS_WHO" ENABLE;
