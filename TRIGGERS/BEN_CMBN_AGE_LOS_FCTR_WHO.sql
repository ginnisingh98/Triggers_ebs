--------------------------------------------------------
--  DDL for Trigger BEN_CMBN_AGE_LOS_FCTR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CMBN_AGE_LOS_FCTR_WHO" 
before insert or update on "BEN"."BEN_CMBN_AGE_LOS_FCTR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CMBN_AGE_LOS_FCTR_WHO" ENABLE;
