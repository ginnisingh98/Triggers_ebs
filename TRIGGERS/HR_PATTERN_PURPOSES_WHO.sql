--------------------------------------------------------
--  DDL for Trigger HR_PATTERN_PURPOSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PATTERN_PURPOSES_WHO" 
before insert or update on "HR"."HR_PATTERN_PURPOSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PATTERN_PURPOSES_WHO" ENABLE;
