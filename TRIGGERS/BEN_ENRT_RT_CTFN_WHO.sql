--------------------------------------------------------
--  DDL for Trigger BEN_ENRT_RT_CTFN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ENRT_RT_CTFN_WHO" 
before insert or update on "BEN"."BEN_ENRT_RT_CTFN"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ENRT_RT_CTFN_WHO" ENABLE;
