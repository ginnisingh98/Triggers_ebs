--------------------------------------------------------
--  DDL for Trigger GHR_BREAKDOWN_RESULTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_BREAKDOWN_RESULTS_WHO" 
before insert or update on "HR"."GHR_BREAKDOWN_RESULTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_BREAKDOWN_RESULTS_WHO" ENABLE;
