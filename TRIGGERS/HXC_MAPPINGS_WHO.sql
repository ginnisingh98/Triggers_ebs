--------------------------------------------------------
--  DDL for Trigger HXC_MAPPINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_MAPPINGS_WHO" 
before insert or update on "HXC"."HXC_MAPPINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_MAPPINGS_WHO" ENABLE;
