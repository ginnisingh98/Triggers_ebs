--------------------------------------------------------
--  DDL for Trigger IRC_ASSIGNMENT_STATUSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_ASSIGNMENT_STATUSES_WHO" 
before insert or update on "HR"."IRC_ASSIGNMENT_STATUSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_ASSIGNMENT_STATUSES_WHO" ENABLE;
