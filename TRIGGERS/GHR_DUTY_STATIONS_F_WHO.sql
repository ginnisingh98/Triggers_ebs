--------------------------------------------------------
--  DDL for Trigger GHR_DUTY_STATIONS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_DUTY_STATIONS_F_WHO" 
before insert or update on "HR"."GHR_DUTY_STATIONS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_DUTY_STATIONS_F_WHO" ENABLE;
