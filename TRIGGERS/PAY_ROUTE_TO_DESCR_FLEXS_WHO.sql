--------------------------------------------------------
--  DDL for Trigger PAY_ROUTE_TO_DESCR_FLEXS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ROUTE_TO_DESCR_FLEXS_WHO" 
before insert or update on "HR"."PAY_ROUTE_TO_DESCR_FLEXS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ROUTE_TO_DESCR_FLEXS_WHO" ENABLE;
