--------------------------------------------------------
--  DDL for Trigger FEM_USER_LOV23_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_LOV23_UL" 
instead of update on FEM_USER_LOV23_VL
...
/
ALTER TRIGGER "APPS"."FEM_USER_LOV23_UL" ENABLE;
