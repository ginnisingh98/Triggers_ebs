--------------------------------------------------------
--  DDL for Trigger PER_SECONDARY_ASS_STATUSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SECONDARY_ASS_STATUSES_WHO" 
before insert or update on "HR"."PER_SECONDARY_ASS_STATUSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SECONDARY_ASS_STATUSES_WHO" ENABLE;
