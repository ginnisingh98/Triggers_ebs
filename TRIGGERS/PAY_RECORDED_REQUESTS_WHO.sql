--------------------------------------------------------
--  DDL for Trigger PAY_RECORDED_REQUESTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_RECORDED_REQUESTS_WHO" 
before insert or update on "HR"."PAY_RECORDED_REQUESTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_RECORDED_REQUESTS_WHO" ENABLE;
