--------------------------------------------------------
--  DDL for Trigger BEN_DM_PHASES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DM_PHASES_WHO" 
before insert or update on "BEN"."BEN_DM_PHASES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DM_PHASES_WHO" ENABLE;
