--------------------------------------------------------
--  DDL for Trigger HXC_ENTITY_GROUP_COMPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_ENTITY_GROUP_COMPS_WHO" 
before insert or update on "HXC"."HXC_ENTITY_GROUP_COMPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_ENTITY_GROUP_COMPS_WHO" ENABLE;
