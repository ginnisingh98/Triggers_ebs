--------------------------------------------------------
--  DDL for Trigger BEN_EXT_RSLT_DTL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_RSLT_DTL_WHO" 
before insert or update on "BEN"."BEN_EXT_RSLT_DTL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_RSLT_DTL_WHO" ENABLE;
