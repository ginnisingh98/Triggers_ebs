--------------------------------------------------------
--  DDL for Trigger PER_APPRAISAL_TEMPLATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_APPRAISAL_TEMPLATES_WHO" 
before insert or update on "HR"."PER_APPRAISAL_TEMPLATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_APPRAISAL_TEMPLATES_WHO" ENABLE;
