--------------------------------------------------------
--  DDL for Trigger OTA_TRAINING_PLAN_COSTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_TRAINING_PLAN_COSTS_WHO" 
before insert or update on "OTA"."OTA_TRAINING_PLAN_COSTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_TRAINING_PLAN_COSTS_WHO" ENABLE;
