--------------------------------------------------------
--  DDL for Trigger PSP_ORGANIZATION_ACCOUNTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ORGANIZATION_ACCOUNTS_WHO" 
before insert or update on "PSP"."PSP_ORGANIZATION_ACCOUNTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ORGANIZATION_ACCOUNTS_WHO" ENABLE;
