--------------------------------------------------------
--  DDL for Trigger PER_PERIODS_OF_PLACEMENT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERIODS_OF_PLACEMENT_WHO" 
before insert or update on "HR"."PER_PERIODS_OF_PLACEMENT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERIODS_OF_PLACEMENT_WHO" ENABLE;
