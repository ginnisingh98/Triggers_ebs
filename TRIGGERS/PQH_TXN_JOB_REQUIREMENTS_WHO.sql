--------------------------------------------------------
--  DDL for Trigger PQH_TXN_JOB_REQUIREMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_TXN_JOB_REQUIREMENTS_WHO" 
before insert or update on "HR"."PQH_TXN_JOB_REQUIREMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_TXN_JOB_REQUIREMENTS_WHO" ENABLE;
