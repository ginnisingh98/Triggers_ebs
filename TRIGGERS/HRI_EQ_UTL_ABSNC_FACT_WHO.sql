--------------------------------------------------------
--  DDL for Trigger HRI_EQ_UTL_ABSNC_FACT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_UTL_ABSNC_FACT_WHO" 
before insert or update on "HRI"."HRI_EQ_UTL_ABSNC_FACT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_UTL_ABSNC_FACT_WHO" ENABLE;
