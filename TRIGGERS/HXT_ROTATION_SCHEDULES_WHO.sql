--------------------------------------------------------
--  DDL for Trigger HXT_ROTATION_SCHEDULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_ROTATION_SCHEDULES_WHO" 
before insert or update on "HXT"."HXT_ROTATION_SCHEDULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_ROTATION_SCHEDULES_WHO" ENABLE;
