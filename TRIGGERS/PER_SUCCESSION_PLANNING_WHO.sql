--------------------------------------------------------
--  DDL for Trigger PER_SUCCESSION_PLANNING_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SUCCESSION_PLANNING_WHO" 
before insert or update on "HR"."PER_SUCCESSION_PLANNING"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SUCCESSION_PLANNING_WHO" ENABLE;
