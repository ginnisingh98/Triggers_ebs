--------------------------------------------------------
--  DDL for Trigger PER_EMPDIR_LOCATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_EMPDIR_LOCATIONS_WHO" 
before insert or update on "HR"."PER_EMPDIR_LOCATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_EMPDIR_LOCATIONS_WHO" ENABLE;
