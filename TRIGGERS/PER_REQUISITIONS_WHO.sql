--------------------------------------------------------
--  DDL for Trigger PER_REQUISITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_REQUISITIONS_WHO" 
before insert or update on "HR"."PER_REQUISITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_REQUISITIONS_WHO" ENABLE;
