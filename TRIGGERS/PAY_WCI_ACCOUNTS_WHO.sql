--------------------------------------------------------
--  DDL for Trigger PAY_WCI_ACCOUNTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_WCI_ACCOUNTS_WHO" 
before insert or update on "HR"."PAY_WCI_ACCOUNTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_WCI_ACCOUNTS_WHO" ENABLE;
