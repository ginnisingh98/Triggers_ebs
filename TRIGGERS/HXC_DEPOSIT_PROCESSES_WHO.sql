--------------------------------------------------------
--  DDL for Trigger HXC_DEPOSIT_PROCESSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_DEPOSIT_PROCESSES_WHO" 
before insert or update on "HXC"."HXC_DEPOSIT_PROCESSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_DEPOSIT_PROCESSES_WHO" ENABLE;
