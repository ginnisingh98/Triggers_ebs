--------------------------------------------------------
--  DDL for Trigger PER_PREVIOUS_EMPLOYERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PREVIOUS_EMPLOYERS_WHO" 
before insert or update on "HR"."PER_PREVIOUS_EMPLOYERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PREVIOUS_EMPLOYERS_WHO" ENABLE;
