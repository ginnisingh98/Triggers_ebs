--------------------------------------------------------
--  DDL for Trigger PER_ALLOCATED_CHECKLISTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ALLOCATED_CHECKLISTS_WHO" 
before insert or update on "HR"."PER_ALLOCATED_CHECKLISTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ALLOCATED_CHECKLISTS_WHO" ENABLE;
