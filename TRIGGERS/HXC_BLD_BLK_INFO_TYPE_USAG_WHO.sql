--------------------------------------------------------
--  DDL for Trigger HXC_BLD_BLK_INFO_TYPE_USAG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_BLD_BLK_INFO_TYPE_USAG_WHO" 
before insert or update on "HXC"."HXC_BLD_BLK_INFO_TYPE_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_BLD_BLK_INFO_TYPE_USAG_WHO" ENABLE;
