--------------------------------------------------------
--  DDL for Trigger PER_CAGR_ENTITLEMENT_RESUL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_ENTITLEMENT_RESUL_WHO" 
before insert or update on "HR"."PER_CAGR_ENTITLEMENT_RESULTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_ENTITLEMENT_RESUL_WHO" ENABLE;
