--------------------------------------------------------
--  DDL for Trigger GMA_FC_TEXT_TBL_T2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GMA_FC_TEXT_TBL_T2" 
instead of update on FC_TEXT_TBL_VL
referencing old as FC_TEXT_TBL
for each row
begin
  GMA_FC_TEXT_TBL_PKG.UPDATE_ROW(
...
/
ALTER TRIGGER "APPS"."GMA_FC_TEXT_TBL_T2" ENABLE;
