--------------------------------------------------------
--  DDL for Trigger PQH_RANK_PROCESS_APPROVALS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_RANK_PROCESS_APPROVALS_WHO" 
before insert or update on "HR"."PQH_RANK_PROCESS_APPROVALS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_RANK_PROCESS_APPROVALS_WHO" ENABLE;
