--------------------------------------------------------
--  DDL for Trigger OTA_PRICE_LISTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_PRICE_LISTS_WHO" 
before insert or update on "OTA"."OTA_PRICE_LISTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_PRICE_LISTS_WHO" ENABLE;
