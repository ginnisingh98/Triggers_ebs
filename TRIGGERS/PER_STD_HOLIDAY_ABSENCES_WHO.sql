--------------------------------------------------------
--  DDL for Trigger PER_STD_HOLIDAY_ABSENCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_STD_HOLIDAY_ABSENCES_WHO" 
before insert or update on "HR"."PER_STD_HOLIDAY_ABSENCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_STD_HOLIDAY_ABSENCES_WHO" ENABLE;
