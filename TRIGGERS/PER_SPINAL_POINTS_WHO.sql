--------------------------------------------------------
--  DDL for Trigger PER_SPINAL_POINTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SPINAL_POINTS_WHO" 
before insert or update on "HR"."PER_SPINAL_POINTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SPINAL_POINTS_WHO" ENABLE;
