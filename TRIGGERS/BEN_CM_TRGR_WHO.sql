--------------------------------------------------------
--  DDL for Trigger BEN_CM_TRGR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CM_TRGR_WHO" 
before insert or update on "BEN"."BEN_CM_TRGR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CM_TRGR_WHO" ENABLE;
