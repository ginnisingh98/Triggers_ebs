--------------------------------------------------------
--  DDL for Trigger HR_SOURCE_FORM_TEMPLATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_SOURCE_FORM_TEMPLATES_WHO" 
before insert or update on "HR"."HR_SOURCE_FORM_TEMPLATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_SOURCE_FORM_TEMPLATES_WHO" ENABLE;
