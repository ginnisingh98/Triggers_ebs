--------------------------------------------------------
--  DDL for Trigger BEN_ICD_TRANSACTION_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ICD_TRANSACTION_WHO" 
before insert or update on "BEN"."BEN_ICD_TRANSACTION"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ICD_TRANSACTION_WHO" ENABLE;
