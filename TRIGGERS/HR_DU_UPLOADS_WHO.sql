--------------------------------------------------------
--  DDL for Trigger HR_DU_UPLOADS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DU_UPLOADS_WHO" 
before insert or update on "HR"."HR_DU_UPLOADS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DU_UPLOADS_WHO" ENABLE;
