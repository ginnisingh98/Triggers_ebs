--------------------------------------------------------
--  DDL for Trigger BEN_EXTRA_INPUT_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXTRA_INPUT_VALUES_WHO" 
before insert or update on "BEN"."BEN_EXTRA_INPUT_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXTRA_INPUT_VALUES_WHO" ENABLE;
