--------------------------------------------------------
--  DDL for Trigger PER_JOBS_TL052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_JOBS_TL052617_WHO" 
before insert or update on "HR"."PER_JOBS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_JOBS_TL052617_WHO" ENABLE;
