--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_PER_ELCTBL_CHC_RB_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_PER_ELCTBL_CHC_RB_WHO" 
before insert or update on "BEN"."BEN_ELIG_PER_ELCTBL_CHC_RBV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_PER_ELCTBL_CHC_RB_WHO" ENABLE;
