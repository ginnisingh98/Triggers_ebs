--------------------------------------------------------
--  DDL for Trigger OTA_BKNG_JUSTIFICATIONS_B_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_BKNG_JUSTIFICATIONS_B_WHO" 
before insert or update on "OTA"."OTA_BKNG_JUSTIFICATIONS_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_BKNG_JUSTIFICATIONS_B_WHO" ENABLE;
