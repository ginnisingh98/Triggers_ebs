--------------------------------------------------------
--  DDL for Trigger OTA_ANNOUNCEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_ANNOUNCEMENTS_WHO" 
before insert or update on "OTA"."OTA_ANNOUNCEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_ANNOUNCEMENTS_WHO" ENABLE;
