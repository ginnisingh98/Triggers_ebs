--------------------------------------------------------
--  DDL for Trigger PER_POSITION_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_POSITION_DEFINITIONS_WHO" 
before insert or update on "HR"."PER_POSITION_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_POSITION_DEFINITIONS_WHO" ENABLE;
