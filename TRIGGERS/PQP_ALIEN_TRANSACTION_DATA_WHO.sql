--------------------------------------------------------
--  DDL for Trigger PQP_ALIEN_TRANSACTION_DATA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_ALIEN_TRANSACTION_DATA_WHO" 
before insert or update on "HR"."PQP_ALIEN_TRANSACTION_DATA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_ALIEN_TRANSACTION_DATA_WHO" ENABLE;
