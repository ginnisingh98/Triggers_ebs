--------------------------------------------------------
--  DDL for Trigger HR_ASSIGNMENT_SET_AMENDMEN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ASSIGNMENT_SET_AMENDMEN_WHO" 
before insert or update on "HR"."HR_ASSIGNMENT_SET_AMENDMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ASSIGNMENT_SET_AMENDMEN_WHO" ENABLE;
