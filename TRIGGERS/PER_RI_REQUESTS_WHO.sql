--------------------------------------------------------
--  DDL for Trigger PER_RI_REQUESTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_REQUESTS_WHO" 
before insert or update on "HR"."PER_RI_REQUESTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_REQUESTS_WHO" ENABLE;
