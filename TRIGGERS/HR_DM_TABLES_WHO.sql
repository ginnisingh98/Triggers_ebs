--------------------------------------------------------
--  DDL for Trigger HR_DM_TABLES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_TABLES_WHO" 
before insert or update on "HR"."HR_DM_TABLES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_TABLES_WHO" ENABLE;
