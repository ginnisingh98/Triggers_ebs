--------------------------------------------------------
--  DDL for Trigger HR_DM_SEQUENCE_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_SEQUENCE_DEFINITIONS_WHO" 
before insert or update on "HR"."HR_DM_SEQUENCE_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_SEQUENCE_DEFINITIONS_WHO" ENABLE;
