--------------------------------------------------------
--  DDL for Trigger PQH_ROLES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ROLES_WHO" 
before insert or update on "HR"."PQH_ROLES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ROLES_WHO" ENABLE;
