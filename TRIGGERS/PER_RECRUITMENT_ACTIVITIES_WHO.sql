--------------------------------------------------------
--  DDL for Trigger PER_RECRUITMENT_ACTIVITIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RECRUITMENT_ACTIVITIES_WHO" 
before insert or update on "HR"."PER_RECRUITMENT_ACTIVITIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RECRUITMENT_ACTIVITIES_WHO" ENABLE;
