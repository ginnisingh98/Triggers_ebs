--------------------------------------------------------
--  DDL for Trigger BEN_PRTT_RT_VAL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTT_RT_VAL_WHO" 
before insert or update on "BEN"."BEN_PRTT_RT_VAL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTT_RT_VAL_WHO" ENABLE;
