--------------------------------------------------------
--  DDL for Trigger HR_TAB_PAGE_PROPERTIES_B_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_TAB_PAGE_PROPERTIES_B_WHO" 
before insert or update on "HR"."HR_TAB_PAGE_PROPERTIES_B"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_TAB_PAGE_PROPERTIES_B_WHO" ENABLE;
