--------------------------------------------------------
--  DDL for Trigger PQH_CRITERIA_RATE_DEFN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_CRITERIA_RATE_DEFN_WHO" 
before insert or update on "HR"."PQH_CRITERIA_RATE_DEFN"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_CRITERIA_RATE_DEFN_WHO" ENABLE;
