--------------------------------------------------------
--  DDL for Trigger PSP_EFF_REPORT_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_EFF_REPORT_DETAILS_WHO" 
before insert or update on "PSP"."PSP_EFF_REPORT_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_EFF_REPORT_DETAILS_WHO" ENABLE;
