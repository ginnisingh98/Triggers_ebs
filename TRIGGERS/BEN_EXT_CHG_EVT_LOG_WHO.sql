--------------------------------------------------------
--  DDL for Trigger BEN_EXT_CHG_EVT_LOG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_CHG_EVT_LOG_WHO" 
before insert or update on "BEN"."BEN_EXT_CHG_EVT_LOG"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_CHG_EVT_LOG_WHO" ENABLE;
