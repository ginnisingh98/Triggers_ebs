--------------------------------------------------------
--  DDL for Trigger HR_ITEM_PROPERTIES_T052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ITEM_PROPERTIES_T052615_WHO" 
before insert or update on "HR"."HR_ITEM_PROPERTIES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ITEM_PROPERTIES_T052615_WHO" ENABLE;
