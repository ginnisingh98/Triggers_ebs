--------------------------------------------------------
--  DDL for Trigger HR_TRANSACTION_SNAPSHOT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_TRANSACTION_SNAPSHOT_WHO" 
before insert or update on "HR"."HR_TRANSACTION_SNAPSHOT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_TRANSACTION_SNAPSHOT_WHO" ENABLE;
