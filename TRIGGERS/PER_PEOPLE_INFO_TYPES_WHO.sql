--------------------------------------------------------
--  DDL for Trigger PER_PEOPLE_INFO_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PEOPLE_INFO_TYPES_WHO" 
before insert or update on "HR"."PER_PEOPLE_INFO_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PEOPLE_INFO_TYPES_WHO" ENABLE;
