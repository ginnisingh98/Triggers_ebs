--------------------------------------------------------
--  DDL for Trigger HXC_ALIAS_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_ALIAS_TYPES_WHO" 
before insert or update on "HXC"."HXC_ALIAS_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_ALIAS_TYPES_WHO" ENABLE;
