--------------------------------------------------------
--  DDL for Trigger PAY_ORG_PAYMENT_METHODS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ORG_PAYMENT_METHODS_F_WHO" 
...
/
ALTER TRIGGER "APPS"."PAY_ORG_PAYMENT_METHODS_F_WHO" ENABLE;
