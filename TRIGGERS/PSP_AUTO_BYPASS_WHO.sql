--------------------------------------------------------
--  DDL for Trigger PSP_AUTO_BYPASS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_AUTO_BYPASS_WHO" 
before insert or update on "PSP"."PSP_AUTO_BYPASS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_AUTO_BYPASS_WHO" ENABLE;
