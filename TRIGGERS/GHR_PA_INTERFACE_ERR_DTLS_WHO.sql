--------------------------------------------------------
--  DDL for Trigger GHR_PA_INTERFACE_ERR_DTLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PA_INTERFACE_ERR_DTLS_WHO" 
before insert or update on "HR"."GHR_PA_INTERFACE_ERR_DTLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PA_INTERFACE_ERR_DTLS_WHO" ENABLE;
