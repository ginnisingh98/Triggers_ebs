--------------------------------------------------------
--  DDL for Trigger PAY_JP_BANK_BRANCHES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_JP_BANK_BRANCHES_WHO" 
before insert or update on "HR"."PAY_JP_BANK_BRANCHES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_JP_BANK_BRANCHES_WHO" ENABLE;
