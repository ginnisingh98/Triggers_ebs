--------------------------------------------------------
--  DDL for Trigger OTA_RESPONSE_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_RESPONSE_TYPES_WHO" 
before insert or update on "OTA"."OTA_RESPONSE_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_RESPONSE_TYPES_WHO" ENABLE;
