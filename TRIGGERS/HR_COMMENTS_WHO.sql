--------------------------------------------------------
--  DDL for Trigger HR_COMMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_COMMENTS_WHO" 
before insert or update on "HR"."HR_COMMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_COMMENTS_WHO" ENABLE;
