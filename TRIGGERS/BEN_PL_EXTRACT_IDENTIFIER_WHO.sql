--------------------------------------------------------
--  DDL for Trigger BEN_PL_EXTRACT_IDENTIFIER_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PL_EXTRACT_IDENTIFIER_WHO" 
before insert or update on "BEN"."BEN_PL_EXTRACT_IDENTIFIER_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PL_EXTRACT_IDENTIFIER_WHO" ENABLE;
