--------------------------------------------------------
--  DDL for Trigger OTA_ACT_CAT_INCLUSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_ACT_CAT_INCLUSIONS_WHO" 
before insert or update on "OTA"."OTA_ACT_CAT_INCLUSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_ACT_CAT_INCLUSIONS_WHO" ENABLE;
