--------------------------------------------------------
--  DDL for Trigger IRC_ASSIGNMENT_DETAILS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_ASSIGNMENT_DETAILS_F_WHO" 
before insert or update on "HR"."IRC_ASSIGNMENT_DETAILS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_ASSIGNMENT_DETAILS_F_WHO" ENABLE;
