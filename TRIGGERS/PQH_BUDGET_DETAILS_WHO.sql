--------------------------------------------------------
--  DDL for Trigger PQH_BUDGET_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BUDGET_DETAILS_WHO" 
before insert or update on "HR"."PQH_BUDGET_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BUDGET_DETAILS_WHO" ENABLE;
