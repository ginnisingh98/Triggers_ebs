--------------------------------------------------------
--  DDL for Trigger GHR_PA_INCENTIVES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PA_INCENTIVES_WHO" 
before insert or update on "HR"."GHR_PA_INCENTIVES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PA_INCENTIVES_WHO" ENABLE;
