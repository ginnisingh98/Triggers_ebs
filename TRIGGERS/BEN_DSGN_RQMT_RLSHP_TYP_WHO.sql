--------------------------------------------------------
--  DDL for Trigger BEN_DSGN_RQMT_RLSHP_TYP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DSGN_RQMT_RLSHP_TYP_WHO" 
before insert or update on "BEN"."BEN_DSGN_RQMT_RLSHP_TYP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DSGN_RQMT_RLSHP_TYP_WHO" ENABLE;
