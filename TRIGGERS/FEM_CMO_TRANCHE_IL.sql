--------------------------------------------------------
--  DDL for Trigger FEM_CMO_TRANCHE_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_CMO_TRANCHE_IL" 
instead of insert on FEM_CMO_TRANCHE_VL
...
declare
 ...
 ---
begin
  FEM_CMO_TRANCHE_PKG.INSERT_ROW(
    X_ROWID => ROW_ID,
    ...
    X_CREATION_DATE => :FEM_CMO_TRANCHE_B.CREATION_DATE,
    X_CREATED_BY => :FEM_CMO_TRANCHE_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_CMO_TRANCHE_IL" ENABLE;
