--------------------------------------------------------
--  DDL for Trigger HXC_PREF_HIERARCHIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_PREF_HIERARCHIES_WHO" 
before insert or update on "HXC"."HXC_PREF_HIERARCHIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_PREF_HIERARCHIES_WHO" ENABLE;
