--------------------------------------------------------
--  DDL for Trigger PER_PTU_DFF_MIG_FAILED_PEO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PTU_DFF_MIG_FAILED_PEO_WHO" 
before insert or update on "HR"."PER_PTU_DFF_MIG_FAILED_PEOPLE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PTU_DFF_MIG_FAILED_PEO_WHO" ENABLE;
