--------------------------------------------------------
--  DDL for Trigger HR_PUMP_DEFAULT_EXCEPTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PUMP_DEFAULT_EXCEPTIONS_WHO" 
before insert or update on "HR"."HR_PUMP_DEFAULT_EXCEPTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PUMP_DEFAULT_EXCEPTIONS_WHO" ENABLE;
