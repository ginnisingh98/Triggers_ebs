--------------------------------------------------------
--  DDL for Trigger HXC_LAYOUTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_LAYOUTS_WHO" 
before insert or update on "HXC"."HXC_LAYOUTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_LAYOUTS_WHO" ENABLE;
