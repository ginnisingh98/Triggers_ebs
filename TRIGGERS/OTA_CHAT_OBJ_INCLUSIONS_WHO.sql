--------------------------------------------------------
--  DDL for Trigger OTA_CHAT_OBJ_INCLUSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CHAT_OBJ_INCLUSIONS_WHO" 
before insert or update on "OTA"."OTA_CHAT_OBJ_INCLUSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CHAT_OBJ_INCLUSIONS_WHO" ENABLE;
