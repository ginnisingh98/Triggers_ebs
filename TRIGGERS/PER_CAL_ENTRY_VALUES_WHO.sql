--------------------------------------------------------
--  DDL for Trigger PER_CAL_ENTRY_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAL_ENTRY_VALUES_WHO" 
before insert or update on "HR"."PER_CAL_ENTRY_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAL_ENTRY_VALUES_WHO" ENABLE;
