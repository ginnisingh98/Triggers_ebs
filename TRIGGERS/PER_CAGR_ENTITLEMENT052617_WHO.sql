--------------------------------------------------------
--  DDL for Trigger PER_CAGR_ENTITLEMENT052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_ENTITLEMENT052617_WHO" 
before insert or update on "HR"."PER_CAGR_ENTITLEMENT_ITEMS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_ENTITLEMENT052617_WHO" ENABLE;
