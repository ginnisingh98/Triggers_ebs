--------------------------------------------------------
--  DDL for Trigger PSP_SALARY_CAP_OVERRIDES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_SALARY_CAP_OVERRIDES_WHO" 
before insert or update on "PSP"."PSP_SALARY_CAP_OVERRIDES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_SALARY_CAP_OVERRIDES_WHO" ENABLE;
