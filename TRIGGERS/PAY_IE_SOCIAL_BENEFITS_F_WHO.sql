--------------------------------------------------------
--  DDL for Trigger PAY_IE_SOCIAL_BENEFITS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_IE_SOCIAL_BENEFITS_F_WHO" 
before insert or update on "HR"."PAY_IE_SOCIAL_BENEFITS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_IE_SOCIAL_BENEFITS_F_WHO" ENABLE;
