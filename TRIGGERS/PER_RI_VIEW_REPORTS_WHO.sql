--------------------------------------------------------
--  DDL for Trigger PER_RI_VIEW_REPORTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_VIEW_REPORTS_WHO" 
before insert or update on "HR"."PER_RI_VIEW_REPORTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_VIEW_REPORTS_WHO" ENABLE;
