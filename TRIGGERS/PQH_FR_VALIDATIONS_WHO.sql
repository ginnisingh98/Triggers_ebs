--------------------------------------------------------
--  DDL for Trigger PQH_FR_VALIDATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_FR_VALIDATIONS_WHO" 
before insert or update on "HR"."PQH_FR_VALIDATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_FR_VALIDATIONS_WHO" ENABLE;
