--------------------------------------------------------
--  DDL for Trigger OTA_CONTENT_SERVERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CONTENT_SERVERS_WHO" 
before insert or update on "OTA"."OTA_CONTENT_SERVERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CONTENT_SERVERS_WHO" ENABLE;
