--------------------------------------------------------
--  DDL for Trigger GHR_PAYROLL_OFFICE_NUMBER_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PAYROLL_OFFICE_NUMBER_WHO" 
before insert or update on "HR"."GHR_PAYROLL_OFFICE_NUMBER"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PAYROLL_OFFICE_NUMBER_WHO" ENABLE;
