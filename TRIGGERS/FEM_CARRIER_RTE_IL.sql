--------------------------------------------------------
--  DDL for Trigger FEM_CARRIER_RTE_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_CARRIER_RTE_IL" 
instead of insert on FEM_CARRIER_RTE_VL
...
declare
 ...
 ---
begin
  FEM_CARRIER_RTE_PKG.INSERT_ROW(
    X_ROWID => ROW_ID,
    ...
    X_CREATION_DATE => :FEM_CARRIER_RTE_B.CREATION_DATE,
    X_CREATED_BY => :FEM_CARRIER_RTE_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_CARRIER_RTE_IL" ENABLE;
