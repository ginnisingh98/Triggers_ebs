--------------------------------------------------------
--  DDL for Trigger BEN_GD_OR_SVC_TYP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_GD_OR_SVC_TYP_WHO" 
before insert or update on "BEN"."BEN_GD_OR_SVC_TYP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_GD_OR_SVC_TYP_WHO" ENABLE;
