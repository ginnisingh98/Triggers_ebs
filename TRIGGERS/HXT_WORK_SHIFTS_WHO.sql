--------------------------------------------------------
--  DDL for Trigger HXT_WORK_SHIFTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_WORK_SHIFTS_WHO" 
before insert or update on "HXT"."HXT_WORK_SHIFTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_WORK_SHIFTS_WHO" ENABLE;
