--------------------------------------------------------
--  DDL for Trigger PAY_TEMPLATE_EXCLUSION_RUL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_TEMPLATE_EXCLUSION_RUL_WHO" 
before insert or update on "HR"."PAY_TEMPLATE_EXCLUSION_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_TEMPLATE_EXCLUSION_RUL_WHO" ENABLE;
