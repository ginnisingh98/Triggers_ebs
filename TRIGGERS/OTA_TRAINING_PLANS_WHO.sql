--------------------------------------------------------
--  DDL for Trigger OTA_TRAINING_PLANS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_TRAINING_PLANS_WHO" 
before insert or update on "OTA"."OTA_TRAINING_PLANS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_TRAINING_PLANS_WHO" ENABLE;
