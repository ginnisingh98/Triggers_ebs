--------------------------------------------------------
--  DDL for Trigger PSP_EXTERNAL_EFFORT_LINES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_EXTERNAL_EFFORT_LINES_WHO" 
before insert or update on "PSP"."PSP_EXTERNAL_EFFORT_LINES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_EXTERNAL_EFFORT_LINES_WHO" ENABLE;
