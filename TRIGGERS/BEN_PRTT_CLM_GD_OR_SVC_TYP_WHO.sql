--------------------------------------------------------
--  DDL for Trigger BEN_PRTT_CLM_GD_OR_SVC_TYP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTT_CLM_GD_OR_SVC_TYP_WHO" 
before insert or update on "BEN"."BEN_PRTT_CLM_GD_OR_SVC_TYP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTT_CLM_GD_OR_SVC_TYP_WHO" ENABLE;
