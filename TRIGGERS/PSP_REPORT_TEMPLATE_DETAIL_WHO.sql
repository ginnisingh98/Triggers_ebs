--------------------------------------------------------
--  DDL for Trigger PSP_REPORT_TEMPLATE_DETAIL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_REPORT_TEMPLATE_DETAIL_WHO" 
before insert or update on "PSP"."PSP_REPORT_TEMPLATE_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_REPORT_TEMPLATE_DETAIL_WHO" ENABLE;
