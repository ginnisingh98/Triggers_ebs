--------------------------------------------------------
--  DDL for Trigger GHR_GROUPBOXES_AI_STM
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_GROUPBOXES_AI_STM" 
...
begin
  ...
  for i in 1..ghr_api.ghr_gbx_index loop
   ...
   wf_event.AddParameterToList('ExpirationDate',null,l_parms);
...
end GHR_GROUPBOXES_AI_STM;


/
ALTER TRIGGER "APPS"."GHR_GROUPBOXES_AI_STM" ENABLE;
