--------------------------------------------------------
--  DDL for Trigger BEN_EXT_INCL_CHG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_INCL_CHG_WHO" 
before insert or update on "BEN"."BEN_EXT_INCL_CHG"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_INCL_CHG_WHO" ENABLE;
