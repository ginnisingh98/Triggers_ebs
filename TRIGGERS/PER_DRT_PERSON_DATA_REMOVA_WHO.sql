--------------------------------------------------------
--  DDL for Trigger PER_DRT_PERSON_DATA_REMOVA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_DRT_PERSON_DATA_REMOVA_WHO" 
before insert or update on "HR"."PER_DRT_PERSON_DATA_REMOVALS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_DRT_PERSON_DATA_REMOVA_WHO" ENABLE;
