--------------------------------------------------------
--  DDL for Trigger HXC_LOCKER_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_LOCKER_TYPES_WHO" 
before insert or update on "HXC"."HXC_LOCKER_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_LOCKER_TYPES_WHO" ENABLE;
