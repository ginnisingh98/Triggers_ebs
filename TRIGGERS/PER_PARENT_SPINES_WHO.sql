--------------------------------------------------------
--  DDL for Trigger PER_PARENT_SPINES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PARENT_SPINES_WHO" 
before insert or update on "HR"."PER_PARENT_SPINES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PARENT_SPINES_WHO" ENABLE;
