--------------------------------------------------------
--  DDL for Trigger PER_ZA_TRAINING_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ZA_TRAINING_WHO" 
before insert or update on "HR"."PER_ZA_TRAINING"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ZA_TRAINING_WHO" ENABLE;
