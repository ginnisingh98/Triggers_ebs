--------------------------------------------------------
--  DDL for Trigger PER_ZA_FORMAL_QUALIFICATIO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ZA_FORMAL_QUALIFICATIO_WHO" 
before insert or update on "HR"."PER_ZA_FORMAL_QUALIFICATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ZA_FORMAL_QUALIFICATIO_WHO" ENABLE;
