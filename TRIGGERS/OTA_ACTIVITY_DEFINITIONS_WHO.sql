--------------------------------------------------------
--  DDL for Trigger OTA_ACTIVITY_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_ACTIVITY_DEFINITIONS_WHO" 
before insert or update on "OTA"."OTA_ACTIVITY_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_ACTIVITY_DEFINITIONS_WHO" ENABLE;
