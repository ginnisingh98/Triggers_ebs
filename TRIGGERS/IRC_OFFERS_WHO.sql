--------------------------------------------------------
--  DDL for Trigger IRC_OFFERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_OFFERS_WHO" 
before insert or update on "HR"."IRC_OFFERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_OFFERS_WHO" ENABLE;
