--------------------------------------------------------
--  DDL for Trigger PQH_ROUTING_HIST_ATTRIBS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ROUTING_HIST_ATTRIBS_WHO" 
before insert or update on "HR"."PQH_ROUTING_HIST_ATTRIBS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ROUTING_HIST_ATTRIBS_WHO" ENABLE;
