--------------------------------------------------------
--  DDL for Trigger GHR_MASS_SALARY_CRITERIA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_MASS_SALARY_CRITERIA_WHO" 
before insert or update on "HR"."GHR_MASS_SALARY_CRITERIA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_MASS_SALARY_CRITERIA_WHO" ENABLE;
