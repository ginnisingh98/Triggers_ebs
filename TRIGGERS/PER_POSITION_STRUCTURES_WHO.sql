--------------------------------------------------------
--  DDL for Trigger PER_POSITION_STRUCTURES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_POSITION_STRUCTURES_WHO" 
before insert or update on "HR"."PER_POSITION_STRUCTURES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_POSITION_STRUCTURES_WHO" ENABLE;
