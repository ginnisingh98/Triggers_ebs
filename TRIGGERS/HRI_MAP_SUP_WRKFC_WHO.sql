--------------------------------------------------------
--  DDL for Trigger HRI_MAP_SUP_WRKFC_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_MAP_SUP_WRKFC_WHO" 
before insert or update on "HRI"."HRI_MAP_SUP_WRKFC"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_MAP_SUP_WRKFC_WHO" ENABLE;
