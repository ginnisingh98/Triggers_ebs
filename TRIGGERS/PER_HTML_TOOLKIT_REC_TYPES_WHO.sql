--------------------------------------------------------
--  DDL for Trigger PER_HTML_TOOLKIT_REC_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_HTML_TOOLKIT_REC_TYPES_WHO" 
before insert or update on "HR"."PER_HTML_TOOLKIT_REC_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_HTML_TOOLKIT_REC_TYPES_WHO" ENABLE;
