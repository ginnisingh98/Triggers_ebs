--------------------------------------------------------
--  DDL for Trigger PQH_TRANSACTION_TEMPLATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_TRANSACTION_TEMPLATES_WHO" 
before insert or update on "HR"."PQH_TRANSACTION_TEMPLATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_TRANSACTION_TEMPLATES_WHO" ENABLE;
