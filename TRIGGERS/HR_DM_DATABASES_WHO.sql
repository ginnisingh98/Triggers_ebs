--------------------------------------------------------
--  DDL for Trigger HR_DM_DATABASES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_DATABASES_WHO" 
before insert or update on "HR"."HR_DM_DATABASES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_DATABASES_WHO" ENABLE;
