--------------------------------------------------------
--  DDL for Trigger PAY_BAL_ATTRIBUTE_DEFAULTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_BAL_ATTRIBUTE_DEFAULTS_WHO" 
before insert or update on "HR"."PAY_BAL_ATTRIBUTE_DEFAULTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_BAL_ATTRIBUTE_DEFAULTS_WHO" ENABLE;
