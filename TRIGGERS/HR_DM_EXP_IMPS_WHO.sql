--------------------------------------------------------
--  DDL for Trigger HR_DM_EXP_IMPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_EXP_IMPS_WHO" 
before insert or update on "HR"."HR_DM_EXP_IMPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_EXP_IMPS_WHO" ENABLE;
