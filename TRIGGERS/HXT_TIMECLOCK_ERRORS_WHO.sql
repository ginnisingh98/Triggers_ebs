--------------------------------------------------------
--  DDL for Trigger HXT_TIMECLOCK_ERRORS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_TIMECLOCK_ERRORS_WHO" 
before insert or update on "HXT"."HXT_TIMECLOCK_ERRORS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_TIMECLOCK_ERRORS_WHO" ENABLE;
