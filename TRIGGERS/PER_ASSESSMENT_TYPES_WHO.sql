--------------------------------------------------------
--  DDL for Trigger PER_ASSESSMENT_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASSESSMENT_TYPES_WHO" 
before insert or update on "HR"."PER_ASSESSMENT_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ASSESSMENT_TYPES_WHO" ENABLE;
