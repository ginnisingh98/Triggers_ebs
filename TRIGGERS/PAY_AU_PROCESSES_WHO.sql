--------------------------------------------------------
--  DDL for Trigger PAY_AU_PROCESSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_AU_PROCESSES_WHO" 
before insert or update on "HR"."PAY_AU_PROCESSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_AU_PROCESSES_WHO" ENABLE;
