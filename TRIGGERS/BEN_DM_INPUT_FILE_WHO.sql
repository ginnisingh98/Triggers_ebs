--------------------------------------------------------
--  DDL for Trigger BEN_DM_INPUT_FILE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DM_INPUT_FILE_WHO" 
before insert or update on "BEN"."BEN_DM_INPUT_FILE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DM_INPUT_FILE_WHO" ENABLE;
