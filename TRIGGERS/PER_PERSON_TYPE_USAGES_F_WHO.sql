--------------------------------------------------------
--  DDL for Trigger PER_PERSON_TYPE_USAGES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERSON_TYPE_USAGES_F_WHO" 
before insert or update on "HR"."PER_PERSON_TYPE_USAGES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERSON_TYPE_USAGES_F_WHO" ENABLE;
