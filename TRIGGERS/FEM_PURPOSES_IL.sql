--------------------------------------------------------
--  DDL for Trigger FEM_PURPOSES_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_PURPOSES_IL" 
instead of insert on FEM_PURPOSES_VL
...
begin
  FEM_PURPOSES_PKG.INSERT_ROW(
    ...
    X_CREATION_DATE => :FEM_PURPOSES_B.CREATION_DATE,
    X_CREATED_BY => :FEM_PURPOSES_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_PURPOSES_IL" ENABLE;
