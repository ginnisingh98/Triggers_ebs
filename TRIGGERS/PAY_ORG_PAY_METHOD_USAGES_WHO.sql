--------------------------------------------------------
--  DDL for Trigger PAY_ORG_PAY_METHOD_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ORG_PAY_METHOD_USAGES_WHO" 
before insert or update on "HR"."PAY_ORG_PAY_METHOD_USAGES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ORG_PAY_METHOD_USAGES_WHO" ENABLE;
