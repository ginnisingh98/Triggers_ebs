--------------------------------------------------------
--  DDL for Trigger PER_PERFORMANCE_RATINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERFORMANCE_RATINGS_WHO" 
before insert or update on "HR"."PER_PERFORMANCE_RATINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERFORMANCE_RATINGS_WHO" ENABLE;
