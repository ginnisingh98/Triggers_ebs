--------------------------------------------------------
--  DDL for Trigger PQH_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_RULES_WHO" 
before insert or update on "HR"."PQH_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_RULES_WHO" ENABLE;
