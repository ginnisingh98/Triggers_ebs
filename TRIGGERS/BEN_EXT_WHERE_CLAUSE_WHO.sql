--------------------------------------------------------
--  DDL for Trigger BEN_EXT_WHERE_CLAUSE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_WHERE_CLAUSE_WHO" 
before insert or update on "BEN"."BEN_EXT_WHERE_CLAUSE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_WHERE_CLAUSE_WHO" ENABLE;
