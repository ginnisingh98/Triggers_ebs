--------------------------------------------------------
--  DDL for Trigger BEN_ENRT_RT_RBV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ENRT_RT_RBV_WHO" 
before insert or update on "BEN"."BEN_ENRT_RT_RBV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ENRT_RT_RBV_WHO" ENABLE;
