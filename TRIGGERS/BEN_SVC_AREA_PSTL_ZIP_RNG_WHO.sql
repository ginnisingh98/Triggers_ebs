--------------------------------------------------------
--  DDL for Trigger BEN_SVC_AREA_PSTL_ZIP_RNG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_SVC_AREA_PSTL_ZIP_RNG_WHO" 
before insert or update on "BEN"."BEN_SVC_AREA_PSTL_ZIP_RNG_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_SVC_AREA_PSTL_ZIP_RNG_WHO" ENABLE;
