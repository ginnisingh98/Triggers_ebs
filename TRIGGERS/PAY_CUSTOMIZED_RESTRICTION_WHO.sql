--------------------------------------------------------
--  DDL for Trigger PAY_CUSTOMIZED_RESTRICTION_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_CUSTOMIZED_RESTRICTION_WHO" 
before insert or update on "HR"."PAY_CUSTOMIZED_RESTRICTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_CUSTOMIZED_RESTRICTION_WHO" ENABLE;
