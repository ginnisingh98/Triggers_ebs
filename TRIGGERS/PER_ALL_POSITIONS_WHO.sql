--------------------------------------------------------
--  DDL for Trigger PER_ALL_POSITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ALL_POSITIONS_WHO" 
before insert or update on "HR"."PER_ALL_POSITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ALL_POSITIONS_WHO" ENABLE;
