--------------------------------------------------------
--  DDL for Trigger OTA_PERFORMANCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_PERFORMANCES_WHO" 
before insert or update on "OTA"."OTA_PERFORMANCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_PERFORMANCES_WHO" ENABLE;
