--------------------------------------------------------
--  DDL for Trigger PSP_ADJUSTMENT_CONTROL_TAB_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ADJUSTMENT_CONTROL_TAB_WHO" 
before insert or update on "PSP"."PSP_ADJUSTMENT_CONTROL_TABLE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ADJUSTMENT_CONTROL_TAB_WHO" ENABLE;
