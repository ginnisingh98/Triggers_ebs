--------------------------------------------------------
--  DDL for Trigger PER_ZA_LEARNERSHIP_AGREEME_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ZA_LEARNERSHIP_AGREEME_WHO" 
before insert or update on "HR"."PER_ZA_LEARNERSHIP_AGREEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ZA_LEARNERSHIP_AGREEME_WHO" ENABLE;
