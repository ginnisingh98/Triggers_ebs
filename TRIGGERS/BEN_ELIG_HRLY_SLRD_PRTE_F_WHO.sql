--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_HRLY_SLRD_PRTE_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_HRLY_SLRD_PRTE_F_WHO" 
before insert or update on "BEN"."BEN_ELIG_HRLY_SLRD_PRTE_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_HRLY_SLRD_PRTE_F_WHO" ENABLE;
