--------------------------------------------------------
--  DDL for Trigger HR_EFC_PROCESS_COMPONENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_EFC_PROCESS_COMPONENTS_WHO" 
before insert or update on "HR"."HR_EFC_PROCESS_COMPONENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_EFC_PROCESS_COMPONENTS_WHO" ENABLE;
