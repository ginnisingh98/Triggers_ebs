--------------------------------------------------------
--  DDL for Trigger HXC_PREF_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_PREF_DEFINITIONS_WHO" 
before insert or update on "HXC"."HXC_PREF_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_PREF_DEFINITIONS_WHO" ENABLE;
