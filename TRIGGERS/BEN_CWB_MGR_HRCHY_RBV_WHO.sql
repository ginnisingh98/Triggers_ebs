--------------------------------------------------------
--  DDL for Trigger BEN_CWB_MGR_HRCHY_RBV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_MGR_HRCHY_RBV_WHO" 
before insert or update on "BEN"."BEN_CWB_MGR_HRCHY_RBV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_MGR_HRCHY_RBV_WHO" ENABLE;
