--------------------------------------------------------
--  DDL for Trigger OTA_SUPPLIABLE_RESOU052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_SUPPLIABLE_RESOU052615_WHO" 
before insert or update on "OTA"."OTA_SUPPLIABLE_RESOURCES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_SUPPLIABLE_RESOU052615_WHO" ENABLE;
