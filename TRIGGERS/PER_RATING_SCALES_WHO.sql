--------------------------------------------------------
--  DDL for Trigger PER_RATING_SCALES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RATING_SCALES_WHO" 
before insert or update on "HR"."PER_RATING_SCALES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RATING_SCALES_WHO" ENABLE;
