--------------------------------------------------------
--  DDL for Trigger HRI_EQ_WRKFC_EVT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_WRKFC_EVT_WHO" 
before insert or update on "HRI"."HRI_EQ_WRKFC_EVT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_WRKFC_EVT_WHO" ENABLE;
