--------------------------------------------------------
--  DDL for Trigger HR_CALENDAR_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_CALENDAR_USAGES_WHO" 
before insert or update on "HR"."HR_CALENDAR_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_CALENDAR_USAGES_WHO" ENABLE;
