--------------------------------------------------------
--  DDL for Trigger PQH_DFLT_FUND_SRCS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DFLT_FUND_SRCS_WHO" 
before insert or update on "HR"."PQH_DFLT_FUND_SRCS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DFLT_FUND_SRCS_WHO" ENABLE;
