--------------------------------------------------------
--  DDL for Trigger BEN_DPNT_CVRD_ANTHR_PL_CVG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DPNT_CVRD_ANTHR_PL_CVG_WHO" 
before insert or update on "BEN"."BEN_DPNT_CVRD_ANTHR_PL_CVG_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DPNT_CVRD_ANTHR_PL_CVG_WHO" ENABLE;
