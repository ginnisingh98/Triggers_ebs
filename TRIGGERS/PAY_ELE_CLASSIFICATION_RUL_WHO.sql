--------------------------------------------------------
--  DDL for Trigger PAY_ELE_CLASSIFICATION_RUL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELE_CLASSIFICATION_RUL_WHO" 
before insert or update on "HR"."PAY_ELE_CLASSIFICATION_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELE_CLASSIFICATION_RUL_WHO" ENABLE;
