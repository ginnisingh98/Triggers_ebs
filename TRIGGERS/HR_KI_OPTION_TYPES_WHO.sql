--------------------------------------------------------
--  DDL for Trigger HR_KI_OPTION_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_OPTION_TYPES_WHO" 
before insert or update on "HR"."HR_KI_OPTION_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_OPTION_TYPES_WHO" ENABLE;
