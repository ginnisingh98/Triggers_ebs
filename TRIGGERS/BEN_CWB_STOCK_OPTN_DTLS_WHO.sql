--------------------------------------------------------
--  DDL for Trigger BEN_CWB_STOCK_OPTN_DTLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_STOCK_OPTN_DTLS_WHO" 
before insert or update on "BEN"."BEN_CWB_STOCK_OPTN_DTLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_STOCK_OPTN_DTLS_WHO" ENABLE;
