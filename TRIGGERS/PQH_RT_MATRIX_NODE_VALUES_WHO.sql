--------------------------------------------------------
--  DDL for Trigger PQH_RT_MATRIX_NODE_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_RT_MATRIX_NODE_VALUES_WHO" 
before insert or update on "HR"."PQH_RT_MATRIX_NODE_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_RT_MATRIX_NODE_VALUES_WHO" ENABLE;
