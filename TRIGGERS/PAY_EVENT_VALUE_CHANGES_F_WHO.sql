--------------------------------------------------------
--  DDL for Trigger PAY_EVENT_VALUE_CHANGES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_EVENT_VALUE_CHANGES_F_WHO" 
before insert or update on "HR"."PAY_EVENT_VALUE_CHANGES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_EVENT_VALUE_CHANGES_F_WHO" ENABLE;
