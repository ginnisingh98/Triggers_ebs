--------------------------------------------------------
--  DDL for Trigger PSP_AUTO_PARAMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_AUTO_PARAMS_WHO" 
before insert or update on "PSP"."PSP_AUTO_PARAMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_AUTO_PARAMS_WHO" ENABLE;
