--------------------------------------------------------
--  DDL for Trigger HR_WINDOW_PROPERTIES052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_WINDOW_PROPERTIES052616_WHO" 
before insert or update on "HR"."HR_WINDOW_PROPERTIES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_WINDOW_PROPERTIES052616_WHO" ENABLE;
