--------------------------------------------------------
--  DDL for Trigger OTA_EVALUATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_EVALUATIONS_WHO" 
before insert or update on "OTA"."OTA_EVALUATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_EVALUATIONS_WHO" ENABLE;
