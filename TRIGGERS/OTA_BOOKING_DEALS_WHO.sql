--------------------------------------------------------
--  DDL for Trigger OTA_BOOKING_DEALS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_BOOKING_DEALS_WHO" 
before insert or update on "OTA"."OTA_BOOKING_DEALS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_BOOKING_DEALS_WHO" ENABLE;
