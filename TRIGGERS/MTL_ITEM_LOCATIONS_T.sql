--------------------------------------------------------
--  DDL for Trigger MTL_ITEM_LOCATIONS_T
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."MTL_ITEM_LOCATIONS_T" 
/* $Header: INVLOCTR.sql 120.0 2005/05/25 05:32:27 appldev noship $ */
BEFORE INSERT
--INVCONV kkillams
OR UPDATE
--END INVCONV kkillams
ON "INV"."MTL_ITEM_LOCATIONS"
FOR EACH ROW
DECLARE
--INVCONV kkillams
...
/
ALTER TRIGGER "APPS"."MTL_ITEM_LOCATIONS_T" ENABLE;
