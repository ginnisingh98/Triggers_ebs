--------------------------------------------------------
--  DDL for Trigger IRC_COMM_RECIPIENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_COMM_RECIPIENTS_WHO" 
before insert or update on "HR"."IRC_COMM_RECIPIENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_COMM_RECIPIENTS_WHO" ENABLE;
