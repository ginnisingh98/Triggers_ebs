--------------------------------------------------------
--  DDL for Trigger PER_ELECTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ELECTIONS_WHO" 
before insert or update on "HR"."PER_ELECTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ELECTIONS_WHO" ENABLE;
