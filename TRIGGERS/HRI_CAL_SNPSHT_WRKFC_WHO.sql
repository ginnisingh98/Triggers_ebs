--------------------------------------------------------
--  DDL for Trigger HRI_CAL_SNPSHT_WRKFC_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_CAL_SNPSHT_WRKFC_WHO" 
before insert or update on "HRI"."HRI_CAL_SNPSHT_WRKFC"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_CAL_SNPSHT_WRKFC_WHO" ENABLE;
