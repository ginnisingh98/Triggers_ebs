--------------------------------------------------------
--  DDL for Trigger BEN_EXT_CRIT_PRFL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_CRIT_PRFL_WHO" 
before insert or update on "BEN"."BEN_EXT_CRIT_PRFL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_CRIT_PRFL_WHO" ENABLE;
