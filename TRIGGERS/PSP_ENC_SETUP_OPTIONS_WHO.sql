--------------------------------------------------------
--  DDL for Trigger PSP_ENC_SETUP_OPTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ENC_SETUP_OPTIONS_WHO" 
before insert or update on "PSP"."PSP_ENC_SETUP_OPTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ENC_SETUP_OPTIONS_WHO" ENABLE;
