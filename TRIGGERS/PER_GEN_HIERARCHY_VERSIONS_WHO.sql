--------------------------------------------------------
--  DDL for Trigger PER_GEN_HIERARCHY_VERSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_GEN_HIERARCHY_VERSIONS_WHO" 
before insert or update on "HR"."PER_GEN_HIERARCHY_VERSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_GEN_HIERARCHY_VERSIONS_WHO" ENABLE;
