--------------------------------------------------------
--  DDL for Trigger FF_DATABASE_ITEMS_TL052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_DATABASE_ITEMS_TL052616_WHO" 
before insert or update on "HR"."FF_DATABASE_ITEMS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_DATABASE_ITEMS_TL052616_WHO" ENABLE;
