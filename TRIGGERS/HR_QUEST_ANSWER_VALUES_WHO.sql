--------------------------------------------------------
--  DDL for Trigger HR_QUEST_ANSWER_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_QUEST_ANSWER_VALUES_WHO" 
before insert or update on "HR"."HR_QUEST_ANSWER_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_QUEST_ANSWER_VALUES_WHO" ENABLE;
