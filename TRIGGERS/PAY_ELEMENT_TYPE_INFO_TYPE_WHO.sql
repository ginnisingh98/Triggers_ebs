--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_TYPE_INFO_TYPE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_TYPE_INFO_TYPE_WHO" 
before insert or update on "HR"."PAY_ELEMENT_TYPE_INFO_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_TYPE_INFO_TYPE_WHO" ENABLE;
