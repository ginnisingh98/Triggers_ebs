--------------------------------------------------------
--  DDL for Trigger GHR_MASS_ACTIONS_PREVIEW_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_MASS_ACTIONS_PREVIEW_WHO" 
before insert or update on "HR"."GHR_MASS_ACTIONS_PREVIEW"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_MASS_ACTIONS_PREVIEW_WHO" ENABLE;
