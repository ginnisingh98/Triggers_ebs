--------------------------------------------------------
--  DDL for Trigger HRI_MDP_BDGTS_HDCNT_ORGMGR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_MDP_BDGTS_HDCNT_ORGMGR_WHO" 
before insert or update on "HRI"."HRI_MDP_BDGTS_HDCNT_ORGMGR_CT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_MDP_BDGTS_HDCNT_ORGMGR_WHO" ENABLE;
