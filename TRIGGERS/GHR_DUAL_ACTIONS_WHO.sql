--------------------------------------------------------
--  DDL for Trigger GHR_DUAL_ACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_DUAL_ACTIONS_WHO" 
before insert or update on "HR"."GHR_DUAL_ACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_DUAL_ACTIONS_WHO" ENABLE;
