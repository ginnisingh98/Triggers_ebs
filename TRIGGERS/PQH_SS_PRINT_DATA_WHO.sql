--------------------------------------------------------
--  DDL for Trigger PQH_SS_PRINT_DATA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_SS_PRINT_DATA_WHO" 
before insert or update on "HR"."PQH_SS_PRINT_DATA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_SS_PRINT_DATA_WHO" ENABLE;
