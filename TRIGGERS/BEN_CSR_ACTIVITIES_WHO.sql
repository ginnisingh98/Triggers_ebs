--------------------------------------------------------
--  DDL for Trigger BEN_CSR_ACTIVITIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CSR_ACTIVITIES_WHO" 
before insert or update on "BEN"."BEN_CSR_ACTIVITIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CSR_ACTIVITIES_WHO" ENABLE;
