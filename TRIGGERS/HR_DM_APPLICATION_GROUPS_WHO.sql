--------------------------------------------------------
--  DDL for Trigger HR_DM_APPLICATION_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_APPLICATION_GROUPS_WHO" 
before insert or update on "HR"."HR_DM_APPLICATION_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_APPLICATION_GROUPS_WHO" ENABLE;
