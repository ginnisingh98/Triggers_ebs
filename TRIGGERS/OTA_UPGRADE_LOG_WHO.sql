--------------------------------------------------------
--  DDL for Trigger OTA_UPGRADE_LOG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_UPGRADE_LOG_WHO" 
before insert or update on "OTA"."OTA_UPGRADE_LOG"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_UPGRADE_LOG_WHO" ENABLE;
