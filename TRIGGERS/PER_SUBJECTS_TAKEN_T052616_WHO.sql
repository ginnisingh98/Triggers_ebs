--------------------------------------------------------
--  DDL for Trigger PER_SUBJECTS_TAKEN_T052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SUBJECTS_TAKEN_T052616_WHO" 
before insert or update on "HR"."PER_SUBJECTS_TAKEN_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SUBJECTS_TAKEN_T052616_WHO" ENABLE;
