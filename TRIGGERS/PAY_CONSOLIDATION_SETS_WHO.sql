--------------------------------------------------------
--  DDL for Trigger PAY_CONSOLIDATION_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_CONSOLIDATION_SETS_WHO" 
before insert or update on "HR"."PAY_CONSOLIDATION_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_CONSOLIDATION_SETS_WHO" ENABLE;
