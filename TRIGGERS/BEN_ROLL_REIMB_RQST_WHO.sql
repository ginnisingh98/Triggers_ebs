--------------------------------------------------------
--  DDL for Trigger BEN_ROLL_REIMB_RQST_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ROLL_REIMB_RQST_WHO" 
before insert or update on "BEN"."BEN_ROLL_REIMB_RQST"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ROLL_REIMB_RQST_WHO" ENABLE;
