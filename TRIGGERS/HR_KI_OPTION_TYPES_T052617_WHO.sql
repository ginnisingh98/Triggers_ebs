--------------------------------------------------------
--  DDL for Trigger HR_KI_OPTION_TYPES_T052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_OPTION_TYPES_T052617_WHO" 
before insert or update on "HR"."HR_KI_OPTION_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_OPTION_TYPES_T052617_WHO" ENABLE;
