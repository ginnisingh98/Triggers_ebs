--------------------------------------------------------
--  DDL for Trigger OTA_ACTIVITY_VERSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_ACTIVITY_VERSIONS_WHO" 
before insert or update on "OTA"."OTA_ACTIVITY_VERSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_ACTIVITY_VERSIONS_WHO" ENABLE;
