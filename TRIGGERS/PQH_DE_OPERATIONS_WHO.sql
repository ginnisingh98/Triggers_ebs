--------------------------------------------------------
--  DDL for Trigger PQH_DE_OPERATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_OPERATIONS_WHO" 
before insert or update on "HR"."PQH_DE_OPERATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_OPERATIONS_WHO" ENABLE;
