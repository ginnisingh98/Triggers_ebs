--------------------------------------------------------
--  DDL for Trigger OTA_OFFERINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_OFFERINGS_WHO" 
before insert or update on "OTA"."OTA_OFFERINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_OFFERINGS_WHO" ENABLE;
