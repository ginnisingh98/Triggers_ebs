--------------------------------------------------------
--  DDL for Trigger BEN_ENRT_PREM_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ENRT_PREM_WHO" 
before insert or update on "BEN"."BEN_ENRT_PREM"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ENRT_PREM_WHO" ENABLE;
