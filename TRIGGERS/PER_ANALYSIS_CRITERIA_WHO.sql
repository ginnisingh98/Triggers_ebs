--------------------------------------------------------
--  DDL for Trigger PER_ANALYSIS_CRITERIA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ANALYSIS_CRITERIA_WHO" 
before insert or update on "HR"."PER_ANALYSIS_CRITERIA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ANALYSIS_CRITERIA_WHO" ENABLE;
