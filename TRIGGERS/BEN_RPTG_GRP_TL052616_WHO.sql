--------------------------------------------------------
--  DDL for Trigger BEN_RPTG_GRP_TL052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_RPTG_GRP_TL052616_WHO" 
before insert or update on "BEN"."BEN_RPTG_GRP_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_RPTG_GRP_TL052616_WHO" ENABLE;
