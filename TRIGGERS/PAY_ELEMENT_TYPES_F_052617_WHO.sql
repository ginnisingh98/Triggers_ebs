--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_TYPES_F_052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_TYPES_F_052617_WHO" 
before insert or update on "HR"."PAY_ELEMENT_TYPES_F_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_TYPES_F_052617_WHO" ENABLE;
