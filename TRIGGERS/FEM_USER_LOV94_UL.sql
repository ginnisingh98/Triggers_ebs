--------------------------------------------------------
--  DDL for Trigger FEM_USER_LOV94_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_LOV94_UL" 
instead of update on FEM_USER_LOV94_VL
...
/
ALTER TRIGGER "APPS"."FEM_USER_LOV94_UL" ENABLE;
