--------------------------------------------------------
--  DDL for Trigger HR_DE_LIABILITY_PREMIUMS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DE_LIABILITY_PREMIUMS_F_WHO" 
before insert or update on "HR"."HR_DE_LIABILITY_PREMIUMS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DE_LIABILITY_PREMIUMS_F_WHO" ENABLE;
