--------------------------------------------------------
--  DDL for Trigger PQH_DOCUMENTS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DOCUMENTS_F_WHO" 
before insert or update on "HR"."PQH_DOCUMENTS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DOCUMENTS_F_WHO" ENABLE;
