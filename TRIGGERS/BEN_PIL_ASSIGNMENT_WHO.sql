--------------------------------------------------------
--  DDL for Trigger BEN_PIL_ASSIGNMENT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PIL_ASSIGNMENT_WHO" 
before insert or update on "BEN"."BEN_PIL_ASSIGNMENT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PIL_ASSIGNMENT_WHO" ENABLE;
