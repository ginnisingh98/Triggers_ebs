--------------------------------------------------------
--  DDL for Trigger PSP_EFF_REPORT_APPROVALS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_EFF_REPORT_APPROVALS_WHO" 
before insert or update on "PSP"."PSP_EFF_REPORT_APPROVALS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_EFF_REPORT_APPROVALS_WHO" ENABLE;
