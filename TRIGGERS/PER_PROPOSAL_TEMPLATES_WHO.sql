--------------------------------------------------------
--  DDL for Trigger PER_PROPOSAL_TEMPLATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PROPOSAL_TEMPLATES_WHO" 
before insert or update on "HR"."PER_PROPOSAL_TEMPLATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PROPOSAL_TEMPLATES_WHO" ENABLE;
