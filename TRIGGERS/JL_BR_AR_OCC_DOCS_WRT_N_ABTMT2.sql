--------------------------------------------------------
--  DDL for Trigger JL_BR_AR_OCC_DOCS_WRT_N_ABTMT2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."JL_BR_AR_OCC_DOCS_WRT_N_ABTMT2" 
...
/
ALTER TRIGGER "APPS"."JL_BR_AR_OCC_DOCS_WRT_N_ABTMT2" ENABLE;
