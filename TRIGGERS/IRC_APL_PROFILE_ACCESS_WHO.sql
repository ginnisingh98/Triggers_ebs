--------------------------------------------------------
--  DDL for Trigger IRC_APL_PROFILE_ACCESS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_APL_PROFILE_ACCESS_WHO" 
before insert or update on "HR"."IRC_APL_PROFILE_ACCESS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_APL_PROFILE_ACCESS_WHO" ENABLE;
