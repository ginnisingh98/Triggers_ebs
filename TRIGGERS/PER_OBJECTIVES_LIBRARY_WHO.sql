--------------------------------------------------------
--  DDL for Trigger PER_OBJECTIVES_LIBRARY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_OBJECTIVES_LIBRARY_WHO" 
before insert or update on "HR"."PER_OBJECTIVES_LIBRARY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_OBJECTIVES_LIBRARY_WHO" ENABLE;
