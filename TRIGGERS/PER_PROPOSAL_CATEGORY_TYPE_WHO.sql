--------------------------------------------------------
--  DDL for Trigger PER_PROPOSAL_CATEGORY_TYPE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PROPOSAL_CATEGORY_TYPE_WHO" 
before insert or update on "HR"."PER_PROPOSAL_CATEGORY_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PROPOSAL_CATEGORY_TYPE_WHO" ENABLE;
