--------------------------------------------------------
--  DDL for Trigger HR_FORM_ITEMS_TL052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_FORM_ITEMS_TL052617_WHO" 
before insert or update on "HR"."HR_FORM_ITEMS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_FORM_ITEMS_TL052617_WHO" ENABLE;
