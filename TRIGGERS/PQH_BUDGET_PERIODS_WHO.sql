--------------------------------------------------------
--  DDL for Trigger PQH_BUDGET_PERIODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BUDGET_PERIODS_WHO" 
before insert or update on "HR"."PQH_BUDGET_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BUDGET_PERIODS_WHO" ENABLE;
