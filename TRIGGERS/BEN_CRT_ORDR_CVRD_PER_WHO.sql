--------------------------------------------------------
--  DDL for Trigger BEN_CRT_ORDR_CVRD_PER_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CRT_ORDR_CVRD_PER_WHO" 
before insert or update on "BEN"."BEN_CRT_ORDR_CVRD_PER"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CRT_ORDR_CVRD_PER_WHO" ENABLE;
