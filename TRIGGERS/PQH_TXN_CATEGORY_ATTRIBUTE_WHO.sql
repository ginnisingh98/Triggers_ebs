--------------------------------------------------------
--  DDL for Trigger PQH_TXN_CATEGORY_ATTRIBUTE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_TXN_CATEGORY_ATTRIBUTE_WHO" 
before insert or update on "HR"."PQH_TXN_CATEGORY_ATTRIBUTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_TXN_CATEGORY_ATTRIBUTE_WHO" ENABLE;
