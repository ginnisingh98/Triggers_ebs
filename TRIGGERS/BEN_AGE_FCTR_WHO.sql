--------------------------------------------------------
--  DDL for Trigger BEN_AGE_FCTR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_AGE_FCTR_WHO" 
before insert or update on "BEN"."BEN_AGE_FCTR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_AGE_FCTR_WHO" ENABLE;
