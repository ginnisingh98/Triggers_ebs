--------------------------------------------------------
--  DDL for Trigger PSP_AUTO_FILL_DATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_AUTO_FILL_DATES_WHO" 
before insert or update on "PSP"."PSP_AUTO_FILL_DATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_AUTO_FILL_DATES_WHO" ENABLE;
