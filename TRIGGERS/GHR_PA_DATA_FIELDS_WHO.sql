--------------------------------------------------------
--  DDL for Trigger GHR_PA_DATA_FIELDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PA_DATA_FIELDS_WHO" 
before insert or update on "HR"."GHR_PA_DATA_FIELDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PA_DATA_FIELDS_WHO" ENABLE;
