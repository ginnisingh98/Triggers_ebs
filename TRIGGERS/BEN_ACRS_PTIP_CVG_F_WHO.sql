--------------------------------------------------------
--  DDL for Trigger BEN_ACRS_PTIP_CVG_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ACRS_PTIP_CVG_F_WHO" 
before insert or update on "BEN"."BEN_ACRS_PTIP_CVG_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ACRS_PTIP_CVG_F_WHO" ENABLE;
