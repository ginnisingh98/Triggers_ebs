--------------------------------------------------------
--  DDL for Trigger PQH_SS_PRINT_LABEL_TEMP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_SS_PRINT_LABEL_TEMP_WHO" 
before insert or update on "HR"."PQH_SS_PRINT_LABEL_TEMP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_SS_PRINT_LABEL_TEMP_WHO" ENABLE;
