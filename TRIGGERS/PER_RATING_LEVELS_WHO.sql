--------------------------------------------------------
--  DDL for Trigger PER_RATING_LEVELS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RATING_LEVELS_WHO" 
before insert or update on "HR"."PER_RATING_LEVELS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RATING_LEVELS_WHO" ENABLE;
