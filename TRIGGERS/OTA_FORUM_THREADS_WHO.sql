--------------------------------------------------------
--  DDL for Trigger OTA_FORUM_THREADS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_FORUM_THREADS_WHO" 
before insert or update on "OTA"."OTA_FORUM_THREADS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_FORUM_THREADS_WHO" ENABLE;
