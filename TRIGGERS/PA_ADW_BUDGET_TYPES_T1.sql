--------------------------------------------------------
--  DDL for Trigger PA_ADW_BUDGET_TYPES_T1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PA_ADW_BUDGET_TYPES_T1" 
-- $Header: PATRIG01.pls 115.5 99/07/16 15:14:43 porting ship  $
BEFORE UPDATE OF
  -- Columns required for data warehouse
  BUDGET_TYPE
ON "PA"."PA_BUDGET_TYPES"
FOR EACH ROW
...
/
ALTER TRIGGER "APPS"."PA_ADW_BUDGET_TYPES_T1" ENABLE;
