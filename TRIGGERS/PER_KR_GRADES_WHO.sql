--------------------------------------------------------
--  DDL for Trigger PER_KR_GRADES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_KR_GRADES_WHO" 
before insert or update on "HR"."PER_KR_GRADES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_KR_GRADES_WHO" ENABLE;
