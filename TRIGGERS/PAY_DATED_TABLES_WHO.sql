--------------------------------------------------------
--  DDL for Trigger PAY_DATED_TABLES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_DATED_TABLES_WHO" 
before insert or update on "HR"."PAY_DATED_TABLES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_DATED_TABLES_WHO" ENABLE;
