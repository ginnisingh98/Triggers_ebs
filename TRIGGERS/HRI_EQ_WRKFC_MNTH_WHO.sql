--------------------------------------------------------
--  DDL for Trigger HRI_EQ_WRKFC_MNTH_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_WRKFC_MNTH_WHO" 
before insert or update on "HRI"."HRI_EQ_WRKFC_MNTH"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_WRKFC_MNTH_WHO" ENABLE;
