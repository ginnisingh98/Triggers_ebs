--------------------------------------------------------
--  DDL for Trigger FEM_DIS_ENTITIES_HIER_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_DIS_ENTITIES_HIER_UL" 
instead of update on FEM_DIS_ENTITIES_HIER_VL
referencing new as FEM_DIS_ENTITIES_HIER_B
for each row
begin
  FEM_DIS_ENTITIES_HIER_PKG.UPDATE_ROW(
...
/
ALTER TRIGGER "APPS"."FEM_DIS_ENTITIES_HIER_UL" ENABLE;
