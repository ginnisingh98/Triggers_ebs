--------------------------------------------------------
--  DDL for Trigger PER_CAGR_ENTITLEMENT_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_ENTITLEMENT_ITEMS_WHO" 
before insert or update on "HR"."PER_CAGR_ENTITLEMENT_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_ENTITLEMENT_ITEMS_WHO" ENABLE;
