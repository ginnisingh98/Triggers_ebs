--------------------------------------------------------
--  DDL for Trigger PAY_JP_SWOT_NUMBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_JP_SWOT_NUMBERS_WHO" 
before insert or update on "HR"."PAY_JP_SWOT_NUMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_JP_SWOT_NUMBERS_WHO" ENABLE;
