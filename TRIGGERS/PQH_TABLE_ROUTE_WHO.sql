--------------------------------------------------------
--  DDL for Trigger PQH_TABLE_ROUTE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_TABLE_ROUTE_WHO" 
before insert or update on "HR"."PQH_TABLE_ROUTE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_TABLE_ROUTE_WHO" ENABLE;
