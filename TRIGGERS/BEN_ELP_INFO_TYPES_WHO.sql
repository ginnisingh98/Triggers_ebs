--------------------------------------------------------
--  DDL for Trigger BEN_ELP_INFO_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELP_INFO_TYPES_WHO" 
before insert or update on "BEN"."BEN_ELP_INFO_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELP_INFO_TYPES_WHO" ENABLE;
