--------------------------------------------------------
--  DDL for Trigger PAY_EVENT_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_EVENT_GROUPS_WHO" 
before insert or update on "HR"."PAY_EVENT_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_EVENT_GROUPS_WHO" ENABLE;
