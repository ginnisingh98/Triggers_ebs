--------------------------------------------------------
--  DDL for Trigger HR_ADI_INTG_RESP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ADI_INTG_RESP_WHO" 
before insert or update on "HR"."HR_ADI_INTG_RESP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ADI_INTG_RESP_WHO" ENABLE;
