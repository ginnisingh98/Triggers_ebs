--------------------------------------------------------
--  DDL for Trigger GHR_RESTRICTED_PROC_METHOD_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_RESTRICTED_PROC_METHOD_WHO" 
before insert or update on "HR"."GHR_RESTRICTED_PROC_METHODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_RESTRICTED_PROC_METHOD_WHO" ENABLE;
