--------------------------------------------------------
--  DDL for Trigger HXC_DATA_APP_RULE_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_DATA_APP_RULE_USAGES_WHO" 
before insert or update on "HXC"."HXC_DATA_APP_RULE_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_DATA_APP_RULE_USAGES_WHO" ENABLE;
