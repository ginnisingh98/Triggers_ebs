--------------------------------------------------------
--  DDL for Trigger GHR_POIS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_POIS_WHO" 
before insert or update on "HR"."GHR_POIS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_POIS_WHO" ENABLE;
