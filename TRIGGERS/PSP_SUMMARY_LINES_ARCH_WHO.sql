--------------------------------------------------------
--  DDL for Trigger PSP_SUMMARY_LINES_ARCH_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_SUMMARY_LINES_ARCH_WHO" 
before insert or update on "PSP"."PSP_SUMMARY_LINES_ARCH"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_SUMMARY_LINES_ARCH_WHO" ENABLE;
