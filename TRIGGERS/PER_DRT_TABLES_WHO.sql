--------------------------------------------------------
--  DDL for Trigger PER_DRT_TABLES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_DRT_TABLES_WHO" 
before insert or update on "HR"."PER_DRT_TABLES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_DRT_TABLES_WHO" ENABLE;
