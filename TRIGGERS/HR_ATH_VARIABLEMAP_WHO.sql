--------------------------------------------------------
--  DDL for Trigger HR_ATH_VARIABLEMAP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ATH_VARIABLEMAP_WHO" 
before insert or update on "HR"."HR_ATH_VARIABLEMAP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ATH_VARIABLEMAP_WHO" ENABLE;
