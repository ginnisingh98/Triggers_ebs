--------------------------------------------------------
--  DDL for Trigger PAY_TAXABILITY_RULES_DATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_TAXABILITY_RULES_DATES_WHO" 
before insert or update on "HR"."PAY_TAXABILITY_RULES_DATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_TAXABILITY_RULES_DATES_WHO" ENABLE;
