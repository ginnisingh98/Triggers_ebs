--------------------------------------------------------
--  DDL for Trigger GHR_GROUPBOXES_AU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_GROUPBOXES_AU" 
...
end GHR_GROUPBOXES_AU;


/
ALTER TRIGGER "APPS"."GHR_GROUPBOXES_AU" ENABLE;
