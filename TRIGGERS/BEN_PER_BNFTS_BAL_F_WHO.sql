--------------------------------------------------------
--  DDL for Trigger BEN_PER_BNFTS_BAL_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PER_BNFTS_BAL_F_WHO" 
before insert or update on "BEN"."BEN_PER_BNFTS_BAL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PER_BNFTS_BAL_F_WHO" ENABLE;
