--------------------------------------------------------
--  DDL for Trigger PER_CAGR_GRADES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_GRADES_WHO" 
before insert or update on "HR"."PER_CAGR_GRADES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_GRADES_WHO" ENABLE;
