--------------------------------------------------------
--  DDL for Trigger PER_SCHED_COBRA_PAYMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SCHED_COBRA_PAYMENTS_WHO" 
before insert or update on "HR"."PER_SCHED_COBRA_PAYMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SCHED_COBRA_PAYMENTS_WHO" ENABLE;
