--------------------------------------------------------
--  DDL for Trigger BEN_LEE_RSN_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_LEE_RSN_F_WHO" 
before insert or update on "BEN"."BEN_LEE_RSN_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_LEE_RSN_F_WHO" ENABLE;
