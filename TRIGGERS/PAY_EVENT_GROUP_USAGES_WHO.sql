--------------------------------------------------------
--  DDL for Trigger PAY_EVENT_GROUP_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_EVENT_GROUP_USAGES_WHO" 
before insert or update on "HR"."PAY_EVENT_GROUP_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_EVENT_GROUP_USAGES_WHO" ENABLE;
