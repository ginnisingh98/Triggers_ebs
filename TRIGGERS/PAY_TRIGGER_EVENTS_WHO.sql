--------------------------------------------------------
--  DDL for Trigger PAY_TRIGGER_EVENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_TRIGGER_EVENTS_WHO" 
before insert or update on "HR"."PAY_TRIGGER_EVENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_TRIGGER_EVENTS_WHO" ENABLE;
