--------------------------------------------------------
--  DDL for Trigger HXT_HOUR_DEDUCTION_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_HOUR_DEDUCTION_RULES_WHO" 
before insert or update on "HXT"."HXT_HOUR_DEDUCTION_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_HOUR_DEDUCTION_RULES_WHO" ENABLE;
