--------------------------------------------------------
--  DDL for Trigger PAY_FUNCTIONAL_TRIGGERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_FUNCTIONAL_TRIGGERS_WHO" 
before insert or update on "HR"."PAY_FUNCTIONAL_TRIGGERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_FUNCTIONAL_TRIGGERS_WHO" ENABLE;
