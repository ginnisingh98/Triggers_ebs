--------------------------------------------------------
--  DDL for Trigger BEN_TCS_PER_ITEM_VALUE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_TCS_PER_ITEM_VALUE_WHO" 
before insert or update on "BEN"."BEN_TCS_PER_ITEM_VALUE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_TCS_PER_ITEM_VALUE_WHO" ENABLE;
