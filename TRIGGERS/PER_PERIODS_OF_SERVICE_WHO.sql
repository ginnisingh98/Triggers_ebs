--------------------------------------------------------
--  DDL for Trigger PER_PERIODS_OF_SERVICE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERIODS_OF_SERVICE_WHO" 
before insert or update on "HR"."PER_PERIODS_OF_SERVICE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERIODS_OF_SERVICE_WHO" ENABLE;
