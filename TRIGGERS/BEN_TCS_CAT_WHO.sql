--------------------------------------------------------
--  DDL for Trigger BEN_TCS_CAT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_TCS_CAT_WHO" 
before insert or update on "BEN"."BEN_TCS_CAT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_TCS_CAT_WHO" ENABLE;
