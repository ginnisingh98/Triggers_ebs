--------------------------------------------------------
--  DDL for Trigger BEN_PRTT_RT_VAL_RBV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTT_RT_VAL_RBV_WHO" 
before insert or update on "BEN"."BEN_PRTT_RT_VAL_RBV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTT_RT_VAL_RBV_WHO" ENABLE;
