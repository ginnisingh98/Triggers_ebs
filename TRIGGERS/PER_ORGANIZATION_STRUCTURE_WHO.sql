--------------------------------------------------------
--  DDL for Trigger PER_ORGANIZATION_STRUCTURE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ORGANIZATION_STRUCTURE_WHO" 
before insert or update on "HR"."PER_ORGANIZATION_STRUCTURES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ORGANIZATION_STRUCTURE_WHO" ENABLE;
