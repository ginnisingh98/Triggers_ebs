--------------------------------------------------------
--  DDL for Trigger PER_CAGR_LOG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_LOG_WHO" 
before insert or update on "HR"."PER_CAGR_LOG"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_LOG_WHO" ENABLE;
