--------------------------------------------------------
--  DDL for Trigger PER_KR_G_POINTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_KR_G_POINTS_WHO" 
before insert or update on "HR"."PER_KR_G_POINTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_KR_G_POINTS_WHO" ENABLE;
