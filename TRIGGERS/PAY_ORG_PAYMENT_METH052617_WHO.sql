--------------------------------------------------------
--  DDL for Trigger PAY_ORG_PAYMENT_METH052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ORG_PAYMENT_METH052617_WHO" 
before insert or update on "HR"."PAY_ORG_PAYMENT_METHODS_F_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ORG_PAYMENT_METH052617_WHO" ENABLE;
