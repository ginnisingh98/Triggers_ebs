--------------------------------------------------------
--  DDL for Trigger PER_SECURITY_PROFILES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SECURITY_PROFILES_WHO" 
before insert or update on "HR"."PER_SECURITY_PROFILES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SECURITY_PROFILES_WHO" ENABLE;
