--------------------------------------------------------
--  DDL for Trigger PER_CONTACT_EXTRA_INFO_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CONTACT_EXTRA_INFO_F_WHO" 
before insert or update on "HR"."PER_CONTACT_EXTRA_INFO_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CONTACT_EXTRA_INFO_F_WHO" ENABLE;
