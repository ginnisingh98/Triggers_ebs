--------------------------------------------------------
--  DDL for Trigger PER_PERFORMANCE_REVIEWS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERFORMANCE_REVIEWS_WHO" 
before insert or update on "HR"."PER_PERFORMANCE_REVIEWS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERFORMANCE_REVIEWS_WHO" ENABLE;
