--------------------------------------------------------
--  DDL for Trigger HR_ITEM_CONTEXTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ITEM_CONTEXTS_WHO" 
before insert or update on "HR"."HR_ITEM_CONTEXTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ITEM_CONTEXTS_WHO" ENABLE;
