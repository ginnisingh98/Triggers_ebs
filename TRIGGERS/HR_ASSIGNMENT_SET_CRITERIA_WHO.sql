--------------------------------------------------------
--  DDL for Trigger HR_ASSIGNMENT_SET_CRITERIA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ASSIGNMENT_SET_CRITERIA_WHO" 
before insert or update on "HR"."HR_ASSIGNMENT_SET_CRITERIA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ASSIGNMENT_SET_CRITERIA_WHO" ENABLE;
