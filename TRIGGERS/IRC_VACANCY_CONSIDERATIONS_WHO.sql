--------------------------------------------------------
--  DDL for Trigger IRC_VACANCY_CONSIDERATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_VACANCY_CONSIDERATIONS_WHO" 
before insert or update on "HR"."IRC_VACANCY_CONSIDERATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_VACANCY_CONSIDERATIONS_WHO" ENABLE;
