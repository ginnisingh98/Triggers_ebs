--------------------------------------------------------
--  DDL for Trigger PER_PERSON_ANALYSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERSON_ANALYSES_WHO" 
before insert or update on "HR"."PER_PERSON_ANALYSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERSON_ANALYSES_WHO" ENABLE;
