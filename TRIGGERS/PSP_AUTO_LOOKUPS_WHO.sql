--------------------------------------------------------
--  DDL for Trigger PSP_AUTO_LOOKUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_AUTO_LOOKUPS_WHO" 
before insert or update on "PSP"."PSP_AUTO_LOOKUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_AUTO_LOOKUPS_WHO" ENABLE;
