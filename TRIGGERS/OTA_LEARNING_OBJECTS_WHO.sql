--------------------------------------------------------
--  DDL for Trigger OTA_LEARNING_OBJECTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_LEARNING_OBJECTS_WHO" 
before insert or update on "OTA"."OTA_LEARNING_OBJECTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_LEARNING_OBJECTS_WHO" ENABLE;
