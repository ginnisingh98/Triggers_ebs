--------------------------------------------------------
--  DDL for Trigger FEM_USER_DIM6_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_DIM6_IL" 
instead of insert on FEM_USER_DIM6_VL
...
begin
  FEM_USER_DIM6_PKG.INSERT_ROW(
    ...
    X_CREATION_DATE => :FEM_USER_DIM6_B.CREATION_DATE,
    X_CREATED_BY => :FEM_USER_DIM6_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_USER_DIM6_IL" ENABLE;
