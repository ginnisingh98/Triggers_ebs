--------------------------------------------------------
--  DDL for Trigger PER_JOB_EVALUATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_JOB_EVALUATIONS_WHO" 
before insert or update on "HR"."PER_JOB_EVALUATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_JOB_EVALUATIONS_WHO" ENABLE;
