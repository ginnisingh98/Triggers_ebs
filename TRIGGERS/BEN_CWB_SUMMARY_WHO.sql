--------------------------------------------------------
--  DDL for Trigger BEN_CWB_SUMMARY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_SUMMARY_WHO" 
before insert or update on "BEN"."BEN_CWB_SUMMARY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_SUMMARY_WHO" ENABLE;
