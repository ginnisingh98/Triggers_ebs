--------------------------------------------------------
--  DDL for Trigger OTA_RESOURCE_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_RESOURCE_DEFINITIONS_WHO" 
before insert or update on "OTA"."OTA_RESOURCE_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_RESOURCE_DEFINITIONS_WHO" ENABLE;
