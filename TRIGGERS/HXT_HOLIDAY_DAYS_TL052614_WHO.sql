--------------------------------------------------------
--  DDL for Trigger HXT_HOLIDAY_DAYS_TL052614_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_HOLIDAY_DAYS_TL052614_WHO" 
before insert or update on "HXT"."HXT_HOLIDAY_DAYS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_HOLIDAY_DAYS_TL052614_WHO" ENABLE;
