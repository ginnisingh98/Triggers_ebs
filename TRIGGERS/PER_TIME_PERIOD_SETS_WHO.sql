--------------------------------------------------------
--  DDL for Trigger PER_TIME_PERIOD_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_TIME_PERIOD_SETS_WHO" 
before insert or update on "HR"."PER_TIME_PERIOD_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_TIME_PERIOD_SETS_WHO" ENABLE;
