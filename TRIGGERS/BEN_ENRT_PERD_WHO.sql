--------------------------------------------------------
--  DDL for Trigger BEN_ENRT_PERD_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ENRT_PERD_WHO" 
before insert or update on "BEN"."BEN_ENRT_PERD"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ENRT_PERD_WHO" ENABLE;
