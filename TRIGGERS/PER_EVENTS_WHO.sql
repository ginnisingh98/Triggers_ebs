--------------------------------------------------------
--  DDL for Trigger PER_EVENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_EVENTS_WHO" 
before insert or update on "HR"."PER_EVENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_EVENTS_WHO" ENABLE;
