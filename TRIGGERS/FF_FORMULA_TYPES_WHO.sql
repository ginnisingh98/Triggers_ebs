--------------------------------------------------------
--  DDL for Trigger FF_FORMULA_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_FORMULA_TYPES_WHO" 
before insert or update on "HR"."FF_FORMULA_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_FORMULA_TYPES_WHO" ENABLE;
