--------------------------------------------------------
--  DDL for Trigger PAY_REPORT_CATEGORY_COMPON_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_REPORT_CATEGORY_COMPON_WHO" 
before insert or update on "HR"."PAY_REPORT_CATEGORY_COMPONENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_REPORT_CATEGORY_COMPON_WHO" ENABLE;
