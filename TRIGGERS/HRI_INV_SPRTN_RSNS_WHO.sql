--------------------------------------------------------
--  DDL for Trigger HRI_INV_SPRTN_RSNS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_INV_SPRTN_RSNS_WHO" 
before insert or update on "HRI"."HRI_INV_SPRTN_RSNS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_INV_SPRTN_RSNS_WHO" ENABLE;
