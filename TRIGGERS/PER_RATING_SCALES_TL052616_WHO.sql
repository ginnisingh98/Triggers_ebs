--------------------------------------------------------
--  DDL for Trigger PER_RATING_SCALES_TL052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RATING_SCALES_TL052616_WHO" 
before insert or update on "HR"."PER_RATING_SCALES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RATING_SCALES_TL052616_WHO" ENABLE;
