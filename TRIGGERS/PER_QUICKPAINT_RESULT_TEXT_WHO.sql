--------------------------------------------------------
--  DDL for Trigger PER_QUICKPAINT_RESULT_TEXT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_QUICKPAINT_RESULT_TEXT_WHO" 
before insert or update on "HR"."PER_QUICKPAINT_RESULT_TEXT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_QUICKPAINT_RESULT_TEXT_WHO" ENABLE;
