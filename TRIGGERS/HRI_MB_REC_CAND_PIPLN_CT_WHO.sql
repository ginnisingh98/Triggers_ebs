--------------------------------------------------------
--  DDL for Trigger HRI_MB_REC_CAND_PIPLN_CT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_MB_REC_CAND_PIPLN_CT_WHO" 
before insert or update on "HRI"."HRI_MB_REC_CAND_PIPLN_CT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_MB_REC_CAND_PIPLN_CT_WHO" ENABLE;
