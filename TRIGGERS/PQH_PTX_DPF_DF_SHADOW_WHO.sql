--------------------------------------------------------
--  DDL for Trigger PQH_PTX_DPF_DF_SHADOW_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_PTX_DPF_DF_SHADOW_WHO" 
before insert or update on "HR"."PQH_PTX_DPF_DF_SHADOW"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_PTX_DPF_DF_SHADOW_WHO" ENABLE;
