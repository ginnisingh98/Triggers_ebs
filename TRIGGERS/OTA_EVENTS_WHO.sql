--------------------------------------------------------
--  DDL for Trigger OTA_EVENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_EVENTS_WHO" 
before insert or update on "OTA"."OTA_EVENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_EVENTS_WHO" ENABLE;
