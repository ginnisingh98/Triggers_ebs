--------------------------------------------------------
--  DDL for Trigger FF_GLOBALS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_GLOBALS_F_WHO" 
before insert or update on "HR"."FF_GLOBALS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_GLOBALS_F_WHO" ENABLE;
