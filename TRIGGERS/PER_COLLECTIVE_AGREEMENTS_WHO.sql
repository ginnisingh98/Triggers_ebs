--------------------------------------------------------
--  DDL for Trigger PER_COLLECTIVE_AGREEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COLLECTIVE_AGREEMENTS_WHO" 
before insert or update on "HR"."PER_COLLECTIVE_AGREEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COLLECTIVE_AGREEMENTS_WHO" ENABLE;
