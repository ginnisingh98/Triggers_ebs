--------------------------------------------------------
--  DDL for Trigger BEN_STARTUP_CM_TYP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_STARTUP_CM_TYP_WHO" 
before insert or update on "BEN"."BEN_STARTUP_CM_TYP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_STARTUP_CM_TYP_WHO" ENABLE;
