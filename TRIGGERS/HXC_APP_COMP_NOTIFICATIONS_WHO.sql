--------------------------------------------------------
--  DDL for Trigger HXC_APP_COMP_NOTIFICATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_APP_COMP_NOTIFICATIONS_WHO" 
before insert or update on "HXC"."HXC_APP_COMP_NOTIFICATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_APP_COMP_NOTIFICATIONS_WHO" ENABLE;
