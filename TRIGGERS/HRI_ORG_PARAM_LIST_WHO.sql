--------------------------------------------------------
--  DDL for Trigger HRI_ORG_PARAM_LIST_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_ORG_PARAM_LIST_WHO" 
before insert or update on "HRI"."HRI_ORG_PARAM_LIST"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_ORG_PARAM_LIST_WHO" ENABLE;
