--------------------------------------------------------
--  DDL for Trigger HR_PATTERN_BITS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PATTERN_BITS_WHO" 
before insert or update on "HR"."HR_PATTERN_BITS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PATTERN_BITS_WHO" ENABLE;
