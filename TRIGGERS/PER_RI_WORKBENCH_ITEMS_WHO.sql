--------------------------------------------------------
--  DDL for Trigger PER_RI_WORKBENCH_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_WORKBENCH_ITEMS_WHO" 
before insert or update on "HR"."PER_RI_WORKBENCH_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_WORKBENCH_ITEMS_WHO" ENABLE;
