--------------------------------------------------------
--  DDL for Trigger PQH_CRITERIA_RATE_ELEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_CRITERIA_RATE_ELEMENTS_WHO" 
before insert or update on "HR"."PQH_CRITERIA_RATE_ELEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_CRITERIA_RATE_ELEMENTS_WHO" ENABLE;
