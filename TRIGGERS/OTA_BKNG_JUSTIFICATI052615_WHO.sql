--------------------------------------------------------
--  DDL for Trigger OTA_BKNG_JUSTIFICATI052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_BKNG_JUSTIFICATI052615_WHO" 
before insert or update on "OTA"."OTA_BKNG_JUSTIFICATIONS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_BKNG_JUSTIFICATI052615_WHO" ENABLE;
