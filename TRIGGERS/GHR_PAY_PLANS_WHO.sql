--------------------------------------------------------
--  DDL for Trigger GHR_PAY_PLANS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PAY_PLANS_WHO" 
before insert or update on "HR"."GHR_PAY_PLANS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PAY_PLANS_WHO" ENABLE;
