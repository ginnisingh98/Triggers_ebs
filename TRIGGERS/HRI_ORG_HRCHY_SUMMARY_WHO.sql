--------------------------------------------------------
--  DDL for Trigger HRI_ORG_HRCHY_SUMMARY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_ORG_HRCHY_SUMMARY_WHO" 
before insert or update on "HRI"."HRI_ORG_HRCHY_SUMMARY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_ORG_HRCHY_SUMMARY_WHO" ENABLE;
