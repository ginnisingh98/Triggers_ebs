--------------------------------------------------------
--  DDL for Trigger BEN_PRTT_PREM_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTT_PREM_F_WHO" 
before insert or update on "BEN"."BEN_PRTT_PREM_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTT_PREM_F_WHO" ENABLE;
