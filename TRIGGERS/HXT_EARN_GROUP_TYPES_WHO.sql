--------------------------------------------------------
--  DDL for Trigger HXT_EARN_GROUP_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_EARN_GROUP_TYPES_WHO" 
before insert or update on "HXT"."HXT_EARN_GROUP_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_EARN_GROUP_TYPES_WHO" ENABLE;
