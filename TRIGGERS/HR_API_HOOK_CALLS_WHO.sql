--------------------------------------------------------
--  DDL for Trigger HR_API_HOOK_CALLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_API_HOOK_CALLS_WHO" 
before insert or update on "HR"."HR_API_HOOK_CALLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_API_HOOK_CALLS_WHO" ENABLE;
