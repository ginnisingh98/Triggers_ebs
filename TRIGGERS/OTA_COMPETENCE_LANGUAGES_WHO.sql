--------------------------------------------------------
--  DDL for Trigger OTA_COMPETENCE_LANGUAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_COMPETENCE_LANGUAGES_WHO" 
before insert or update on "OTA"."OTA_COMPETENCE_LANGUAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_COMPETENCE_LANGUAGES_WHO" ENABLE;
