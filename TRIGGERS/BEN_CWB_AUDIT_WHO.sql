--------------------------------------------------------
--  DDL for Trigger BEN_CWB_AUDIT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_AUDIT_WHO" 
before insert or update on "BEN"."BEN_CWB_AUDIT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_AUDIT_WHO" ENABLE;
