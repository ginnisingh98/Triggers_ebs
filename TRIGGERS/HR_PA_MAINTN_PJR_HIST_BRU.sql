--------------------------------------------------------
--  DDL for Trigger HR_PA_MAINTN_PJR_HIST_BRU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PA_MAINTN_PJR_HIST_BRU" 
BEFORE UPDATE OF
 FROM_JOB_ID
,TO_JOB_ID
...
/
ALTER TRIGGER "APPS"."HR_PA_MAINTN_PJR_HIST_BRU" ENABLE;
