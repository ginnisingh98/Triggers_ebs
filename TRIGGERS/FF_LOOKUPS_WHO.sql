--------------------------------------------------------
--  DDL for Trigger FF_LOOKUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_LOOKUPS_WHO" 
before insert or update on "HR"."FF_LOOKUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_LOOKUPS_WHO" ENABLE;
