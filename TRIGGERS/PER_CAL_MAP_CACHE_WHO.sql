--------------------------------------------------------
--  DDL for Trigger PER_CAL_MAP_CACHE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAL_MAP_CACHE_WHO" 
before insert or update on "HR"."PER_CAL_MAP_CACHE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAL_MAP_CACHE_WHO" ENABLE;
