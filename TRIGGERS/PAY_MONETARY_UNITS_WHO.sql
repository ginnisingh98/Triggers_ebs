--------------------------------------------------------
--  DDL for Trigger PAY_MONETARY_UNITS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_MONETARY_UNITS_WHO" 
before insert or update on "HR"."PAY_MONETARY_UNITS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_MONETARY_UNITS_WHO" ENABLE;
