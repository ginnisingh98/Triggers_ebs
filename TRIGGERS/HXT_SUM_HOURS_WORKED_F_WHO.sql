--------------------------------------------------------
--  DDL for Trigger HXT_SUM_HOURS_WORKED_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_SUM_HOURS_WORKED_F_WHO" 
before insert or update on "HXT"."HXT_SUM_HOURS_WORKED_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_SUM_HOURS_WORKED_F_WHO" ENABLE;
