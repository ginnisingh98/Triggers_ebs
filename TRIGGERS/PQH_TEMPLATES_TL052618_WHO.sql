--------------------------------------------------------
--  DDL for Trigger PQH_TEMPLATES_TL052618_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_TEMPLATES_TL052618_WHO" 
before insert or update on "HR"."PQH_TEMPLATES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_TEMPLATES_TL052618_WHO" ENABLE;
