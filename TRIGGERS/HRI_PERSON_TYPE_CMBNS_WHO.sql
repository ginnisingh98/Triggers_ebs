--------------------------------------------------------
--  DDL for Trigger HRI_PERSON_TYPE_CMBNS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_PERSON_TYPE_CMBNS_WHO" 
before insert or update on "HRI"."HRI_PERSON_TYPE_CMBNS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_PERSON_TYPE_CMBNS_WHO" ENABLE;
