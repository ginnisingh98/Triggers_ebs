--------------------------------------------------------
--  DDL for Trigger OTA_CERT_MBR_ENROLLMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CERT_MBR_ENROLLMENTS_WHO" 
before insert or update on "OTA"."OTA_CERT_MBR_ENROLLMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CERT_MBR_ENROLLMENTS_WHO" ENABLE;
