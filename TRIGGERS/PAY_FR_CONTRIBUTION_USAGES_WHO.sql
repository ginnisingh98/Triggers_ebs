--------------------------------------------------------
--  DDL for Trigger PAY_FR_CONTRIBUTION_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_FR_CONTRIBUTION_USAGES_WHO" 
before insert or update on "HR"."PAY_FR_CONTRIBUTION_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_FR_CONTRIBUTION_USAGES_WHO" ENABLE;
