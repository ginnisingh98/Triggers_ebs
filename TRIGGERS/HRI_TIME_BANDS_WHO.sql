--------------------------------------------------------
--  DDL for Trigger HRI_TIME_BANDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_TIME_BANDS_WHO" 
before insert or update on "HRI"."HRI_TIME_BANDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_TIME_BANDS_WHO" ENABLE;
