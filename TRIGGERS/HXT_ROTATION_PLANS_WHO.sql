--------------------------------------------------------
--  DDL for Trigger HXT_ROTATION_PLANS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_ROTATION_PLANS_WHO" 
before insert or update on "HXT"."HXT_ROTATION_PLANS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_ROTATION_PLANS_WHO" ENABLE;
