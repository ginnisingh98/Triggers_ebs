--------------------------------------------------------
--  DDL for Trigger OTA_CONFERENCE_SERVE052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CONFERENCE_SERVE052615_WHO" 
before insert or update on "OTA"."OTA_CONFERENCE_SERVERS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CONFERENCE_SERVE052615_WHO" ENABLE;
