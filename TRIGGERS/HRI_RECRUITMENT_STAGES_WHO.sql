--------------------------------------------------------
--  DDL for Trigger HRI_RECRUITMENT_STAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_RECRUITMENT_STAGES_WHO" 
before insert or update on "HRI"."HRI_RECRUITMENT_STAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_RECRUITMENT_STAGES_WHO" ENABLE;
