--------------------------------------------------------
--  DDL for Trigger HRI_EQ_WRKFC_EVT_MGRH_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_WRKFC_EVT_MGRH_WHO" 
before insert or update on "HRI"."HRI_EQ_WRKFC_EVT_MGRH"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_WRKFC_EVT_MGRH_WHO" ENABLE;
