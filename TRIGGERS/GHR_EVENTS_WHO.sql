--------------------------------------------------------
--  DDL for Trigger GHR_EVENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_EVENTS_WHO" 
before insert or update on "HR"."GHR_EVENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_EVENTS_WHO" ENABLE;
