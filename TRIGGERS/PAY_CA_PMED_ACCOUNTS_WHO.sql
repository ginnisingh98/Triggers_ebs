--------------------------------------------------------
--  DDL for Trigger PAY_CA_PMED_ACCOUNTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_CA_PMED_ACCOUNTS_WHO" 
before insert or update on "HR"."PAY_CA_PMED_ACCOUNTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_CA_PMED_ACCOUNTS_WHO" ENABLE;
