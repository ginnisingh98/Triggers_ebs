--------------------------------------------------------
--  DDL for Trigger BEN_SVC_AREA_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_SVC_AREA_F_WHO" 
before insert or update on "BEN"."BEN_SVC_AREA_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_SVC_AREA_F_WHO" ENABLE;
