--------------------------------------------------------
--  DDL for Trigger BEN_CNTNU_PRTN_CTFN_TYP_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CNTNU_PRTN_CTFN_TYP_F_WHO" 
before insert or update on "BEN"."BEN_CNTNU_PRTN_CTFN_TYP_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CNTNU_PRTN_CTFN_TYP_F_WHO" ENABLE;
