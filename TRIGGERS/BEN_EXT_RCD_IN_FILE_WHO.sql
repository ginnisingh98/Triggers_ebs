--------------------------------------------------------
--  DDL for Trigger BEN_EXT_RCD_IN_FILE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_RCD_IN_FILE_WHO" 
before insert or update on "BEN"."BEN_EXT_RCD_IN_FILE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_RCD_IN_FILE_WHO" ENABLE;
