--------------------------------------------------------
--  DDL for Trigger HRI_EQ_UTL_ABSNC_DIM_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_UTL_ABSNC_DIM_WHO" 
before insert or update on "HRI"."HRI_EQ_UTL_ABSNC_DIM"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_UTL_ABSNC_DIM_WHO" ENABLE;
