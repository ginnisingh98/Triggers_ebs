--------------------------------------------------------
--  DDL for Trigger FEM_DIS_ENTITIES_HIER_DL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_DIS_ENTITIES_HIER_DL" 
instead of delete on FEM_DIS_ENTITIES_HIER_VL
referencing old as FEM_DIS_ENTITIES_HIER_B
for each row
begin
  FEM_DIS_ENTITIES_HIER_PKG.DELETE_ROW(
...
/
ALTER TRIGGER "APPS"."FEM_DIS_ENTITIES_HIER_DL" ENABLE;
