--------------------------------------------------------
--  DDL for Trigger PQP_EXT_CROSS_PERSON_RECOR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_EXT_CROSS_PERSON_RECOR_WHO" 
before insert or update on "HR"."PQP_EXT_CROSS_PERSON_RECORDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_EXT_CROSS_PERSON_RECOR_WHO" ENABLE;
