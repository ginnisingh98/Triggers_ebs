--------------------------------------------------------
--  DDL for Trigger PAY_USER_COLUMNS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_USER_COLUMNS_WHO" 
before insert or update on "HR"."PAY_USER_COLUMNS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_USER_COLUMNS_WHO" ENABLE;
