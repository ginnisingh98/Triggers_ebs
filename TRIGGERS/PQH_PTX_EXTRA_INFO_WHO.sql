--------------------------------------------------------
--  DDL for Trigger PQH_PTX_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_PTX_EXTRA_INFO_WHO" 
before insert or update on "HR"."PQH_PTX_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_PTX_EXTRA_INFO_WHO" ENABLE;
