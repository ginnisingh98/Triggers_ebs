--------------------------------------------------------
--  DDL for Trigger HR_ASSIGNMENT_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ASSIGNMENT_SETS_WHO" 
before insert or update on "HR"."HR_ASSIGNMENT_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ASSIGNMENT_SETS_WHO" ENABLE;
