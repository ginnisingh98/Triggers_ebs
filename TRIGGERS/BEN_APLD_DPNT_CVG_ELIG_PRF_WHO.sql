--------------------------------------------------------
--  DDL for Trigger BEN_APLD_DPNT_CVG_ELIG_PRF_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_APLD_DPNT_CVG_ELIG_PRF_WHO" 
before insert or update on "BEN"."BEN_APLD_DPNT_CVG_ELIG_PRFL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_APLD_DPNT_CVG_ELIG_PRF_WHO" ENABLE;
