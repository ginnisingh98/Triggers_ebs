--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_ENRLD_ANTHR_PLIP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_ENRLD_ANTHR_PLIP_WHO" 
before insert or update on "BEN"."BEN_ELIG_ENRLD_ANTHR_PLIP_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_ENRLD_ANTHR_PLIP_WHO" ENABLE;
