--------------------------------------------------------
--  DDL for Trigger PER_CAL_ENTRY_GEO_LIST_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAL_ENTRY_GEO_LIST_WHO" 
before insert or update on "HR"."PER_CAL_ENTRY_GEO_LIST"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAL_ENTRY_GEO_LIST_WHO" ENABLE;
