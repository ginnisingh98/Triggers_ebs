--------------------------------------------------------
--  DDL for Trigger HXC_ALIAS_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_ALIAS_DEFINITIONS_WHO" 
before insert or update on "HXC"."HXC_ALIAS_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_ALIAS_DEFINITIONS_WHO" ENABLE;
