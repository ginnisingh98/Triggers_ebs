--------------------------------------------------------
--  DDL for Trigger BEN_STARTUP_LERS_TL052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_STARTUP_LERS_TL052615_WHO" 
before insert or update on "BEN"."BEN_STARTUP_LERS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_STARTUP_LERS_TL052615_WHO" ENABLE;
