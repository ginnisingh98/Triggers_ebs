--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_TEMPLATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_TEMPLATES_WHO" 
before insert or update on "HR"."PAY_ELEMENT_TEMPLATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_TEMPLATES_WHO" ENABLE;
