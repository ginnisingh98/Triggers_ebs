--------------------------------------------------------
--  DDL for Trigger BEN_CWB_MGR_HRCHY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_MGR_HRCHY_WHO" 
before insert or update on "BEN"."BEN_CWB_MGR_HRCHY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_MGR_HRCHY_WHO" ENABLE;
