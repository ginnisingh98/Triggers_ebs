--------------------------------------------------------
--  DDL for Trigger PER_CHECKLIST_ITEMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CHECKLIST_ITEMS_WHO" 
before insert or update on "HR"."PER_CHECKLIST_ITEMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CHECKLIST_ITEMS_WHO" ENABLE;
