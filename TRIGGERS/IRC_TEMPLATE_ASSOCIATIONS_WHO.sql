--------------------------------------------------------
--  DDL for Trigger IRC_TEMPLATE_ASSOCIATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_TEMPLATE_ASSOCIATIONS_WHO" 
before insert or update on "HR"."IRC_TEMPLATE_ASSOCIATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_TEMPLATE_ASSOCIATIONS_WHO" ENABLE;
