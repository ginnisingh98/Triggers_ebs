--------------------------------------------------------
--  DDL for Trigger GHR_COMPL_CLAIMS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPL_CLAIMS_WHO" 
before insert or update on "HR"."GHR_COMPL_CLAIMS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPL_CLAIMS_WHO" ENABLE;
