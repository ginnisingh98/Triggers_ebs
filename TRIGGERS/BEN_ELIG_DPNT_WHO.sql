--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_DPNT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_DPNT_WHO" 
before insert or update on "BEN"."BEN_ELIG_DPNT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_DPNT_WHO" ENABLE;
