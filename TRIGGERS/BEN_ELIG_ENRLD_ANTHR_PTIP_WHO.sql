--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_ENRLD_ANTHR_PTIP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_ENRLD_ANTHR_PTIP_WHO" 
before insert or update on "BEN"."BEN_ELIG_ENRLD_ANTHR_PTIP_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_ENRLD_ANTHR_PTIP_WHO" ENABLE;
