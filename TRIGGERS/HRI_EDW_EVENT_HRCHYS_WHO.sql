--------------------------------------------------------
--  DDL for Trigger HRI_EDW_EVENT_HRCHYS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EDW_EVENT_HRCHYS_WHO" 
before insert or update on "HRI"."HRI_EDW_EVENT_HRCHYS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EDW_EVENT_HRCHYS_WHO" ENABLE;
