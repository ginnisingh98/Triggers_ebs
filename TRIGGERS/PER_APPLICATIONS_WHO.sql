--------------------------------------------------------
--  DDL for Trigger PER_APPLICATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_APPLICATIONS_WHO" 
before insert or update on "HR"."PER_APPLICATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_APPLICATIONS_WHO" ENABLE;
