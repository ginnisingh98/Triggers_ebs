--------------------------------------------------------
--  DDL for Trigger HR_QUEST_ANSWERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_QUEST_ANSWERS_WHO" 
before insert or update on "HR"."HR_QUEST_ANSWERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_QUEST_ANSWERS_WHO" ENABLE;
