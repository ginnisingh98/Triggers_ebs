--------------------------------------------------------
--  DDL for Trigger HR_QUEST_FIELDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_QUEST_FIELDS_WHO" 
before insert or update on "HR"."HR_QUEST_FIELDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_QUEST_FIELDS_WHO" ENABLE;
