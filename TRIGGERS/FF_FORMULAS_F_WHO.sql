--------------------------------------------------------
--  DDL for Trigger FF_FORMULAS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_FORMULAS_F_WHO" 
before insert or update on "HR"."FF_FORMULAS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_FORMULAS_F_WHO" ENABLE;
