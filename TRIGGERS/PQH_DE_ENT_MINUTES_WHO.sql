--------------------------------------------------------
--  DDL for Trigger PQH_DE_ENT_MINUTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_ENT_MINUTES_WHO" 
before insert or update on "HR"."PQH_DE_ENT_MINUTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_ENT_MINUTES_WHO" ENABLE;
