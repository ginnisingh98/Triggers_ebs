--------------------------------------------------------
--  DDL for Trigger GHR_PLAN_SERVICE_AREAS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PLAN_SERVICE_AREAS_F_WHO" 
before insert or update on "HR"."GHR_PLAN_SERVICE_AREAS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PLAN_SERVICE_AREAS_F_WHO" ENABLE;
