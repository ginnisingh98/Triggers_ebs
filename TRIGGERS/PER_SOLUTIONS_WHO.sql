--------------------------------------------------------
--  DDL for Trigger PER_SOLUTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SOLUTIONS_WHO" 
before insert or update on "HR"."PER_SOLUTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SOLUTIONS_WHO" ENABLE;
