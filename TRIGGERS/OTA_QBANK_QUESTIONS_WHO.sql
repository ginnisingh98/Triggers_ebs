--------------------------------------------------------
--  DDL for Trigger OTA_QBANK_QUESTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_QBANK_QUESTIONS_WHO" 
before insert or update on "OTA"."OTA_QBANK_QUESTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_QBANK_QUESTIONS_WHO" ENABLE;
