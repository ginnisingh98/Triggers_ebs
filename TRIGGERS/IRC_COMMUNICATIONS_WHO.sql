--------------------------------------------------------
--  DDL for Trigger IRC_COMMUNICATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_COMMUNICATIONS_WHO" 
before insert or update on "HR"."IRC_COMMUNICATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_COMMUNICATIONS_WHO" ENABLE;
