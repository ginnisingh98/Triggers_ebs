--------------------------------------------------------
--  DDL for Trigger PER_PAY_PROPOSALS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PAY_PROPOSALS_WHO" 
before insert or update on "HR"."PER_PAY_PROPOSALS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PAY_PROPOSALS_WHO" ENABLE;
