--------------------------------------------------------
--  DDL for Trigger PAY_USER_COLUMN_INSTANCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_USER_COLUMN_INSTANCES_WHO" 
before insert or update on "HR"."PAY_USER_COLUMN_INSTANCES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_USER_COLUMN_INSTANCES_WHO" ENABLE;
