--------------------------------------------------------
--  DDL for Trigger PAY_TRIGGER_COMPONENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_TRIGGER_COMPONENTS_WHO" 
before insert or update on "HR"."PAY_TRIGGER_COMPONENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_TRIGGER_COMPONENTS_WHO" ENABLE;
