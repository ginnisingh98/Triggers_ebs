--------------------------------------------------------
--  DDL for Trigger PER_ASSIGNMENT_INFO_052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASSIGNMENT_INFO_052616_WHO" 
before insert or update on "HR"."PER_ASSIGNMENT_INFO_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ASSIGNMENT_INFO_052616_WHO" ENABLE;
