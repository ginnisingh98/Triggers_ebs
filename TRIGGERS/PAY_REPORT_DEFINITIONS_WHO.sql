--------------------------------------------------------
--  DDL for Trigger PAY_REPORT_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_REPORT_DEFINITIONS_WHO" 
before insert or update on "HR"."PAY_REPORT_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_REPORT_DEFINITIONS_WHO" ENABLE;
