--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_SUB_CLASSI_RULE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_SUB_CLASSI_RULE_WHO" 
before insert or update on "HR"."PAY_SHADOW_SUB_CLASSI_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_SUB_CLASSI_RULE_WHO" ENABLE;
