--------------------------------------------------------
--  DDL for Trigger SSP_STOPPAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."SSP_STOPPAGES_WHO" 
before insert or update on "SSP"."SSP_STOPPAGES"
for each row
...
/
ALTER TRIGGER "APPS"."SSP_STOPPAGES_WHO" ENABLE;
