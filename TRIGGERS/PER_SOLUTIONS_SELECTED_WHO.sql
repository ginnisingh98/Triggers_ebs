--------------------------------------------------------
--  DDL for Trigger PER_SOLUTIONS_SELECTED_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SOLUTIONS_SELECTED_WHO" 
before insert or update on "HR"."PER_SOLUTIONS_SELECTED"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SOLUTIONS_SELECTED_WHO" ENABLE;
