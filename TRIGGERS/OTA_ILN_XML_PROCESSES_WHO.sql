--------------------------------------------------------
--  DDL for Trigger OTA_ILN_XML_PROCESSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_ILN_XML_PROCESSES_WHO" 
before insert or update on "OTA"."OTA_ILN_XML_PROCESSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_ILN_XML_PROCESSES_WHO" ENABLE;
