--------------------------------------------------------
--  DDL for Trigger IRC_REC_TEAM_MEMBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_REC_TEAM_MEMBERS_WHO" 
before insert or update on "HR"."IRC_REC_TEAM_MEMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_REC_TEAM_MEMBERS_WHO" ENABLE;
