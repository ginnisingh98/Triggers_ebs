--------------------------------------------------------
--  DDL for Trigger PER_GRADE_DEFINITIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_GRADE_DEFINITIONS_WHO" 
before insert or update on "HR"."PER_GRADE_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_GRADE_DEFINITIONS_WHO" ENABLE;
