--------------------------------------------------------
--  DDL for Trigger OTA_BOOKING_STATUS_T052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_BOOKING_STATUS_T052615_WHO" 
before insert or update on "OTA"."OTA_BOOKING_STATUS_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_BOOKING_STATUS_T052615_WHO" ENABLE;
