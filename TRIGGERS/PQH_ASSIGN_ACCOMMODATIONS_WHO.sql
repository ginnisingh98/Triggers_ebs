--------------------------------------------------------
--  DDL for Trigger PQH_ASSIGN_ACCOMMODATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ASSIGN_ACCOMMODATIONS_WHO" 
before insert or update on "HR"."PQH_ASSIGN_ACCOMMODATIONS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ASSIGN_ACCOMMODATIONS_WHO" ENABLE;
