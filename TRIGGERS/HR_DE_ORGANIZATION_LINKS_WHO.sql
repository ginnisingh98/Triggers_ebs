--------------------------------------------------------
--  DDL for Trigger HR_DE_ORGANIZATION_LINKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DE_ORGANIZATION_LINKS_WHO" 
before insert or update on "HR"."HR_DE_ORGANIZATION_LINKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DE_ORGANIZATION_LINKS_WHO" ENABLE;
