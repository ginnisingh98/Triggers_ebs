--------------------------------------------------------
--  DDL for Trigger PER_ASS_STATUS_TYPE_AMENDS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASS_STATUS_TYPE_AMENDS_WHO" 
before insert or update on "HR"."PER_ASS_STATUS_TYPE_AMENDS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ASS_STATUS_TYPE_AMENDS_WHO" ENABLE;
