--------------------------------------------------------
--  DDL for Trigger BEN_STARTUP_ACTN_TYP052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_STARTUP_ACTN_TYP052616_WHO" 
before insert or update on "BEN"."BEN_STARTUP_ACTN_TYP_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_STARTUP_ACTN_TYP052616_WHO" ENABLE;
