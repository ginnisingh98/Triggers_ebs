--------------------------------------------------------
--  DDL for Trigger HRI_ADM_DGNSTC_SBSCRB_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_ADM_DGNSTC_SBSCRB_WHO" 
before insert or update on "HRI"."HRI_ADM_DGNSTC_SBSCRB"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_ADM_DGNSTC_SBSCRB_WHO" ENABLE;
