--------------------------------------------------------
--  DDL for Trigger OTA_NOTRNG_HISTORIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_NOTRNG_HISTORIES_WHO" 
before insert or update on "OTA"."OTA_NOTRNG_HISTORIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_NOTRNG_HISTORIES_WHO" ENABLE;
