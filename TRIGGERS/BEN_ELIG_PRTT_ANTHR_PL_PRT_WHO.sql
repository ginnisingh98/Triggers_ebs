--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_PRTT_ANTHR_PL_PRT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_PRTT_ANTHR_PL_PRT_WHO" 
before insert or update on "BEN"."BEN_ELIG_PRTT_ANTHR_PL_PRTE_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_PRTT_ANTHR_PL_PRT_WHO" ENABLE;
