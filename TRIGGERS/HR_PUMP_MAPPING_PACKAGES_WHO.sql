--------------------------------------------------------
--  DDL for Trigger HR_PUMP_MAPPING_PACKAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PUMP_MAPPING_PACKAGES_WHO" 
before insert or update on "HR"."HR_PUMP_MAPPING_PACKAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PUMP_MAPPING_PACKAGES_WHO" ENABLE;
