--------------------------------------------------------
--  DDL for Trigger PAY_AU_PROCESS_PARAMETERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_AU_PROCESS_PARAMETERS_WHO" 
before insert or update on "HR"."PAY_AU_PROCESS_PARAMETERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_AU_PROCESS_PARAMETERS_WHO" ENABLE;
