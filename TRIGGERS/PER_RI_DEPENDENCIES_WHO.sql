--------------------------------------------------------
--  DDL for Trigger PER_RI_DEPENDENCIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_DEPENDENCIES_WHO" 
before insert or update on "HR"."PER_RI_DEPENDENCIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_DEPENDENCIES_WHO" ENABLE;
