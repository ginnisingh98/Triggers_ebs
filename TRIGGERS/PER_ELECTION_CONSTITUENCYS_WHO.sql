--------------------------------------------------------
--  DDL for Trigger PER_ELECTION_CONSTITUENCYS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ELECTION_CONSTITUENCYS_WHO" 
before insert or update on "HR"."PER_ELECTION_CONSTITUENCYS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ELECTION_CONSTITUENCYS_WHO" ENABLE;
