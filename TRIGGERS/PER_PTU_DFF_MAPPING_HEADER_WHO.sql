--------------------------------------------------------
--  DDL for Trigger PER_PTU_DFF_MAPPING_HEADER_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PTU_DFF_MAPPING_HEADER_WHO" 
before insert or update on "HR"."PER_PTU_DFF_MAPPING_HEADERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PTU_DFF_MAPPING_HEADER_WHO" ENABLE;
