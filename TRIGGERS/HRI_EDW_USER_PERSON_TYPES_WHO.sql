--------------------------------------------------------
--  DDL for Trigger HRI_EDW_USER_PERSON_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EDW_USER_PERSON_TYPES_WHO" 
before insert or update on "HRI"."HRI_EDW_USER_PERSON_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EDW_USER_PERSON_TYPES_WHO" ENABLE;
