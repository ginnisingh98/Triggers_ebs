--------------------------------------------------------
--  DDL for Trigger HR_DM_MIGRATION_REQUESTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_MIGRATION_REQUESTS_WHO" 
before insert or update on "HR"."HR_DM_MIGRATION_REQUESTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_MIGRATION_REQUESTS_WHO" ENABLE;
