--------------------------------------------------------
--  DDL for Trigger PAY_US_CONTRIBUTION_HISTOR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_US_CONTRIBUTION_HISTOR_WHO" 
before insert or update on "HR"."PAY_US_CONTRIBUTION_HISTORY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_US_CONTRIBUTION_HISTOR_WHO" ENABLE;
