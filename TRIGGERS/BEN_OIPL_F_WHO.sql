--------------------------------------------------------
--  DDL for Trigger BEN_OIPL_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_OIPL_F_WHO" 
before insert or update on "BEN"."BEN_OIPL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_OIPL_F_WHO" ENABLE;
