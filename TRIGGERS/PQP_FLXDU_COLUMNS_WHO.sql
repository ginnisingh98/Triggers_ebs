--------------------------------------------------------
--  DDL for Trigger PQP_FLXDU_COLUMNS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_FLXDU_COLUMNS_WHO" 
before insert or update on "HR"."PQP_FLXDU_COLUMNS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_FLXDU_COLUMNS_WHO" ENABLE;
