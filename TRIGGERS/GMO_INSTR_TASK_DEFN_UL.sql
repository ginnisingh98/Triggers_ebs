--------------------------------------------------------
--  DDL for Trigger GMO_INSTR_TASK_DEFN_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GMO_INSTR_TASK_DEFN_UL" 
/* $Header: GMOTSKUT.sql 120.0.12000000.2 2007/03/14 11:58:49 rvsingh ship $ */

instead of update on GMO_INSTR_TASK_DEFN_VL
referencing new as GMO_INSTR_TASK_DEFN_B
for each row
begin
  GMO_INSTR_TASK_DEFN_PKG.UPDATE_ROW(
...
/
ALTER TRIGGER "APPS"."GMO_INSTR_TASK_DEFN_UL" ENABLE;
