--------------------------------------------------------
--  DDL for Trigger BEN_PCT_FL_TM_RT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PCT_FL_TM_RT_F_WHO" 
before insert or update on "BEN"."BEN_PCT_FL_TM_RT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PCT_FL_TM_RT_F_WHO" ENABLE;
