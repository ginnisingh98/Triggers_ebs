--------------------------------------------------------
--  DDL for Trigger OTA_PROGRAM_MEMBERSHIPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_PROGRAM_MEMBERSHIPS_WHO" 
before insert or update on "OTA"."OTA_PROGRAM_MEMBERSHIPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_PROGRAM_MEMBERSHIPS_WHO" ENABLE;
