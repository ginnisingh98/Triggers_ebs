--------------------------------------------------------
--  DDL for Trigger PER_DRT_COL_CONTEXTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_DRT_COL_CONTEXTS_WHO" 
before insert or update on "HR"."PER_DRT_COL_CONTEXTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_DRT_COL_CONTEXTS_WHO" ENABLE;
