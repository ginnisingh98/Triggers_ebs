--------------------------------------------------------
--  DDL for Trigger PER_QUICKPAINT_INVOCATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_QUICKPAINT_INVOCATIONS_WHO" 
before insert or update on "HR"."PER_QUICKPAINT_INVOCATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_QUICKPAINT_INVOCATIONS_WHO" ENABLE;
