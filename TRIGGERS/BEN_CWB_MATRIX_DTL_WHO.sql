--------------------------------------------------------
--  DDL for Trigger BEN_CWB_MATRIX_DTL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_MATRIX_DTL_WHO" 
before insert or update on "BEN"."BEN_CWB_MATRIX_DTL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_MATRIX_DTL_WHO" ENABLE;
