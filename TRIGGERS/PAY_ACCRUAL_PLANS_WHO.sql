--------------------------------------------------------
--  DDL for Trigger PAY_ACCRUAL_PLANS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ACCRUAL_PLANS_WHO" 
before insert or update on "HR"."PAY_ACCRUAL_PLANS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ACCRUAL_PLANS_WHO" ENABLE;
