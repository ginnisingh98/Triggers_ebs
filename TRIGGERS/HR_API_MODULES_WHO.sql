--------------------------------------------------------
--  DDL for Trigger HR_API_MODULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_API_MODULES_WHO" 
before insert or update on "HR"."HR_API_MODULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_API_MODULES_WHO" ENABLE;
