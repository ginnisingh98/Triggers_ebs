--------------------------------------------------------
--  DDL for Trigger PER_BOOKINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_BOOKINGS_WHO" 
before insert or update on "HR"."PER_BOOKINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_BOOKINGS_WHO" ENABLE;
