--------------------------------------------------------
--  DDL for Trigger BEN_BENEFIT_CLASSIFICATION_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_BENEFIT_CLASSIFICATION_WHO" 
before insert or update on "HR"."BEN_BENEFIT_CLASSIFICATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_BENEFIT_CLASSIFICATION_WHO" ENABLE;
