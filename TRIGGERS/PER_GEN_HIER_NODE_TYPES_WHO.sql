--------------------------------------------------------
--  DDL for Trigger PER_GEN_HIER_NODE_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_GEN_HIER_NODE_TYPES_WHO" 
before insert or update on "HR"."PER_GEN_HIER_NODE_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_GEN_HIER_NODE_TYPES_WHO" ENABLE;
