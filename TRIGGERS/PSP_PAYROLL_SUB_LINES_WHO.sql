--------------------------------------------------------
--  DDL for Trigger PSP_PAYROLL_SUB_LINES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_PAYROLL_SUB_LINES_WHO" 
before insert or update on "PSP"."PSP_PAYROLL_SUB_LINES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_PAYROLL_SUB_LINES_WHO" ENABLE;
