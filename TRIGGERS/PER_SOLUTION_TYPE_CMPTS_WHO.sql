--------------------------------------------------------
--  DDL for Trigger PER_SOLUTION_TYPE_CMPTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SOLUTION_TYPE_CMPTS_WHO" 
before insert or update on "HR"."PER_SOLUTION_TYPE_CMPTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SOLUTION_TYPE_CMPTS_WHO" ENABLE;
