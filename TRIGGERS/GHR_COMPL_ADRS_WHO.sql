--------------------------------------------------------
--  DDL for Trigger GHR_COMPL_ADRS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPL_ADRS_WHO" 
before insert or update on "HR"."GHR_COMPL_ADRS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPL_ADRS_WHO" ENABLE;
