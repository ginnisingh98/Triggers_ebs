--------------------------------------------------------
--  DDL for Trigger JAI_OE_OHA_ARIUD_T1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."JAI_OE_OHA_ARIUD_T1" 
AFTER INSERT OR UPDATE OR DELETE ON "ONT"."OE_ORDER_HEADERS_ALL"
for each row
DECLARE
...
/
ALTER TRIGGER "APPS"."JAI_OE_OHA_ARIUD_T1" DISABLE;
