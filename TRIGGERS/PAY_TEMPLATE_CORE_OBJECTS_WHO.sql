--------------------------------------------------------
--  DDL for Trigger PAY_TEMPLATE_CORE_OBJECTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_TEMPLATE_CORE_OBJECTS_WHO" 
before insert or update on "HR"."PAY_TEMPLATE_CORE_OBJECTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_TEMPLATE_CORE_OBJECTS_WHO" ENABLE;
