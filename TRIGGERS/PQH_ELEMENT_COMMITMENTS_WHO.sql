--------------------------------------------------------
--  DDL for Trigger PQH_ELEMENT_COMMITMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ELEMENT_COMMITMENTS_WHO" 
before insert or update on "HR"."PQH_ELEMENT_COMMITMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ELEMENT_COMMITMENTS_WHO" ENABLE;
