--------------------------------------------------------
--  DDL for Trigger BEN_EXT_DFN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_DFN_WHO" 
before insert or update on "BEN"."BEN_EXT_DFN"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_DFN_WHO" ENABLE;
