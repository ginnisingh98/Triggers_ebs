--------------------------------------------------------
--  DDL for Trigger PQP_CONFIGURATION_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_CONFIGURATION_TYPES_WHO" 
before insert or update on "HR"."PQP_CONFIGURATION_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_CONFIGURATION_TYPES_WHO" ENABLE;
