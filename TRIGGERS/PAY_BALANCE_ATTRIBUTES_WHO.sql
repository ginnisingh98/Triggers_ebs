--------------------------------------------------------
--  DDL for Trigger PAY_BALANCE_ATTRIBUTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_BALANCE_ATTRIBUTES_WHO" 
before insert or update on "HR"."PAY_BALANCE_ATTRIBUTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_BALANCE_ATTRIBUTES_WHO" ENABLE;
