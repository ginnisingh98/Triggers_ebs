--------------------------------------------------------
--  DDL for Trigger PSP_GROUP_ELEMENT_LIST_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_GROUP_ELEMENT_LIST_WHO" 
before insert or update on "PSP"."PSP_GROUP_ELEMENT_LIST"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_GROUP_ELEMENT_LIST_WHO" ENABLE;
