--------------------------------------------------------
--  DDL for Trigger IGI_BUD_JOURNAL_PERIODS_T2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IGI_BUD_JOURNAL_PERIODS_T2" 
AFTER UPDATE ON "IGI"."IGI_BUD_JOURNAL_PERIODS"
FOR EACH ROW
...
/
ALTER TRIGGER "APPS"."IGI_BUD_JOURNAL_PERIODS_T2" ENABLE;
