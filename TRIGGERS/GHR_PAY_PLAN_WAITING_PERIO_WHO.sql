--------------------------------------------------------
--  DDL for Trigger GHR_PAY_PLAN_WAITING_PERIO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PAY_PLAN_WAITING_PERIO_WHO" 
before insert or update on "HR"."GHR_PAY_PLAN_WAITING_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PAY_PLAN_WAITING_PERIO_WHO" ENABLE;
