--------------------------------------------------------
--  DDL for Trigger BEN_BNFT_PRVDR_POOL_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_BNFT_PRVDR_POOL_F_WHO" 
before insert or update on "BEN"."BEN_BNFT_PRVDR_POOL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_BNFT_PRVDR_POOL_F_WHO" ENABLE;
