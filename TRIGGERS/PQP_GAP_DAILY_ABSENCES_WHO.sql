--------------------------------------------------------
--  DDL for Trigger PQP_GAP_DAILY_ABSENCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_GAP_DAILY_ABSENCES_WHO" 
before insert or update on "HR"."PQP_GAP_DAILY_ABSENCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_GAP_DAILY_ABSENCES_WHO" ENABLE;
