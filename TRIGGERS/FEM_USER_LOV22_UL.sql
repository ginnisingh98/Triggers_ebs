--------------------------------------------------------
--  DDL for Trigger FEM_USER_LOV22_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_LOV22_UL" 
instead of update on FEM_USER_LOV22_VL
...
/
ALTER TRIGGER "APPS"."FEM_USER_LOV22_UL" ENABLE;
