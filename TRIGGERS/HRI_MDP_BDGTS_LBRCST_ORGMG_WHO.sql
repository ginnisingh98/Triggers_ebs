--------------------------------------------------------
--  DDL for Trigger HRI_MDP_BDGTS_LBRCST_ORGMG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_MDP_BDGTS_LBRCST_ORGMG_WHO" 
before insert or update on "HRI"."HRI_MDP_BDGTS_LBRCST_ORGMGR_CT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_MDP_BDGTS_LBRCST_ORGMG_WHO" ENABLE;
