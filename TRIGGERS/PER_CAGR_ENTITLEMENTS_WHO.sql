--------------------------------------------------------
--  DDL for Trigger PER_CAGR_ENTITLEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_ENTITLEMENTS_WHO" 
before insert or update on "HR"."PER_CAGR_ENTITLEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_ENTITLEMENTS_WHO" ENABLE;
