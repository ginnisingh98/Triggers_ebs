--------------------------------------------------------
--  DDL for Trigger PER_PAY_PROPOSAL_COMPONENT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PAY_PROPOSAL_COMPONENT_WHO" 
before insert or update on "HR"."PER_PAY_PROPOSAL_COMPONENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PAY_PROPOSAL_COMPONENT_WHO" ENABLE;
