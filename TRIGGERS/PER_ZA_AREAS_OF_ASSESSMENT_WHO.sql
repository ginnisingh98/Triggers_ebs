--------------------------------------------------------
--  DDL for Trigger PER_ZA_AREAS_OF_ASSESSMENT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ZA_AREAS_OF_ASSESSMENT_WHO" 
before insert or update on "HR"."PER_ZA_AREAS_OF_ASSESSMENT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ZA_AREAS_OF_ASSESSMENT_WHO" ENABLE;
