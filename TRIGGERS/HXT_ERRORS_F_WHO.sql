--------------------------------------------------------
--  DDL for Trigger HXT_ERRORS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_ERRORS_F_WHO" 
before insert or update on "HXT"."HXT_ERRORS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_ERRORS_F_WHO" ENABLE;
