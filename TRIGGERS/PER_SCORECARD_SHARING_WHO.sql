--------------------------------------------------------
--  DDL for Trigger PER_SCORECARD_SHARING_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SCORECARD_SHARING_WHO" 
before insert or update on "HR"."PER_SCORECARD_SHARING"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SCORECARD_SHARING_WHO" ENABLE;
