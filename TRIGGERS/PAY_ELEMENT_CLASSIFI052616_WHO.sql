--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_CLASSIFI052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_CLASSIFI052616_WHO" 
before insert or update on "HR"."PAY_ELEMENT_CLASSIFICATIONS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_CLASSIFI052616_WHO" ENABLE;
