--------------------------------------------------------
--  DDL for Trigger PQH_TRANSACTION_CATEGORIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_TRANSACTION_CATEGORIES_WHO" 
before insert or update on "HR"."PQH_TRANSACTION_CATEGORIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_TRANSACTION_CATEGORIES_WHO" ENABLE;
