--------------------------------------------------------
--  DDL for Trigger BEN_PYMT_CHECK_DET_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PYMT_CHECK_DET_WHO" 
before insert or update on "BEN"."BEN_PYMT_CHECK_DET"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PYMT_CHECK_DET_WHO" ENABLE;
