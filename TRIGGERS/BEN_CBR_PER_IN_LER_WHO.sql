--------------------------------------------------------
--  DDL for Trigger BEN_CBR_PER_IN_LER_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CBR_PER_IN_LER_WHO" 
before insert or update on "BEN"."BEN_CBR_PER_IN_LER"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CBR_PER_IN_LER_WHO" ENABLE;
