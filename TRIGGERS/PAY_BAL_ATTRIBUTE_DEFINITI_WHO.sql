--------------------------------------------------------
--  DDL for Trigger PAY_BAL_ATTRIBUTE_DEFINITI_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_BAL_ATTRIBUTE_DEFINITI_WHO" 
before insert or update on "HR"."PAY_BAL_ATTRIBUTE_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_BAL_ATTRIBUTE_DEFINITI_WHO" ENABLE;
