--------------------------------------------------------
--  DDL for Trigger HXC_ALIAS_DEFINITION052614_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_ALIAS_DEFINITION052614_WHO" 
before insert or update on "HXC"."HXC_ALIAS_DEFINITIONS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_ALIAS_DEFINITION052614_WHO" ENABLE;
