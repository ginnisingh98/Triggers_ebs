--------------------------------------------------------
--  DDL for Trigger PAY_UPGRADE_LEGISLATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_UPGRADE_LEGISLATIONS_WHO" 
before insert or update on "HR"."PAY_UPGRADE_LEGISLATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_UPGRADE_LEGISLATIONS_WHO" ENABLE;
