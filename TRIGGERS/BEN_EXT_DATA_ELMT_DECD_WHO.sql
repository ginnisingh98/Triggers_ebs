--------------------------------------------------------
--  DDL for Trigger BEN_EXT_DATA_ELMT_DECD_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_DATA_ELMT_DECD_WHO" 
before insert or update on "BEN"."BEN_EXT_DATA_ELMT_DECD"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_DATA_ELMT_DECD_WHO" ENABLE;
