--------------------------------------------------------
--  DDL for Trigger BEN_EXT_RSLT_ERR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_RSLT_ERR_WHO" 
before insert or update on "BEN"."BEN_EXT_RSLT_ERR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_RSLT_ERR_WHO" ENABLE;
