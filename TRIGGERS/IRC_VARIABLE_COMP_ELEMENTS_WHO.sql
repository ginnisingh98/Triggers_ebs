--------------------------------------------------------
--  DDL for Trigger IRC_VARIABLE_COMP_ELEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_VARIABLE_COMP_ELEMENTS_WHO" 
before insert or update on "HR"."IRC_VARIABLE_COMP_ELEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_VARIABLE_COMP_ELEMENTS_WHO" ENABLE;
