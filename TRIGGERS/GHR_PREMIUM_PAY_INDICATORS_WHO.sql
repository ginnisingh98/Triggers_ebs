--------------------------------------------------------
--  DDL for Trigger GHR_PREMIUM_PAY_INDICATORS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PREMIUM_PAY_INDICATORS_WHO" 
before insert or update on "HR"."GHR_PREMIUM_PAY_INDICATORS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PREMIUM_PAY_INDICATORS_WHO" ENABLE;
