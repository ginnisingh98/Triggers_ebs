--------------------------------------------------------
--  DDL for Trigger PSP_LAYOUT_OPTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_LAYOUT_OPTIONS_WHO" 
before insert or update on "PSP"."PSP_LAYOUT_OPTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_LAYOUT_OPTIONS_WHO" ENABLE;
