--------------------------------------------------------
--  DDL for Trigger PAY_REPORT_FORMAT_PARAMETE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_REPORT_FORMAT_PARAMETE_WHO" 
before insert or update on "HR"."PAY_REPORT_FORMAT_PARAMETERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_REPORT_FORMAT_PARAMETE_WHO" ENABLE;
