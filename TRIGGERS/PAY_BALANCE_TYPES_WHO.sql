--------------------------------------------------------
--  DDL for Trigger PAY_BALANCE_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_BALANCE_TYPES_WHO" 
before insert or update on "HR"."PAY_BALANCE_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_BALANCE_TYPES_WHO" ENABLE;
