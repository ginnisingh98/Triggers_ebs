--------------------------------------------------------
--  DDL for Trigger PQH_WORKSHEET_PERIODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_WORKSHEET_PERIODS_WHO" 
before insert or update on "HR"."PQH_WORKSHEET_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_WORKSHEET_PERIODS_WHO" ENABLE;
