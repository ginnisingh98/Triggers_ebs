--------------------------------------------------------
--  DDL for Trigger PQH_TABLE_ROUTE_TL052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_TABLE_ROUTE_TL052617_WHO" 
before insert or update on "HR"."PQH_TABLE_ROUTE_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_TABLE_ROUTE_TL052617_WHO" ENABLE;
