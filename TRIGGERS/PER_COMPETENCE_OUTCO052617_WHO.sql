--------------------------------------------------------
--  DDL for Trigger PER_COMPETENCE_OUTCO052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COMPETENCE_OUTCO052617_WHO" 
before insert or update on "HR"."PER_COMPETENCE_OUTCOMES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COMPETENCE_OUTCO052617_WHO" ENABLE;
