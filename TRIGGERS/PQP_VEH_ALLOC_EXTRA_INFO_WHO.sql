--------------------------------------------------------
--  DDL for Trigger PQP_VEH_ALLOC_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_VEH_ALLOC_EXTRA_INFO_WHO" 
before insert or update on "HR"."PQP_VEH_ALLOC_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_VEH_ALLOC_EXTRA_INFO_WHO" ENABLE;
