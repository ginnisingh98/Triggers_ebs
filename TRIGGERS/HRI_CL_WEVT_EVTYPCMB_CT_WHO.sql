--------------------------------------------------------
--  DDL for Trigger HRI_CL_WEVT_EVTYPCMB_CT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_CL_WEVT_EVTYPCMB_CT_WHO" 
before insert or update on "HRI"."HRI_CL_WEVT_EVTYPCMB_CT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_CL_WEVT_EVTYPCMB_CT_WHO" ENABLE;
