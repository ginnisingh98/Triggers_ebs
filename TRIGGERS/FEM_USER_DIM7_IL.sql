--------------------------------------------------------
--  DDL for Trigger FEM_USER_DIM7_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_DIM7_IL" 
instead of insert on FEM_USER_DIM7_VL
...
begin
  FEM_USER_DIM7_PKG.INSERT_ROW(
    ...
    X_CREATION_DATE => :FEM_USER_DIM7_B.CREATION_DATE,
    X_CREATED_BY => :FEM_USER_DIM7_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_USER_DIM7_IL" ENABLE;
