--------------------------------------------------------
--  DDL for Trigger PAY_DIMENSION_ROUTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_DIMENSION_ROUTES_WHO" 
before insert or update on "HR"."PAY_DIMENSION_ROUTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_DIMENSION_ROUTES_WHO" ENABLE;
