--------------------------------------------------------
--  DDL for Trigger GHR_MTS_TEMP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_MTS_TEMP_WHO" 
before insert or update on "HR"."GHR_MTS_TEMP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_MTS_TEMP_WHO" ENABLE;
