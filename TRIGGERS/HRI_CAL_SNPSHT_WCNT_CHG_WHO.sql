--------------------------------------------------------
--  DDL for Trigger HRI_CAL_SNPSHT_WCNT_CHG_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_CAL_SNPSHT_WCNT_CHG_WHO" 
before insert or update on "HRI"."HRI_CAL_SNPSHT_WCNT_CHG"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_CAL_SNPSHT_WCNT_CHG_WHO" ENABLE;
