--------------------------------------------------------
--  DDL for Trigger HRI_SUPH_PRC_ACTIONS_TMP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_SUPH_PRC_ACTIONS_TMP_WHO" 
before insert or update on "HRI"."HRI_SUPH_PRC_ACTIONS_TMP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_SUPH_PRC_ACTIONS_TMP_WHO" ENABLE;
