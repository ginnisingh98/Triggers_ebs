--------------------------------------------------------
--  DDL for Trigger BEN_REGN_FOR_REGY_BODY_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_REGN_FOR_REGY_BODY_F_WHO" 
before insert or update on "BEN"."BEN_REGN_FOR_REGY_BODY_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_REGN_FOR_REGY_BODY_F_WHO" ENABLE;
