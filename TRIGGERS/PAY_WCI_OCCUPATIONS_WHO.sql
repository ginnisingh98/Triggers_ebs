--------------------------------------------------------
--  DDL for Trigger PAY_WCI_OCCUPATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_WCI_OCCUPATIONS_WHO" 
before insert or update on "HR"."PAY_WCI_OCCUPATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_WCI_OCCUPATIONS_WHO" ENABLE;
