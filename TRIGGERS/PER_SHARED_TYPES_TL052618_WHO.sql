--------------------------------------------------------
--  DDL for Trigger PER_SHARED_TYPES_TL052618_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SHARED_TYPES_TL052618_WHO" 
before insert or update on "HR"."PER_SHARED_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SHARED_TYPES_TL052618_WHO" ENABLE;
