--------------------------------------------------------
--  DDL for Trigger PAY_PERSONAL_PAYMENT_METHO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_PERSONAL_PAYMENT_METHO_WHO" 
before insert or update on "HR"."PAY_PERSONAL_PAYMENT_METHODS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_PERSONAL_PAYMENT_METHO_WHO" ENABLE;
