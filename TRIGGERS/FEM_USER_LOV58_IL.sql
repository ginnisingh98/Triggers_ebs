--------------------------------------------------------
--  DDL for Trigger FEM_USER_LOV58_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_LOV58_IL" 
instead of insert on FEM_USER_LOV58_VL
...
begin
  FEM_USER_LOV58_PKG.INSERT_ROW(
    ...
    X_CREATION_DATE => :FEM_USER_LOV58_B.CREATION_DATE,
    X_CREATED_BY => :FEM_USER_LOV58_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_USER_LOV58_IL" ENABLE;
