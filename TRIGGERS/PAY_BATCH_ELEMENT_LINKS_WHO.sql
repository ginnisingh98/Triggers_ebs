--------------------------------------------------------
--  DDL for Trigger PAY_BATCH_ELEMENT_LINKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_BATCH_ELEMENT_LINKS_WHO" 
before insert or update on "HR"."PAY_BATCH_ELEMENT_LINKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_BATCH_ELEMENT_LINKS_WHO" ENABLE;
