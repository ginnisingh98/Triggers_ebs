--------------------------------------------------------
--  DDL for Trigger PER_RI_CONFIG_RESPONSIBILI_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_CONFIG_RESPONSIBILI_WHO" 
before insert or update on "HR"."PER_RI_CONFIG_RESPONSIBILITY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_CONFIG_RESPONSIBILI_WHO" ENABLE;
