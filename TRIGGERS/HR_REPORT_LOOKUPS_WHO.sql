--------------------------------------------------------
--  DDL for Trigger HR_REPORT_LOOKUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_REPORT_LOOKUPS_WHO" 
before insert or update on "HR"."HR_REPORT_LOOKUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_REPORT_LOOKUPS_WHO" ENABLE;
