--------------------------------------------------------
--  DDL for Trigger PSP_CLEARING_ACCOUNT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_CLEARING_ACCOUNT_WHO" 
before insert or update on "PSP"."PSP_CLEARING_ACCOUNT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_CLEARING_ACCOUNT_WHO" ENABLE;
