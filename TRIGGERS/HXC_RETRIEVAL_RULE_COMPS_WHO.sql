--------------------------------------------------------
--  DDL for Trigger HXC_RETRIEVAL_RULE_COMPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_RETRIEVAL_RULE_COMPS_WHO" 
before insert or update on "HXC"."HXC_RETRIEVAL_RULE_COMPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_RETRIEVAL_RULE_COMPS_WHO" ENABLE;
