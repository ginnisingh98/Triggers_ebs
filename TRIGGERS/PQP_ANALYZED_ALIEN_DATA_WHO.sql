--------------------------------------------------------
--  DDL for Trigger PQP_ANALYZED_ALIEN_DATA_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_ANALYZED_ALIEN_DATA_WHO" 
before insert or update on "HR"."PQP_ANALYZED_ALIEN_DATA"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_ANALYZED_ALIEN_DATA_WHO" ENABLE;
