--------------------------------------------------------
--  DDL for Trigger PQH_PTX_DPF_DF_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_PTX_DPF_DF_WHO" 
before insert or update on "HR"."PQH_PTX_DPF_DF"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_PTX_DPF_DF_WHO" ENABLE;
