--------------------------------------------------------
--  DDL for Trigger BEN_CWB_WKSHT_GRP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_WKSHT_GRP_WHO" 
before insert or update on "BEN"."BEN_CWB_WKSHT_GRP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_WKSHT_GRP_WHO" ENABLE;
