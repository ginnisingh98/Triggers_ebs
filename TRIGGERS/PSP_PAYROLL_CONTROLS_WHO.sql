--------------------------------------------------------
--  DDL for Trigger PSP_PAYROLL_CONTROLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_PAYROLL_CONTROLS_WHO" 
before insert or update on "PSP"."PSP_PAYROLL_CONTROLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_PAYROLL_CONTROLS_WHO" ENABLE;
