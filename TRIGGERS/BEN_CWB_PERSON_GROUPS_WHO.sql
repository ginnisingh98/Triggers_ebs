--------------------------------------------------------
--  DDL for Trigger BEN_CWB_PERSON_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_PERSON_GROUPS_WHO" 
before insert or update on "BEN"."BEN_CWB_PERSON_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_PERSON_GROUPS_WHO" ENABLE;
