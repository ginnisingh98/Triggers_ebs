--------------------------------------------------------
--  DDL for Trigger HR_PA_MAINTN_ALLORG_HIST_BRI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PA_MAINTN_ALLORG_HIST_BRI" 
-- $Header: pahraorg.sql 120.2 2005/11/30 01:54:51 vkadimes ship $
BEFORE INSERT
...
/
ALTER TRIGGER "APPS"."HR_PA_MAINTN_ALLORG_HIST_BRI" ENABLE;
