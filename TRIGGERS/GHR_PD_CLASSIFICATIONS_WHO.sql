--------------------------------------------------------
--  DDL for Trigger GHR_PD_CLASSIFICATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PD_CLASSIFICATIONS_WHO" 
before insert or update on "HR"."GHR_PD_CLASSIFICATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PD_CLASSIFICATIONS_WHO" ENABLE;
