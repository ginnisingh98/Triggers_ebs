--------------------------------------------------------
--  DDL for Trigger HR_DM_HIERARCHIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_HIERARCHIES_WHO" 
before insert or update on "HR"."HR_DM_HIERARCHIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_HIERARCHIES_WHO" ENABLE;
