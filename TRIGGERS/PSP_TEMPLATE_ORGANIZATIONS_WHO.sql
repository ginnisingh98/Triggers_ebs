--------------------------------------------------------
--  DDL for Trigger PSP_TEMPLATE_ORGANIZATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_TEMPLATE_ORGANIZATIONS_WHO" 
before insert or update on "PSP"."PSP_TEMPLATE_ORGANIZATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_TEMPLATE_ORGANIZATIONS_WHO" ENABLE;
