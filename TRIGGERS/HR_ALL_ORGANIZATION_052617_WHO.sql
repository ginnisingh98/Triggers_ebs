--------------------------------------------------------
--  DDL for Trigger HR_ALL_ORGANIZATION_052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ALL_ORGANIZATION_052617_WHO" 
before insert or update on "HR"."HR_ALL_ORGANIZATION_UNITS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ALL_ORGANIZATION_052617_WHO" ENABLE;
