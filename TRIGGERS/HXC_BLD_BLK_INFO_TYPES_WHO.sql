--------------------------------------------------------
--  DDL for Trigger HXC_BLD_BLK_INFO_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_BLD_BLK_INFO_TYPES_WHO" 
before insert or update on "HXC"."HXC_BLD_BLK_INFO_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_BLD_BLK_INFO_TYPES_WHO" ENABLE;
