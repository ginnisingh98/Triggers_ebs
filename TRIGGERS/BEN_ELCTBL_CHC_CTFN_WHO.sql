--------------------------------------------------------
--  DDL for Trigger BEN_ELCTBL_CHC_CTFN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELCTBL_CHC_CTFN_WHO" 
before insert or update on "BEN"."BEN_ELCTBL_CHC_CTFN"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELCTBL_CHC_CTFN_WHO" ENABLE;
