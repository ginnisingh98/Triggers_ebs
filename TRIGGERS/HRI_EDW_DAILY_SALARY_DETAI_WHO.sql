--------------------------------------------------------
--  DDL for Trigger HRI_EDW_DAILY_SALARY_DETAI_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EDW_DAILY_SALARY_DETAI_WHO" 
before insert or update on "HRI"."HRI_EDW_DAILY_SALARY_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EDW_DAILY_SALARY_DETAI_WHO" ENABLE;
