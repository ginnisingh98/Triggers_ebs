--------------------------------------------------------
--  DDL for Trigger BEN_OPT_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_OPT_EXTRA_INFO_WHO" 
before insert or update on "BEN"."BEN_OPT_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_OPT_EXTRA_INFO_WHO" ENABLE;
