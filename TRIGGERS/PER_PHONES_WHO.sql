--------------------------------------------------------
--  DDL for Trigger PER_PHONES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PHONES_WHO" 
before insert or update on "HR"."PER_PHONES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PHONES_WHO" ENABLE;
