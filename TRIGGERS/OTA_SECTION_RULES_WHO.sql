--------------------------------------------------------
--  DDL for Trigger OTA_SECTION_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_SECTION_RULES_WHO" 
before insert or update on "OTA"."OTA_SECTION_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_SECTION_RULES_WHO" ENABLE;
