--------------------------------------------------------
--  DDL for Trigger GHR_PA_REMARKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PA_REMARKS_WHO" 
before insert or update on "HR"."GHR_PA_REMARKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PA_REMARKS_WHO" ENABLE;
