--------------------------------------------------------
--  DDL for Trigger HR_ORG_INFORMATION_T052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_ORG_INFORMATION_T052616_WHO" 
before insert or update on "HR"."HR_ORG_INFORMATION_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_ORG_INFORMATION_T052616_WHO" ENABLE;
