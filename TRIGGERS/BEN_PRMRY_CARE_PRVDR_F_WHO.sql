--------------------------------------------------------
--  DDL for Trigger BEN_PRMRY_CARE_PRVDR_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRMRY_CARE_PRVDR_F_WHO" 
before insert or update on "BEN"."BEN_PRMRY_CARE_PRVDR_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRMRY_CARE_PRVDR_F_WHO" ENABLE;
