--------------------------------------------------------
--  DDL for Trigger BEN_PGM_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PGM_EXTRA_INFO_WHO" 
before insert or update on "BEN"."BEN_PGM_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PGM_EXTRA_INFO_WHO" ENABLE;
