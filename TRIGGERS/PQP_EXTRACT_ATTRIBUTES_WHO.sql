--------------------------------------------------------
--  DDL for Trigger PQP_EXTRACT_ATTRIBUTES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_EXTRACT_ATTRIBUTES_WHO" 
before insert or update on "HR"."PQP_EXTRACT_ATTRIBUTES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_EXTRACT_ATTRIBUTES_WHO" ENABLE;
