--------------------------------------------------------
--  DDL for Trigger PQH_DE_CASE_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_CASE_GROUPS_WHO" 
before insert or update on "HR"."PQH_DE_CASE_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_CASE_GROUPS_WHO" ENABLE;
