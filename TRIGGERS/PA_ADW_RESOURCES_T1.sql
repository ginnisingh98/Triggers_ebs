--------------------------------------------------------
--  DDL for Trigger PA_ADW_RESOURCES_T1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PA_ADW_RESOURCES_T1" 
...
BEFORE UPDATE OF
  ...
  ALIAS,
  RESOURCE_LIST_ID
ON "PA"."PA_RESOURCE_LIST_MEMBERS"
FOR EACH ROW
...
/
ALTER TRIGGER "APPS"."PA_ADW_RESOURCES_T1" ENABLE;
