--------------------------------------------------------
--  DDL for Trigger PER_MEDICAL_ASSESSMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_MEDICAL_ASSESSMENTS_WHO" 
before insert or update on "HR"."PER_MEDICAL_ASSESSMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_MEDICAL_ASSESSMENTS_WHO" ENABLE;
