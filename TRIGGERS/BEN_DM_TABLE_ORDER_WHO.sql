--------------------------------------------------------
--  DDL for Trigger BEN_DM_TABLE_ORDER_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DM_TABLE_ORDER_WHO" 
before insert or update on "BEN"."BEN_DM_TABLE_ORDER"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DM_TABLE_ORDER_WHO" ENABLE;
