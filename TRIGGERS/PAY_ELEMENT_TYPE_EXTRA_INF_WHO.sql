--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_TYPE_EXTRA_INF_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_TYPE_EXTRA_INF_WHO" 
before insert or update on "HR"."PAY_ELEMENT_TYPE_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_TYPE_EXTRA_INF_WHO" ENABLE;
