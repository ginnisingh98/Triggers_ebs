--------------------------------------------------------
--  DDL for Trigger SSP_WITHHOLDING_REASONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."SSP_WITHHOLDING_REASONS_WHO" 
before insert or update on "SSP"."SSP_WITHHOLDING_REASONS"
for each row
...
/
ALTER TRIGGER "APPS"."SSP_WITHHOLDING_REASONS_WHO" ENABLE;
