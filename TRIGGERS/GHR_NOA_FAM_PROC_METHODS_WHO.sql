--------------------------------------------------------
--  DDL for Trigger GHR_NOA_FAM_PROC_METHODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_NOA_FAM_PROC_METHODS_WHO" 
before insert or update on "HR"."GHR_NOA_FAM_PROC_METHODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_NOA_FAM_PROC_METHODS_WHO" ENABLE;
