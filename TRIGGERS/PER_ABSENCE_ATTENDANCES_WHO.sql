--------------------------------------------------------
--  DDL for Trigger PER_ABSENCE_ATTENDANCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ABSENCE_ATTENDANCES_WHO" 
before insert or update on "HR"."PER_ABSENCE_ATTENDANCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ABSENCE_ATTENDANCES_WHO" ENABLE;
