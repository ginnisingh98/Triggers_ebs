--------------------------------------------------------
--  DDL for Trigger PSP_EFFORT_REPORT_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_EFFORT_REPORT_DETAILS_WHO" 
before insert or update on "PSP"."PSP_EFFORT_REPORT_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_EFFORT_REPORT_DETAILS_WHO" ENABLE;
