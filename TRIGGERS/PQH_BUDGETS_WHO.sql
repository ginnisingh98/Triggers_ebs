--------------------------------------------------------
--  DDL for Trigger PQH_BUDGETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BUDGETS_WHO" 
before insert or update on "HR"."PQH_BUDGETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BUDGETS_WHO" ENABLE;
