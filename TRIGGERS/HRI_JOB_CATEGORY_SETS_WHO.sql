--------------------------------------------------------
--  DDL for Trigger HRI_JOB_CATEGORY_SETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_JOB_CATEGORY_SETS_WHO" 
before insert or update on "HRI"."HRI_JOB_CATEGORY_SETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_JOB_CATEGORY_SETS_WHO" ENABLE;
