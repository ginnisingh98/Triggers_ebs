--------------------------------------------------------
--  DDL for Trigger OTA_UTEST_RESPONSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_UTEST_RESPONSES_WHO" 
before insert or update on "OTA"."OTA_UTEST_RESPONSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_UTEST_RESPONSES_WHO" ENABLE;
