--------------------------------------------------------
--  DDL for Trigger GHR_ROUTING_LISTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_ROUTING_LISTS_WHO" 
before insert or update on "HR"."GHR_ROUTING_LISTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_ROUTING_LISTS_WHO" ENABLE;
