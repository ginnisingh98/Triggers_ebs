--------------------------------------------------------
--  DDL for Trigger GHR_COMPL_BASES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPL_BASES_WHO" 
before insert or update on "HR"."GHR_COMPL_BASES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPL_BASES_WHO" ENABLE;
