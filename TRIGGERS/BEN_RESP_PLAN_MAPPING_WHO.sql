--------------------------------------------------------
--  DDL for Trigger BEN_RESP_PLAN_MAPPING_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_RESP_PLAN_MAPPING_WHO" 
before insert or update on "BEN"."BEN_RESP_PLAN_MAPPING"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_RESP_PLAN_MAPPING_WHO" ENABLE;
