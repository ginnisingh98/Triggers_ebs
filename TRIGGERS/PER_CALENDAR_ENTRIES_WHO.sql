--------------------------------------------------------
--  DDL for Trigger PER_CALENDAR_ENTRIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CALENDAR_ENTRIES_WHO" 
before insert or update on "HR"."PER_CALENDAR_ENTRIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CALENDAR_ENTRIES_WHO" ENABLE;
