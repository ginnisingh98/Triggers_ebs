--------------------------------------------------------
--  DDL for Trigger HXC_MAPPING_COMP_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_MAPPING_COMP_USAGES_WHO" 
before insert or update on "HXC"."HXC_MAPPING_COMP_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_MAPPING_COMP_USAGES_WHO" ENABLE;
