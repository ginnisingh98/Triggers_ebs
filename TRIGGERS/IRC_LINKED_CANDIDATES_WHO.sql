--------------------------------------------------------
--  DDL for Trigger IRC_LINKED_CANDIDATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_LINKED_CANDIDATES_WHO" 
before insert or update on "HR"."IRC_LINKED_CANDIDATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_LINKED_CANDIDATES_WHO" ENABLE;
