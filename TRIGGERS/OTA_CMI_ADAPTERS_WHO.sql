--------------------------------------------------------
--  DDL for Trigger OTA_CMI_ADAPTERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CMI_ADAPTERS_WHO" 
before insert or update on "OTA"."OTA_CMI_ADAPTERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CMI_ADAPTERS_WHO" ENABLE;
