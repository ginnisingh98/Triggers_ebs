--------------------------------------------------------
--  DDL for Trigger PER_SALARY_SURVEY_MAPPINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SALARY_SURVEY_MAPPINGS_WHO" 
before insert or update on "HR"."PER_SALARY_SURVEY_MAPPINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SALARY_SURVEY_MAPPINGS_WHO" ENABLE;
