--------------------------------------------------------
--  DDL for Trigger HR_EFC_WORKERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_EFC_WORKERS_WHO" 
before insert or update on "HR"."HR_EFC_WORKERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_EFC_WORKERS_WHO" ENABLE;
