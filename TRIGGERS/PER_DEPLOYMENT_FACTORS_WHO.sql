--------------------------------------------------------
--  DDL for Trigger PER_DEPLOYMENT_FACTORS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_DEPLOYMENT_FACTORS_WHO" 
before insert or update on "HR"."PER_DEPLOYMENT_FACTORS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_DEPLOYMENT_FACTORS_WHO" ENABLE;
