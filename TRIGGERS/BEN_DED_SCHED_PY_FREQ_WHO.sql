--------------------------------------------------------
--  DDL for Trigger BEN_DED_SCHED_PY_FREQ_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DED_SCHED_PY_FREQ_WHO" 
before insert or update on "BEN"."BEN_DED_SCHED_PY_FREQ"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DED_SCHED_PY_FREQ_WHO" ENABLE;
