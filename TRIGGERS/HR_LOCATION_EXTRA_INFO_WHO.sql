--------------------------------------------------------
--  DDL for Trigger HR_LOCATION_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_LOCATION_EXTRA_INFO_WHO" 
before insert or update on "HR"."HR_LOCATION_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_LOCATION_EXTRA_INFO_WHO" ENABLE;
