--------------------------------------------------------
--  DDL for Trigger HXC_AR_TC_IDS_TEMP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_AR_TC_IDS_TEMP_WHO" 
before insert or update on "HXC"."HXC_AR_TC_IDS_TEMP"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_AR_TC_IDS_TEMP_WHO" ENABLE;
