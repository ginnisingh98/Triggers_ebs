--------------------------------------------------------
--  DDL for Trigger PAY_ZA_BRANCH_CDV_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ZA_BRANCH_CDV_DETAILS_WHO" 
...
/
ALTER TRIGGER "APPS"."PAY_ZA_BRANCH_CDV_DETAILS_WHO" ENABLE;
