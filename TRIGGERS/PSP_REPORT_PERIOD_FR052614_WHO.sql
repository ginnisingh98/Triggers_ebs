--------------------------------------------------------
--  DDL for Trigger PSP_REPORT_PERIOD_FR052614_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_REPORT_PERIOD_FR052614_WHO" 
before insert or update on "PSP"."PSP_REPORT_PERIOD_FREQUENCY_TL"
for each row
declare
 l_sysdate DATE := sysdate;
begin
  -- Trigger generated by hrcretrg.sql at 2020/10/13 05:26:14.
...
/
ALTER TRIGGER "APPS"."PSP_REPORT_PERIOD_FR052614_WHO" ENABLE;
