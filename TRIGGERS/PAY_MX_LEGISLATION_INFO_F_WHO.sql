--------------------------------------------------------
--  DDL for Trigger PAY_MX_LEGISLATION_INFO_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_MX_LEGISLATION_INFO_F_WHO" 
before insert or update on "HR"."PAY_MX_LEGISLATION_INFO_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_MX_LEGISLATION_INFO_F_WHO" ENABLE;
