--------------------------------------------------------
--  DDL for Trigger HRI_EQ_ASG_SUP_WRFC_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_EQ_ASG_SUP_WRFC_WHO" 
before insert or update on "HRI"."HRI_EQ_ASG_SUP_WRFC"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_EQ_ASG_SUP_WRFC_WHO" ENABLE;
