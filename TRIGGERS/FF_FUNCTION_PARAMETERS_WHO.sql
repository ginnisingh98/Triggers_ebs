--------------------------------------------------------
--  DDL for Trigger FF_FUNCTION_PARAMETERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_FUNCTION_PARAMETERS_WHO" 
before insert or update on "HR"."FF_FUNCTION_PARAMETERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_FUNCTION_PARAMETERS_WHO" ENABLE;
