--------------------------------------------------------
--  DDL for Trigger PSP_SUMMARY_LINES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_SUMMARY_LINES_WHO" 
before insert or update on "PSP"."PSP_SUMMARY_LINES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_SUMMARY_LINES_WHO" ENABLE;
