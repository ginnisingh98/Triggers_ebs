--------------------------------------------------------
--  DDL for Trigger PER_ALLOCATED_TASKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ALLOCATED_TASKS_WHO" 
before insert or update on "HR"."PER_ALLOCATED_TASKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ALLOCATED_TASKS_WHO" ENABLE;
