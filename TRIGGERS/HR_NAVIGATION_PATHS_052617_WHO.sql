--------------------------------------------------------
--  DDL for Trigger HR_NAVIGATION_PATHS_052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_NAVIGATION_PATHS_052617_WHO" 
before insert or update on "HR"."HR_NAVIGATION_PATHS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_NAVIGATION_PATHS_052617_WHO" ENABLE;
