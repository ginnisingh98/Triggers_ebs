--------------------------------------------------------
--  DDL for Trigger PER_CONTACT_INFO_TYP052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CONTACT_INFO_TYP052616_WHO" 
before insert or update on "HR"."PER_CONTACT_INFO_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CONTACT_INFO_TYP052616_WHO" ENABLE;
