--------------------------------------------------------
--  DDL for Trigger BEN_LER_CHG_PL_NIP_RL_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_LER_CHG_PL_NIP_RL_F_WHO" 
before insert or update on "BEN"."BEN_LER_CHG_PL_NIP_RL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_LER_CHG_PL_NIP_RL_F_WHO" ENABLE;
