--------------------------------------------------------
--  DDL for Trigger PER_POSITION_INFO_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_POSITION_INFO_TYPES_WHO" 
before insert or update on "HR"."PER_POSITION_INFO_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_POSITION_INFO_TYPES_WHO" ENABLE;
