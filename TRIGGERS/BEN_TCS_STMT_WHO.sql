--------------------------------------------------------
--  DDL for Trigger BEN_TCS_STMT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_TCS_STMT_WHO" 
before insert or update on "BEN"."BEN_TCS_STMT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_TCS_STMT_WHO" ENABLE;
