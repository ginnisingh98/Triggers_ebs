--------------------------------------------------------
--  DDL for Trigger PQP_VEHICLE_REPOSITORY_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_VEHICLE_REPOSITORY_F_WHO" 
before insert or update on "HR"."PQP_VEHICLE_REPOSITORY_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_VEHICLE_REPOSITORY_F_WHO" ENABLE;
