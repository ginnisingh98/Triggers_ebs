--------------------------------------------------------
--  DDL for Trigger PER_CAREER_PATHS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAREER_PATHS_WHO" 
before insert or update on "HR"."PER_CAREER_PATHS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAREER_PATHS_WHO" ENABLE;
