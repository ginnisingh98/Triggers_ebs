--------------------------------------------------------
--  DDL for Trigger HR_PERSON_DEPLYMT_EITS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PERSON_DEPLYMT_EITS_WHO" 
before insert or update on "HR"."HR_PERSON_DEPLYMT_EITS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PERSON_DEPLYMT_EITS_WHO" ENABLE;
