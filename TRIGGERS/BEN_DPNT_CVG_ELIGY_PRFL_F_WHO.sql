--------------------------------------------------------
--  DDL for Trigger BEN_DPNT_CVG_ELIGY_PRFL_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_DPNT_CVG_ELIGY_PRFL_F_WHO" 
before insert or update on "BEN"."BEN_DPNT_CVG_ELIGY_PRFL_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_DPNT_CVG_ELIGY_PRFL_F_WHO" ENABLE;
