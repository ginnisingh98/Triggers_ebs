--------------------------------------------------------
--  DDL for Trigger HXC_LAYOUT_COMP_PROMPTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_LAYOUT_COMP_PROMPTS_WHO" 
before insert or update on "HXC"."HXC_LAYOUT_COMP_PROMPTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_LAYOUT_COMP_PROMPTS_WHO" ENABLE;
