--------------------------------------------------------
--  DDL for Trigger PQH_RATE_ELEMENT_RELATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_RATE_ELEMENT_RELATIONS_WHO" 
before insert or update on "HR"."PQH_RATE_ELEMENT_RELATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_RATE_ELEMENT_RELATIONS_WHO" ENABLE;
