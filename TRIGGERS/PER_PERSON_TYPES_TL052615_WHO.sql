--------------------------------------------------------
--  DDL for Trigger PER_PERSON_TYPES_TL052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PERSON_TYPES_TL052615_WHO" 
before insert or update on "HR"."PER_PERSON_TYPES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PERSON_TYPES_TL052615_WHO" ENABLE;
