--------------------------------------------------------
--  DDL for Trigger PSP_ELEMENT_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ELEMENT_TYPES_WHO" 
before insert or update on "PSP"."PSP_ELEMENT_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ELEMENT_TYPES_WHO" ENABLE;
