--------------------------------------------------------
--  DDL for Trigger BEN_ORG_UNIT_PRDCT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ORG_UNIT_PRDCT_F_WHO" 
before insert or update on "BEN"."BEN_ORG_UNIT_PRDCT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ORG_UNIT_PRDCT_F_WHO" ENABLE;
