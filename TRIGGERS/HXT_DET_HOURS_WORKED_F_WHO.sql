--------------------------------------------------------
--  DDL for Trigger HXT_DET_HOURS_WORKED_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_DET_HOURS_WORKED_F_WHO" 
before insert or update on "HXT"."HXT_DET_HOURS_WORKED_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_DET_HOURS_WORKED_F_WHO" ENABLE;
