--------------------------------------------------------
--  DDL for Trigger FEM_USER_LOV192_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_LOV192_UL" 
instead of update on FEM_USER_LOV192_VL
...
/
ALTER TRIGGER "APPS"."FEM_USER_LOV192_UL" ENABLE;
