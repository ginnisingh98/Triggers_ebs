--------------------------------------------------------
--  DDL for Trigger FF_QP_REPORTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_QP_REPORTS_WHO" 
before insert or update on "HR"."FF_QP_REPORTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_QP_REPORTS_WHO" ENABLE;
