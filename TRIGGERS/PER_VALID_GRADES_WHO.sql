--------------------------------------------------------
--  DDL for Trigger PER_VALID_GRADES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_VALID_GRADES_WHO" 
before insert or update on "HR"."PER_VALID_GRADES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_VALID_GRADES_WHO" ENABLE;
