--------------------------------------------------------
--  DDL for Trigger BEN_CVG_AMT_CALC_MTHD_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CVG_AMT_CALC_MTHD_F_WHO" 
before insert or update on "BEN"."BEN_CVG_AMT_CALC_MTHD_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CVG_AMT_CALC_MTHD_F_WHO" ENABLE;
