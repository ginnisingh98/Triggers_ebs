--------------------------------------------------------
--  DDL for Trigger FEM_USER_LOV178_UL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_LOV178_UL" 
instead of update on FEM_USER_LOV178_VL
...
/
ALTER TRIGGER "APPS"."FEM_USER_LOV178_UL" ENABLE;
