--------------------------------------------------------
--  DDL for Trigger BEN_ELIG_PSTL_CD_R_RNG_PRT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_ELIG_PSTL_CD_R_RNG_PRT_WHO" 
before insert or update on "BEN"."BEN_ELIG_PSTL_CD_R_RNG_PRTE_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_ELIG_PSTL_CD_R_RNG_PRT_WHO" ENABLE;
