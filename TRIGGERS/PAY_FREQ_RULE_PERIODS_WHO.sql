--------------------------------------------------------
--  DDL for Trigger PAY_FREQ_RULE_PERIODS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_FREQ_RULE_PERIODS_WHO" 
before insert or update on "HR"."PAY_FREQ_RULE_PERIODS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_FREQ_RULE_PERIODS_WHO" ENABLE;
