--------------------------------------------------------
--  DDL for Trigger HXC_LAYOUT_COMP_QUAL_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_LAYOUT_COMP_QUAL_RULES_WHO" 
before insert or update on "HXC"."HXC_LAYOUT_COMP_QUAL_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_LAYOUT_COMP_QUAL_RULES_WHO" ENABLE;
