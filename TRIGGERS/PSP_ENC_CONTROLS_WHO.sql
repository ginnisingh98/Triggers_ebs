--------------------------------------------------------
--  DDL for Trigger PSP_ENC_CONTROLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ENC_CONTROLS_WHO" 
before insert or update on "PSP"."PSP_ENC_CONTROLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ENC_CONTROLS_WHO" ENABLE;
