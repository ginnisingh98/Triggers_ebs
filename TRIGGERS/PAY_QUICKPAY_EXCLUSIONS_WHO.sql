--------------------------------------------------------
--  DDL for Trigger PAY_QUICKPAY_EXCLUSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_QUICKPAY_EXCLUSIONS_WHO" 
before insert or update on "HR"."PAY_QUICKPAY_EXCLUSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_QUICKPAY_EXCLUSIONS_WHO" ENABLE;
