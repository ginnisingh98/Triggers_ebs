--------------------------------------------------------
--  DDL for Trigger HR_PATTERN_CONSTRUCTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PATTERN_CONSTRUCTIONS_WHO" 
before insert or update on "HR"."HR_PATTERN_CONSTRUCTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PATTERN_CONSTRUCTIONS_WHO" ENABLE;
