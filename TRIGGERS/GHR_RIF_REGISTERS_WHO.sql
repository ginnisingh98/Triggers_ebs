--------------------------------------------------------
--  DDL for Trigger GHR_RIF_REGISTERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_RIF_REGISTERS_WHO" 
before insert or update on "HR"."GHR_RIF_REGISTERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_RIF_REGISTERS_WHO" ENABLE;
