--------------------------------------------------------
--  DDL for Trigger BEN_PCT_FL_TM_FCTR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PCT_FL_TM_FCTR_WHO" 
before insert or update on "BEN"."BEN_PCT_FL_TM_FCTR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PCT_FL_TM_FCTR_WHO" ENABLE;
