--------------------------------------------------------
--  DDL for Trigger PSP_EFFORT_REPORTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_EFFORT_REPORTS_WHO" 
before insert or update on "PSP"."PSP_EFFORT_REPORTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_EFFORT_REPORTS_WHO" ENABLE;
