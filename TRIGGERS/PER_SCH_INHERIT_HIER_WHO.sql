--------------------------------------------------------
--  DDL for Trigger PER_SCH_INHERIT_HIER_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_SCH_INHERIT_HIER_WHO" 
before insert or update on "HR"."PER_SCH_INHERIT_HIER"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_SCH_INHERIT_HIER_WHO" ENABLE;
