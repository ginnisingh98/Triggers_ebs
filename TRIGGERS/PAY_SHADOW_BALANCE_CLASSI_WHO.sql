--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_BALANCE_CLASSI_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_BALANCE_CLASSI_WHO" 
before insert or update on "HR"."PAY_SHADOW_BALANCE_CLASSI"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_BALANCE_CLASSI_WHO" ENABLE;
