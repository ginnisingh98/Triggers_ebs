--------------------------------------------------------
--  DDL for Trigger BEN_REPORTING_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_REPORTING_WHO" 
before insert or update on "BEN"."BEN_REPORTING"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_REPORTING_WHO" ENABLE;
