--------------------------------------------------------
--  DDL for Trigger PQH_BUDGET_ELEMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BUDGET_ELEMENTS_WHO" 
before insert or update on "HR"."PQH_BUDGET_ELEMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BUDGET_ELEMENTS_WHO" ENABLE;
