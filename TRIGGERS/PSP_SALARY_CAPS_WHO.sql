--------------------------------------------------------
--  DDL for Trigger PSP_SALARY_CAPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_SALARY_CAPS_WHO" 
before insert or update on "PSP"."PSP_SALARY_CAPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_SALARY_CAPS_WHO" ENABLE;
