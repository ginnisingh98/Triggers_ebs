--------------------------------------------------------
--  DDL for Trigger PER_OBJECTIVES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_OBJECTIVES_WHO" 
before insert or update on "HR"."PER_OBJECTIVES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_OBJECTIVES_WHO" ENABLE;
