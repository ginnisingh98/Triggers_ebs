--------------------------------------------------------
--  DDL for Trigger HR_DM_TABLE_GROUPINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_TABLE_GROUPINGS_WHO" 
before insert or update on "HR"."HR_DM_TABLE_GROUPINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_TABLE_GROUPINGS_WHO" ENABLE;
