--------------------------------------------------------
--  DDL for Trigger PQP_ALIEN_STATE_TREATIES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQP_ALIEN_STATE_TREATIES_F_WHO" 
before insert or update on "HR"."PQP_ALIEN_STATE_TREATIES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQP_ALIEN_STATE_TREATIES_F_WHO" ENABLE;
