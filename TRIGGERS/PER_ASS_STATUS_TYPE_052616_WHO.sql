--------------------------------------------------------
--  DDL for Trigger PER_ASS_STATUS_TYPE_052616_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASS_STATUS_TYPE_052616_WHO" 
before insert or update on "HR"."PER_ASS_STATUS_TYPE_AMENDS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_ASS_STATUS_TYPE_052616_WHO" ENABLE;
