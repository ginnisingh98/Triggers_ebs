--------------------------------------------------------
--  DDL for Trigger PER_NUMBER_GENERATION_CONT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_NUMBER_GENERATION_CONT_WHO" 
before insert or update on "HR"."PER_NUMBER_GENERATION_CONTROLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_NUMBER_GENERATION_CONT_WHO" ENABLE;
