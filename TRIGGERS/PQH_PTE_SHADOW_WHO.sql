--------------------------------------------------------
--  DDL for Trigger PQH_PTE_SHADOW_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_PTE_SHADOW_WHO" 
before insert or update on "HR"."PQH_PTE_SHADOW"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_PTE_SHADOW_WHO" ENABLE;
