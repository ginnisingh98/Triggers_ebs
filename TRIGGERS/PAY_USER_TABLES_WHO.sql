--------------------------------------------------------
--  DDL for Trigger PAY_USER_TABLES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_USER_TABLES_WHO" 
before insert or update on "HR"."PAY_USER_TABLES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_USER_TABLES_WHO" ENABLE;
