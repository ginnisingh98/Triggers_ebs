--------------------------------------------------------
--  DDL for Trigger HR_DM_PHASE_RULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_PHASE_RULES_WHO" 
before insert or update on "HR"."HR_DM_PHASE_RULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_PHASE_RULES_WHO" ENABLE;
