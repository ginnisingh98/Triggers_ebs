--------------------------------------------------------
--  DDL for Trigger IRC_COMM_TOPICS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_COMM_TOPICS_WHO" 
before insert or update on "HR"."IRC_COMM_TOPICS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_COMM_TOPICS_WHO" ENABLE;
