--------------------------------------------------------
--  DDL for Trigger PAY_US_GARN_FEE_RULES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_US_GARN_FEE_RULES_F_WHO" 
before insert or update on "HR"."PAY_US_GARN_FEE_RULES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_US_GARN_FEE_RULES_F_WHO" ENABLE;
