--------------------------------------------------------
--  DDL for Trigger PAY_GROSSUP_BAL_EXCLUSIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_GROSSUP_BAL_EXCLUSIONS_WHO" 
before insert or update on "HR"."PAY_GROSSUP_BAL_EXCLUSIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_GROSSUP_BAL_EXCLUSIONS_WHO" ENABLE;
