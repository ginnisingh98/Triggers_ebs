--------------------------------------------------------
--  DDL for Trigger PER_COBRA_COVERAGE_STATUSE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COBRA_COVERAGE_STATUSE_WHO" 
before insert or update on "HR"."PER_COBRA_COVERAGE_STATUSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COBRA_COVERAGE_STATUSE_WHO" ENABLE;
