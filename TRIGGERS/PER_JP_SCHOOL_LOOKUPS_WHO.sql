--------------------------------------------------------
--  DDL for Trigger PER_JP_SCHOOL_LOOKUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_JP_SCHOOL_LOOKUPS_WHO" 
before insert or update on "HR"."PER_JP_SCHOOL_LOOKUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_JP_SCHOOL_LOOKUPS_WHO" ENABLE;
