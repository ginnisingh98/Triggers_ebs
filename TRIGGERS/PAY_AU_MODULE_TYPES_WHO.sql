--------------------------------------------------------
--  DDL for Trigger PAY_AU_MODULE_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_AU_MODULE_TYPES_WHO" 
before insert or update on "HR"."PAY_AU_MODULE_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_AU_MODULE_TYPES_WHO" ENABLE;
