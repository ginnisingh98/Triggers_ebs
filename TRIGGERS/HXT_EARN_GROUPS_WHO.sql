--------------------------------------------------------
--  DDL for Trigger HXT_EARN_GROUPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_EARN_GROUPS_WHO" 
before insert or update on "HXT"."HXT_EARN_GROUPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_EARN_GROUPS_WHO" ENABLE;
