--------------------------------------------------------
--  DDL for Trigger PAY_SHADOW_ELE_TYPE_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_SHADOW_ELE_TYPE_USAGES_WHO" 
before insert or update on "HR"."PAY_SHADOW_ELE_TYPE_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_SHADOW_ELE_TYPE_USAGES_WHO" ENABLE;
