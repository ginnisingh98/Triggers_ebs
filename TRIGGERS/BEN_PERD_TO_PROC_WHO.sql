--------------------------------------------------------
--  DDL for Trigger BEN_PERD_TO_PROC_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PERD_TO_PROC_WHO" 
before insert or update on "BEN"."BEN_PERD_TO_PROC"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PERD_TO_PROC_WHO" ENABLE;
