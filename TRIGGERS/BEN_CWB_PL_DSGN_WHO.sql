--------------------------------------------------------
--  DDL for Trigger BEN_CWB_PL_DSGN_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CWB_PL_DSGN_WHO" 
before insert or update on "BEN"."BEN_CWB_PL_DSGN"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CWB_PL_DSGN_WHO" ENABLE;
