--------------------------------------------------------
--  DDL for Trigger PER_ASSIGNMENT_STATUS_TYPE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_ASSIGNMENT_STATUS_TYPE_WHO" 
before insert or update on "HR"."PER_ASSIGNMENT_STATUS_TYPES"
for each row
declare
 l_sysdate DATE := sysdate;
begin
  -- Trigger generated by hrcretrg.sql at 2007/01/04 13:26:47.
...
/
ALTER TRIGGER "APPS"."PER_ASSIGNMENT_STATUS_TYPE_WHO" ENABLE;
