--------------------------------------------------------
--  DDL for Trigger BEN_EXT_RCD_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_RCD_WHO" 
before insert or update on "BEN"."BEN_EXT_RCD"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_RCD_WHO" ENABLE;
