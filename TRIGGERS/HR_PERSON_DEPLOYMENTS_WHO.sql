--------------------------------------------------------
--  DDL for Trigger HR_PERSON_DEPLOYMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_PERSON_DEPLOYMENTS_WHO" 
before insert or update on "HR"."HR_PERSON_DEPLOYMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_PERSON_DEPLOYMENTS_WHO" ENABLE;
