--------------------------------------------------------
--  DDL for Trigger PAY_CALENDARS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_CALENDARS_WHO" 
before insert or update on "HR"."PAY_CALENDARS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_CALENDARS_WHO" ENABLE;
