--------------------------------------------------------
--  DDL for Trigger FF_GLOBALS_F_TL052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FF_GLOBALS_F_TL052617_WHO" 
before insert or update on "HR"."FF_GLOBALS_F_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."FF_GLOBALS_F_TL052617_WHO" ENABLE;
