--------------------------------------------------------
--  DDL for Trigger PAY_REPORT_VARIABLES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_REPORT_VARIABLES_WHO" 
before insert or update on "HR"."PAY_REPORT_VARIABLES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_REPORT_VARIABLES_WHO" ENABLE;
