--------------------------------------------------------
--  DDL for Trigger HXC_RETRIEVAL_PROCESSES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_RETRIEVAL_PROCESSES_WHO" 
before insert or update on "HXC"."HXC_RETRIEVAL_PROCESSES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_RETRIEVAL_PROCESSES_WHO" ENABLE;
