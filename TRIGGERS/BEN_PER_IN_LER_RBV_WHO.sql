--------------------------------------------------------
--  DDL for Trigger BEN_PER_IN_LER_RBV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PER_IN_LER_RBV_WHO" 
before insert or update on "BEN"."BEN_PER_IN_LER_RBV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PER_IN_LER_RBV_WHO" ENABLE;
