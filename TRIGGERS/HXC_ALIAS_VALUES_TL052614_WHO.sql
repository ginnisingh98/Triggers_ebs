--------------------------------------------------------
--  DDL for Trigger HXC_ALIAS_VALUES_TL052614_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_ALIAS_VALUES_TL052614_WHO" 
before insert or update on "HXC"."HXC_ALIAS_VALUES_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_ALIAS_VALUES_TL052614_WHO" ENABLE;
