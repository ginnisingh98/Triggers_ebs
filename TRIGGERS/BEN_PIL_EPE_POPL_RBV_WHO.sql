--------------------------------------------------------
--  DDL for Trigger BEN_PIL_EPE_POPL_RBV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PIL_EPE_POPL_RBV_WHO" 
before insert or update on "BEN"."BEN_PIL_EPE_POPL_RBV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PIL_EPE_POPL_RBV_WHO" ENABLE;
