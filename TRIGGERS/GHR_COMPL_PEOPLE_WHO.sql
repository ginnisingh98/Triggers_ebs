--------------------------------------------------------
--  DDL for Trigger GHR_COMPL_PEOPLE_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPL_PEOPLE_WHO" 
before insert or update on "HR"."GHR_COMPL_PEOPLE"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPL_PEOPLE_WHO" ENABLE;
