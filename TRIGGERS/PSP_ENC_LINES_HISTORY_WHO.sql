--------------------------------------------------------
--  DDL for Trigger PSP_ENC_LINES_HISTORY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_ENC_LINES_HISTORY_WHO" 
before insert or update on "PSP"."PSP_ENC_LINES_HISTORY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_ENC_LINES_HISTORY_WHO" ENABLE;
