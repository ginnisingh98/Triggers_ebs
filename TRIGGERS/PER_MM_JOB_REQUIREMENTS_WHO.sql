--------------------------------------------------------
--  DDL for Trigger PER_MM_JOB_REQUIREMENTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_MM_JOB_REQUIREMENTS_WHO" 
before insert or update on "HR"."PER_MM_JOB_REQUIREMENTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_MM_JOB_REQUIREMENTS_WHO" ENABLE;
