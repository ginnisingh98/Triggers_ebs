--------------------------------------------------------
--  DDL for Trigger HR_WIP_LOCKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_WIP_LOCKS_WHO" 
before insert or update on "HR"."HR_WIP_LOCKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_WIP_LOCKS_WHO" ENABLE;
