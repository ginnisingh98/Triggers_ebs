--------------------------------------------------------
--  DDL for Trigger PER_RI_CONFIGURATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_CONFIGURATIONS_WHO" 
before insert or update on "HR"."PER_RI_CONFIGURATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_CONFIGURATIONS_WHO" ENABLE;
