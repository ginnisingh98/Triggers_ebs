--------------------------------------------------------
--  DDL for Trigger PAY_RUN_TYPES_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_RUN_TYPES_F_WHO" 
before insert or update on "HR"."PAY_RUN_TYPES_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_RUN_TYPES_F_WHO" ENABLE;
