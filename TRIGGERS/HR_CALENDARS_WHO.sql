--------------------------------------------------------
--  DDL for Trigger HR_CALENDARS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_CALENDARS_WHO" 
before insert or update on "HR"."HR_CALENDARS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_CALENDARS_WHO" ENABLE;
