--------------------------------------------------------
--  DDL for Trigger PER_PREV_JOB_EXTRA_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PREV_JOB_EXTRA_INFO_WHO" 
before insert or update on "HR"."PER_PREV_JOB_EXTRA_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PREV_JOB_EXTRA_INFO_WHO" ENABLE;
