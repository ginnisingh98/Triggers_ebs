--------------------------------------------------------
--  DDL for Trigger PAY_JOB_WC_CODE_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_JOB_WC_CODE_USAGES_WHO" 
before insert or update on "HR"."PAY_JOB_WC_CODE_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_JOB_WC_CODE_USAGES_WHO" ENABLE;
