--------------------------------------------------------
--  DDL for Trigger OTA_RESOURCE_BOOKINGS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_RESOURCE_BOOKINGS_WHO" 
before insert or update on "OTA"."OTA_RESOURCE_BOOKINGS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_RESOURCE_BOOKINGS_WHO" ENABLE;
