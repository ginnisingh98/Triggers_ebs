--------------------------------------------------------
--  DDL for Trigger PAY_PAYROLL_GL_FLEX_MAPS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_PAYROLL_GL_FLEX_MAPS_WHO" 
before insert or update on "HR"."PAY_PAYROLL_GL_FLEX_MAPS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_PAYROLL_GL_FLEX_MAPS_WHO" ENABLE;
