--------------------------------------------------------
--  DDL for Trigger PQH_FYI_NOTIFY_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_FYI_NOTIFY_WHO" 
before insert or update on "HR"."PQH_FYI_NOTIFY"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_FYI_NOTIFY_WHO" ENABLE;
