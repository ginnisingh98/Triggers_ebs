--------------------------------------------------------
--  DDL for Trigger PER_COBRA_COVERAGE_BENEFIT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COBRA_COVERAGE_BENEFIT_WHO" 
before insert or update on "HR"."PER_COBRA_COVERAGE_BENEFITS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COBRA_COVERAGE_BENEFIT_WHO" ENABLE;
