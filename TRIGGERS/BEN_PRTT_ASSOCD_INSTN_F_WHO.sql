--------------------------------------------------------
--  DDL for Trigger BEN_PRTT_ASSOCD_INSTN_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_PRTT_ASSOCD_INSTN_F_WHO" 
before insert or update on "BEN"."BEN_PRTT_ASSOCD_INSTN_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_PRTT_ASSOCD_INSTN_F_WHO" ENABLE;
