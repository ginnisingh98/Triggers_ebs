--------------------------------------------------------
--  DDL for Trigger IRC_COMM_MESSAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_COMM_MESSAGES_WHO" 
before insert or update on "HR"."IRC_COMM_MESSAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_COMM_MESSAGES_WHO" ENABLE;
