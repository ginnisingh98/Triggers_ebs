--------------------------------------------------------
--  DDL for Trigger PQH_CRITERIA_RATE_DE052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_CRITERIA_RATE_DE052615_WHO" 
before insert or update on "HR"."PQH_CRITERIA_RATE_DEFN_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_CRITERIA_RATE_DE052615_WHO" ENABLE;
