--------------------------------------------------------
--  DDL for Trigger PQH_DE_INS_END_REASONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_INS_END_REASONS_WHO" 
before insert or update on "HR"."PQH_DE_INS_END_REASONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_INS_END_REASONS_WHO" ENABLE;
