--------------------------------------------------------
--  DDL for Trigger OTA_TP_MEASUREMENT_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_TP_MEASUREMENT_TYPES_WHO" 
before insert or update on "OTA"."OTA_TP_MEASUREMENT_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_TP_MEASUREMENT_TYPES_WHO" ENABLE;
