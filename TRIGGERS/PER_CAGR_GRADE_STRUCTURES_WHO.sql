--------------------------------------------------------
--  DDL for Trigger PER_CAGR_GRADE_STRUCTURES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_CAGR_GRADE_STRUCTURES_WHO" 
before insert or update on "HR"."PER_CAGR_GRADE_STRUCTURES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_CAGR_GRADE_STRUCTURES_WHO" ENABLE;
