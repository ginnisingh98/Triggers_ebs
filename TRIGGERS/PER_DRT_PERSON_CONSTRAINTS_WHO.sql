--------------------------------------------------------
--  DDL for Trigger PER_DRT_PERSON_CONSTRAINTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_DRT_PERSON_CONSTRAINTS_WHO" 
before insert or update on "HR"."PER_DRT_PERSON_CONSTRAINTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_DRT_PERSON_CONSTRAINTS_WHO" ENABLE;
