--------------------------------------------------------
--  DDL for Trigger OTA_ACTIVITY_VERSION052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_ACTIVITY_VERSION052615_WHO" 
before insert or update on "OTA"."OTA_ACTIVITY_VERSIONS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_ACTIVITY_VERSION052615_WHO" ENABLE;
