--------------------------------------------------------
--  DDL for Trigger PAY_STAT_TRANS_AUDIT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_STAT_TRANS_AUDIT_WHO" 
before insert or update on "HR"."PAY_STAT_TRANS_AUDIT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_STAT_TRANS_AUDIT_WHO" ENABLE;
