--------------------------------------------------------
--  DDL for Trigger BEN_LBR_MMBR_RT_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_LBR_MMBR_RT_F_WHO" 
before insert or update on "BEN"."BEN_LBR_MMBR_RT_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_LBR_MMBR_RT_F_WHO" ENABLE;
