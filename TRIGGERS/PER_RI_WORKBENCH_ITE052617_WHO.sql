--------------------------------------------------------
--  DDL for Trigger PER_RI_WORKBENCH_ITE052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_RI_WORKBENCH_ITE052617_WHO" 
before insert or update on "HR"."PER_RI_WORKBENCH_ITEMS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_RI_WORKBENCH_ITE052617_WHO" ENABLE;
