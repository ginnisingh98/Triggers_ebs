--------------------------------------------------------
--  DDL for Trigger HXC_LAYOUT_COMP_DEFINITION_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_LAYOUT_COMP_DEFINITION_WHO" 
before insert or update on "HXC"."HXC_LAYOUT_COMP_DEFINITIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_LAYOUT_COMP_DEFINITION_WHO" ENABLE;
