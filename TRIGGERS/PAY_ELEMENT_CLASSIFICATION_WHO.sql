--------------------------------------------------------
--  DDL for Trigger PAY_ELEMENT_CLASSIFICATION_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_ELEMENT_CLASSIFICATION_WHO" 
before insert or update on "HR"."PAY_ELEMENT_CLASSIFICATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_ELEMENT_CLASSIFICATION_WHO" ENABLE;
