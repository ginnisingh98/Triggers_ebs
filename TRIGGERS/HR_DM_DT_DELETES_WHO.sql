--------------------------------------------------------
--  DDL for Trigger HR_DM_DT_DELETES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_DT_DELETES_WHO" 
before insert or update on "HR"."HR_DM_DT_DELETES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_DT_DELETES_WHO" ENABLE;
