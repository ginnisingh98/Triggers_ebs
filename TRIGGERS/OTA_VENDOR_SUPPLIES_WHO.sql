--------------------------------------------------------
--  DDL for Trigger OTA_VENDOR_SUPPLIES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_VENDOR_SUPPLIES_WHO" 
before insert or update on "OTA"."OTA_VENDOR_SUPPLIES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_VENDOR_SUPPLIES_WHO" ENABLE;
