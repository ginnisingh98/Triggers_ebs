--------------------------------------------------------
--  DDL for Trigger HR_LOCATION_INFO_TYPES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_LOCATION_INFO_TYPES_WHO" 
before insert or update on "HR"."HR_LOCATION_INFO_TYPES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_LOCATION_INFO_TYPES_WHO" ENABLE;
