--------------------------------------------------------
--  DDL for Trigger BEN_EXT_RSLT_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_EXT_RSLT_WHO" 
before insert or update on "BEN"."BEN_EXT_RSLT"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_EXT_RSLT_WHO" ENABLE;
