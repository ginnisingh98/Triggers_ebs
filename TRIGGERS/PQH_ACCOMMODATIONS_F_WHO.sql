--------------------------------------------------------
--  DDL for Trigger PQH_ACCOMMODATIONS_F_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_ACCOMMODATIONS_F_WHO" 
before insert or update on "HR"."PQH_ACCOMMODATIONS_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_ACCOMMODATIONS_F_WHO" ENABLE;
