--------------------------------------------------------
--  DDL for Trigger BEN_WV_PRTN_RSN_CTFN_PTIP_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_WV_PRTN_RSN_CTFN_PTIP_WHO" 
before insert or update on "BEN"."BEN_WV_PRTN_RSN_CTFN_PTIP_F"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_WV_PRTN_RSN_CTFN_PTIP_WHO" ENABLE;
