--------------------------------------------------------
--  DDL for Trigger OTA_TRAINING_PLAN_MEMBERS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_TRAINING_PLAN_MEMBERS_WHO" 
before insert or update on "OTA"."OTA_TRAINING_PLAN_MEMBERS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_TRAINING_PLAN_MEMBERS_WHO" ENABLE;
