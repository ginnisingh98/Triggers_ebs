--------------------------------------------------------
--  DDL for Trigger PER_COMP_ELEMENT_OUTCOMES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_COMP_ELEMENT_OUTCOMES_WHO" 
before insert or update on "HR"."PER_COMP_ELEMENT_OUTCOMES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_COMP_ELEMENT_OUTCOMES_WHO" ENABLE;
