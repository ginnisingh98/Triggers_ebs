--------------------------------------------------------
--  DDL for Trigger PAY_AU_PROCESS_MODULES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_AU_PROCESS_MODULES_WHO" 
before insert or update on "HR"."PAY_AU_PROCESS_MODULES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_AU_PROCESS_MODULES_WHO" ENABLE;
