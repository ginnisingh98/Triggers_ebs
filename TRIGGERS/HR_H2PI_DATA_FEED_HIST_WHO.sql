--------------------------------------------------------
--  DDL for Trigger HR_H2PI_DATA_FEED_HIST_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_H2PI_DATA_FEED_HIST_WHO" 
before insert or update on "HR"."HR_H2PI_DATA_FEED_HIST"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_H2PI_DATA_FEED_HIST_WHO" ENABLE;
