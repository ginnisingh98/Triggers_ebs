--------------------------------------------------------
--  DDL for Trigger PSP_PAYROLL_SOURCES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PSP_PAYROLL_SOURCES_WHO" 
before insert or update on "PSP"."PSP_PAYROLL_SOURCES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PSP_PAYROLL_SOURCES_WHO" ENABLE;
