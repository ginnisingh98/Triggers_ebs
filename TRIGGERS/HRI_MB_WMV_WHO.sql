--------------------------------------------------------
--  DDL for Trigger HRI_MB_WMV_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HRI_MB_WMV_WHO" 
before insert or update on "HRI"."HRI_MB_WMV"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HRI_MB_WMV_WHO" ENABLE;
