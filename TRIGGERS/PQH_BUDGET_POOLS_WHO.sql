--------------------------------------------------------
--  DDL for Trigger PQH_BUDGET_POOLS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_BUDGET_POOLS_WHO" 
before insert or update on "HR"."PQH_BUDGET_POOLS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_BUDGET_POOLS_WHO" ENABLE;
