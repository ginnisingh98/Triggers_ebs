--------------------------------------------------------
--  DDL for Trigger BEN_CRT_ORDR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_CRT_ORDR_WHO" 
before insert or update on "BEN"."BEN_CRT_ORDR"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_CRT_ORDR_WHO" ENABLE;
