--------------------------------------------------------
--  DDL for Trigger HR_KI_CONTEXTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_KI_CONTEXTS_WHO" 
before insert or update on "HR"."HR_KI_CONTEXTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_KI_CONTEXTS_WHO" ENABLE;
