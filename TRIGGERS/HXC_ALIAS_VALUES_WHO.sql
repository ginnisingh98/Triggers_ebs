--------------------------------------------------------
--  DDL for Trigger HXC_ALIAS_VALUES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXC_ALIAS_VALUES_WHO" 
before insert or update on "HXC"."HXC_ALIAS_VALUES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXC_ALIAS_VALUES_WHO" ENABLE;
