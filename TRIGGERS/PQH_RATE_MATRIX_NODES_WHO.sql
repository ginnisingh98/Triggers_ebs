--------------------------------------------------------
--  DDL for Trigger PQH_RATE_MATRIX_NODES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_RATE_MATRIX_NODES_WHO" 
before insert or update on "HR"."PQH_RATE_MATRIX_NODES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_RATE_MATRIX_NODES_WHO" ENABLE;
