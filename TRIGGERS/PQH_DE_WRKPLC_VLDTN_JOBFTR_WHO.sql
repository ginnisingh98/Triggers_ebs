--------------------------------------------------------
--  DDL for Trigger PQH_DE_WRKPLC_VLDTN_JOBFTR_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_DE_WRKPLC_VLDTN_JOBFTR_WHO" 
before insert or update on "HR"."PQH_DE_WRKPLC_VLDTN_JOBFTRS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_DE_WRKPLC_VLDTN_JOBFTR_WHO" ENABLE;
