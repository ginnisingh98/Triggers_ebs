--------------------------------------------------------
--  DDL for Trigger GHR_PAYROLL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_PAYROLL_WHO" 
before insert or update on "HR"."GHR_PAYROLL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_PAYROLL_WHO" ENABLE;
