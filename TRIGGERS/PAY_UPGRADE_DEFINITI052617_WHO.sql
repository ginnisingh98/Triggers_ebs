--------------------------------------------------------
--  DDL for Trigger PAY_UPGRADE_DEFINITI052617_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_UPGRADE_DEFINITI052617_WHO" 
before insert or update on "HR"."PAY_UPGRADE_DEFINITIONS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_UPGRADE_DEFINITI052617_WHO" ENABLE;
