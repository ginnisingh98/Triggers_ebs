--------------------------------------------------------
--  DDL for Trigger PAY_PBD_MNT_TL_ARI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_PBD_MNT_TL_ARI" 
...
if ( hr_general.g_data_migrator_mode <> 'Y') and
 ...
 pay_bdt_ins.ins_tl ( P_LANGUAGE_CODE                => userenv('LANG')
...
end pay_pbd_mnt_tl_ari;


/
ALTER TRIGGER "APPS"."PAY_PBD_MNT_TL_ARI" ENABLE;
