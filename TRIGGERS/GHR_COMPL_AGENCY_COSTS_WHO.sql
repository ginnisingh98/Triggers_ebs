--------------------------------------------------------
--  DDL for Trigger GHR_COMPL_AGENCY_COSTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPL_AGENCY_COSTS_WHO" 
before insert or update on "HR"."GHR_COMPL_AGENCY_COSTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPL_AGENCY_COSTS_WHO" ENABLE;
