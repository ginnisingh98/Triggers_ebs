--------------------------------------------------------
--  DDL for Trigger OTA_CERTIFICATIONS_T052615_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CERTIFICATIONS_T052615_WHO" 
before insert or update on "OTA"."OTA_CERTIFICATIONS_TL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CERTIFICATIONS_T052615_WHO" ENABLE;
