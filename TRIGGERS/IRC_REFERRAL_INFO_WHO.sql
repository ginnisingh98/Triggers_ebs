--------------------------------------------------------
--  DDL for Trigger IRC_REFERRAL_INFO_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."IRC_REFERRAL_INFO_WHO" 
before insert or update on "HR"."IRC_REFERRAL_INFO"
for each row
declare
...
/
ALTER TRIGGER "APPS"."IRC_REFERRAL_INFO_WHO" ENABLE;
