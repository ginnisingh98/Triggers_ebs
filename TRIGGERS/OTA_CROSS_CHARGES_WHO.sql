--------------------------------------------------------
--  DDL for Trigger OTA_CROSS_CHARGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."OTA_CROSS_CHARGES_WHO" 
before insert or update on "OTA"."OTA_CROSS_CHARGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."OTA_CROSS_CHARGES_WHO" ENABLE;
