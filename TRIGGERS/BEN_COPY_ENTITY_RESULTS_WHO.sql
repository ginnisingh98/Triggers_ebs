--------------------------------------------------------
--  DDL for Trigger BEN_COPY_ENTITY_RESULTS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_COPY_ENTITY_RESULTS_WHO" 
before insert or update on "BEN"."BEN_COPY_ENTITY_RESULTS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_COPY_ENTITY_RESULTS_WHO" ENABLE;
