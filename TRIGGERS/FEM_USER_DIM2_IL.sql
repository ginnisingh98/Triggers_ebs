--------------------------------------------------------
--  DDL for Trigger FEM_USER_DIM2_IL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."FEM_USER_DIM2_IL" 
instead of insert on FEM_USER_DIM2_VL
...
begin
  FEM_USER_DIM2_PKG.INSERT_ROW(
    ...
    X_CREATION_DATE => :FEM_USER_DIM2_B.CREATION_DATE,
    X_CREATED_BY => :FEM_USER_DIM2_B.CREATED_BY,
...
/
ALTER TRIGGER "APPS"."FEM_USER_DIM2_IL" ENABLE;
