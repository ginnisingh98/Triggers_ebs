--------------------------------------------------------
--  DDL for Trigger GHR_COMPLAINTS2_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPLAINTS2_WHO" 
before insert or update on "HR"."GHR_COMPLAINTS2"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPLAINTS2_WHO" ENABLE;
