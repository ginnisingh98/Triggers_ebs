--------------------------------------------------------
--  DDL for Trigger HR_DM_MIGRATIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_DM_MIGRATIONS_WHO" 
before insert or update on "HR"."HR_DM_MIGRATIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_DM_MIGRATIONS_WHO" ENABLE;
