--------------------------------------------------------
--  DDL for Trigger PER_NL_ABSENCE_ACTIONS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_NL_ABSENCE_ACTIONS_WHO" 
before insert or update on "HR"."PER_NL_ABSENCE_ACTIONS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_NL_ABSENCE_ACTIONS_WHO" ENABLE;
