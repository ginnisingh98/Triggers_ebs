--------------------------------------------------------
--  DDL for Trigger BEN_BATCH_RANGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."BEN_BATCH_RANGES_WHO" 
before insert or update on "BEN"."BEN_BATCH_RANGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."BEN_BATCH_RANGES_WHO" ENABLE;
