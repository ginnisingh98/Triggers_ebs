--------------------------------------------------------
--  DDL for Trigger PAY_TEMPLATE_FF_USAGES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_TEMPLATE_FF_USAGES_WHO" 
before insert or update on "HR"."PAY_TEMPLATE_FF_USAGES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_TEMPLATE_FF_USAGES_WHO" ENABLE;
