--------------------------------------------------------
--  DDL for Trigger GHR_COMPL_CA_DETAILS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."GHR_COMPL_CA_DETAILS_WHO" 
before insert or update on "HR"."GHR_COMPL_CA_DETAILS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."GHR_COMPL_CA_DETAILS_WHO" ENABLE;
