--------------------------------------------------------
--  DDL for Trigger PQH_WORKSHEETS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PQH_WORKSHEETS_WHO" 
before insert or update on "HR"."PQH_WORKSHEETS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PQH_WORKSHEETS_WHO" ENABLE;
