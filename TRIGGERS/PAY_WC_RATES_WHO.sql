--------------------------------------------------------
--  DDL for Trigger PAY_WC_RATES_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PAY_WC_RATES_WHO" 
before insert or update on "HR"."PAY_WC_RATES"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PAY_WC_RATES_WHO" ENABLE;
