--------------------------------------------------------
--  DDL for Trigger PER_PREVIOUS_JOBS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."PER_PREVIOUS_JOBS_WHO" 
before insert or update on "HR"."PER_PREVIOUS_JOBS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."PER_PREVIOUS_JOBS_WHO" ENABLE;
