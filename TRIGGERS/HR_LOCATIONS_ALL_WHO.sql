--------------------------------------------------------
--  DDL for Trigger HR_LOCATIONS_ALL_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HR_LOCATIONS_ALL_WHO" 
before insert or update on "HR"."HR_LOCATIONS_ALL"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HR_LOCATIONS_ALL_WHO" ENABLE;
