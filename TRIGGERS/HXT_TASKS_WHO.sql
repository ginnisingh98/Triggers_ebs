--------------------------------------------------------
--  DDL for Trigger HXT_TASKS_WHO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "APPS"."HXT_TASKS_WHO" 
before insert or update on "HXT"."HXT_TASKS"
for each row
declare
...
/
ALTER TRIGGER "APPS"."HXT_TASKS_WHO" ENABLE;
